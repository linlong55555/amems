...
<script type="text/javascript" src="${ctx}/static/js/thjw/common/produce/wokrorder_modal.js"></script>
<div class="modal fade in modal-new" id="open_win_workorder_modal" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="open_win_workorder_modal" aria-hidden="true">
			         		...
			         		<div class=" pull-right padding-left-0 padding-right-8 margin-top-0 modalSearch">	
								...
								<div class=" pull-right padding-left-0 padding-right-0">
									<div class=" pull-left padding-left-0 padding-right-0" style="width: 250px;">
										<input type="text" placeholder='工单编号' id="open_win_workorder_modal_keyword_search" class="form-control" />
									</div>
				                    <div class=" pull-right padding-left-5 padding-right-0 ">   
										<button  name="keyCodeSearch" type="button" class=" btn btn-primary padding-top-1 padding-bottom-1 " onclick="open_win_workorder_modal.search()">
						...
						<div class="margin-left-8 margin-right-8" style='margin-top:5px;'>
							<div style="overflow-x:auto;" class='table-content'>
								<table class="table table-bordered table-thin table-striped table-hover table-set" style="min-width: 1000px !important">
									<thead>
								   		<tr>								   			
											<th  class="selectAllImg" id="checkAll" style='text-align:center;vertical-align:middle;width:60px;'>
												<a href="#" onclick="SelectUtil.performSelectAll('open_win_workorder_modal_list')" ><img src="${ctx}/static/assets/img/d1.png" alt="全选" /></a>
												<a href="#" class="margin-left-5" onclick="SelectUtil.performSelectClear('open_win_workorder_modal_list')" ><img src="${ctx}/static/assets/img/d2.png" alt="不全选" /></a>
											</th>
											<th class='colwidth-9'>
												<div class="important">
									...
									<tbody id="open_win_workorder_modal_list">
									
									</tbody>
								</table>
								</div>
								<div class="col-xs-12 text-center page-height padding-right-0 padding-left-0" id="open_win_workorder_modal_pagination"></div>
					           	...
					           	<div class="col-xs-12 padding-leftright-8"  >
					           		<div class="input-group">
										...
										<span class="input-group-addon modalfooterbtn">
					                      <button type="button" class="btn btn-primary padding-top-1 padding-bottom-1" onclick="open_win_workorder_modal.save();">
