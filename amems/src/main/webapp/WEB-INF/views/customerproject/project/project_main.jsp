...
<body class="page-header-fixed">
			...
			<div class="panel-body padding-bottom-0" >
				 ...
				 <div class='searchContent row-height margin-top-0' >
					 <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12  padding-left-0  padding-right-0 form-group ">
						...
						permissioncode='customerproject:project:main:add' type="button" onclick="add();">
							<div class="font-size-12">新增</div>
							<div class="font-size-9">Add</div>
						</button>
						<button class="btn btn-primary padding-top-1 padding-bottom-1  checkPermission"
						permissioncode='customerproject:project:main:export' type="button" onclick="exportExcel();">
    ...
    <%@ include file="/WEB-INF/views/customerproject/project/project_open.jsp" %>  <!-- 项目信息弹窗 -->
    <%@ include file="/WEB-INF/views/customerproject/project/customer_choose.jsp" %><!-- 选择客户 -->
	<%@ include file="/WEB-INF/views/open_win/department.jsp"%><!-- 选择部门 -->
    <%-- <%@ include file="/WEB-INF/views/customerproject/project/dept_choose.jsp" %> --%>
    
    <%@ include file="/WEB-INF/views/open_win/history_attach_win.jsp"%><!------附件对话框 -------->

	<script type="text/javascript" src="${ctx}/static/js/thjw/customerproject/project/project_main.js"></script>
