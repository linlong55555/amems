            ...
            <div class="panel-body">
				<div class="col-lg-3 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10 form-group" >
					...
					<tr>
						...
						<td><label style='margin-left:10px;font-weight:400;'><input type='radio' style=" vertical-align: middle;   margin-top: -1px;" name='1'/>&nbsp;合格</label>&nbsp;&nbsp;&nbsp;<label style='font-weight:400;'><input type='radio' style=" vertical-align: middle;   margin-top: -1px;" name='1'/>&nbsp;不合格</label></td>
					</tr>
					<tr>
						<td ><label style='margin-left:10px;'>2.经验要素：</label></td>
						<td><label style='margin-left:10px;font-weight:400;'><input type='radio' style=" vertical-align: middle;   margin-top: -1px;" name='2'/>&nbsp;合格</label>&nbsp;&nbsp;&nbsp;<label style='font-weight:400;'><input type='radio' style=" vertical-align: middle;   margin-top: -1px;" name='2'/>&nbsp;不合格</label></td>
					</tr>
					<tr>
						<td ><label style='margin-left:10px;'>3.证书要求</label></td>
						<td><label style='margin-left:10px;font-weight:400;'><input type='radio' style=" vertical-align: middle;   margin-top: -1px;" name='3'/>&nbsp;合格</label>&nbsp;&nbsp;&nbsp;<label style='font-weight:400;'><input type='radio' style=" vertical-align: middle;   margin-top: -1px;" name='3'/>&nbsp;不合格</label></td>
					</tr>
					<tr>
						<td ><label style='margin-left:10px;'>4.人员培训满足《维修人员培训大纲》的要求</label></td>
						<td><label style='margin-left:10px;font-weight:400;'><input type='radio' style=" vertical-align: middle;   margin-top: -1px;" name='4'/>&nbsp;合格</label>&nbsp;&nbsp;&nbsp;<label style='font-weight:400;'><input type='radio' style=" vertical-align: middle;   margin-top: -1px;" name='4'/>&nbsp;不合格</label></td>
					</tr>
					<tr>
						<td ><label style='margin-left:10px;'>5.身体健康状况：是否通过公司年度健康体检</label></td>
						<td><label style='margin-left:10px;font-weight:400;'><input type='radio' style=" vertical-align: middle;   margin-top: -1px;" name='5'/>&nbsp;合格</label>&nbsp;&nbsp;&nbsp;<label style='font-weight:400;'><input type='radio' style=" vertical-align: middle;   margin-top: -1px;" name='5'/>&nbsp;不合格</label></td>
					</tr>
					<tr>
						<td ><label style='margin-left:10px;'>6.以往奖惩记录</label></td>
						<td><label style='margin-left:10px;font-weight:400;'><input type='radio' style=" vertical-align: middle;   margin-top: -1px;" name='6'/>&nbsp;合格</label>&nbsp;&nbsp;&nbsp;<label style='font-weight:400;'><input type='radio' style=" vertical-align: middle;   margin-top: -1px;" name='6'/>&nbsp;不合格</label></td>
					</tr>
					</tbody>
					</table>
					</div>
					...
					<tbody>
					<tr><th width='100'>
					<label style='margin-left:10px;'>评估结论</label></th><td><div class='pull-left'><label style='margin-left:10px;font-weight:400;'><input type='radio'  style=" vertical-align: middle;   margin-top: -1px;" name='7'/>&nbsp;合格</label>&nbsp;&nbsp;&nbsp;<label style='font-weight:400;'><input type='radio'  style=" vertical-align: middle;   margin-top: -1px;" name='7'/>&nbsp;不合格</label></div>
					<div class='pull-right text-right'><p style='font-weight:bold'><label >评估人：<input type='text'/></label><label style='margin-left:15px;margin-right:10px;'>日期：2017-05-03</label></p></div></td></tr>
					</tbody>
					</table>
					</div>
