					...
					<div class="panel-body padding-top-0 padding-bottom-0">
						...
						<form id="form">
							<div
								...
								<input type="hidden" class="form-control " id="fjjx2" name="fjjx2" maxlength="50" readonly="readonly" />
								<input type="text" class="form-control " id="fjjx2Name" name="fjjx2Name" maxlength="50" readonly="readonly" />
								</div>
							</div>
							<div
								class="col-sm-12 col-xs-12 padding-left-0 padding-right-0 form-group">
