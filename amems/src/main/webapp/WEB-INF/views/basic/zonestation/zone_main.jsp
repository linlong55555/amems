...
<body class="page-header-fixed">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body padding-bottom-0" >
			   <%-- <div class='margin-top-0' >
				<!-- 上传按钮  -->
				<div class=" col-lg-1 col-md-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0 form-group row-height" >
					<a href="javascript:add();"  class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode='basic:zone:main:add'
					>
				...
				<div class=" col-lg-3 col-md-6 col-sm-12 col-xs-12   padding-left-0 padding-right-0  form-group" >
					...
					<div class="col-lg-9 col-md-9 col-sm-8 col-xs-10 padding-left-8 padding-right-0 label-input-div" >
						<select class='form-control row-height' id="fjjx" onchange="search();">
					    </select>
					</div>
				</div> 
				<div class=" col-lg-3 col-md-6 col-sm-12 col-xs-12   padding-left-5 padding-right-0  form-group"  >
						<span class="col-lg-3 col-md-3 col-sm-4 col-xs-2  text-right padding-left-0 padding-right-0">
					...
					<!-- 搜索框start -->
				<div class="col-lg-2 col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" style='padding-left:15px;'>
					<div class="col-xs-12 input-group input-group-search">
					<input type="text" placeholder='区域/描述'  class="form-control" id="keyword_search" >
				...
				<div class='searchContent row-height' >
					<div class=" col-lg-3 col-md-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0 form-group  checkPermission">
						<a href="javascript:add();" permissioncode='basic:zone:main:add'  class="btn btn-primary padding-top-1 padding-bottom-1 pull-left  checkPermission">
							<div class="font-size-12">新增</div>
							<div class="font-size-9">Add</div>
						</a> 
						<a href="javascript:showImportModal();" permissioncode='basic:zone:main:export' type="button" class="btn btn-primary padding-top-1 margin-left-10 padding-bottom-1 pull-left checkPermission">
							<div class="font-size-12">导入</div>
							<div class="font-size-9">Export</div>
						</a>
						<a href="javascript:exportExcel();" permissioncode='basic:zone:main:import' class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" style="float: left; margin-left: 10px;">
	...
	<%@ include file="/WEB-INF/views/basic/zonestation/zone_open.jsp" %> 
    <%@ include file="/WEB-INF/views/open_win/import.jsp"%>
	<script type="text/javascript" src="${ctx}/static/js/thjw/basic/zonestation/zone_main.js"></script>
</body>
</html>
