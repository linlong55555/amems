<%@ page contentType="text/html; charset=utf-8" pageEncoding="UTF-8"
	language="java"%>
<!-- 添加弹出框 -->
<div class="modal modal-new active in" id="AddEditAlertModal" tabindex="-1"
					...
					<div class="panel-body padding-top-0 padding-bottom-0">
						...
						<form id="form">
							<div
								...
								<div class="col-sm-10 col-xs-9 padding-leftright-8" id=fjjx_div>
									<input type="text" class="form-control" id="fjjx2" name="fjjx2" readonly/>
								</div>
							</div>
							<div
								class="col-sm-12 col-xs-12 padding-left-0 padding-right-0 form-group">
								<label
									class="col-sm-2 col-xs-3 text-right padding-left-0 padding-right-0">
									<div class="font-size-12 margin-topnew-2">
										<span style="color: red" id="hideOrShow">*</span>区域
									</div>
									<div class="font-size-9">Zone</div>
								</label>
								<div class="col-sm-10 col-xs-9 padding-leftright-8">
									<input class="form-control" id="zone2" name="zone2"/>
								</div>
							</div>
							<div
								class="col-sm-12 col-xs-12 padding-left-0 padding-right-0 form-group">
