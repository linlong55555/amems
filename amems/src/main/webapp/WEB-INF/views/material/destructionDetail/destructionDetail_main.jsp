...
var pageParam = '${param.pageParam}';
			...
			<div class="panel panel-primary">
				...
				<a href="#" onclick="exportExcel()"
					class="btn btn-primary padding-top-1 padding-bottom-1 pull-left form-group checkPermission"
					 permissioncode="aerialmaterial:destructionlist:main:01"
				...
				<div class=" pull-right padding-left-0 padding-right-0 form-group">
					<div class=" pull-left padding-left-0 padding-right-0" style="width: 250px;">
						<input type="text" placeholder='件号/序列号/批次号/销毁单号' id="keyword_search" class="form-control ">
					</div>
				...
				<div class="col-lg-12 col-sm-12 col-xs-12 triangle  padding-top-10 margin-bottom-10 display-none border-cccccc margin-top-0" id="divSearch">
					...
					<div class="col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 ">
						<span class="pull-left col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0">
							...
							<div class="font-size-9">Destruction Date</div>
						</span>
						<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input type="text" class="form-control" name="date-range-picker" id="xhrq" readonly />
						</div>
					</div>
					...
					<div class="col-lg-12 col-md-12 padding-left-0 padding-right-0 margin-top-0 table-height" style="overflow-x: auto;width: 100%;">
						<table id="quality_check_list_table" class="table table-thin table-bordered table-set" style="min-width: 1700px !important">
							...
							<th class="sorting colwidth-13" onclick="orderBy('sn')" id="sn_order">
								<div class="important">
									<div class="font-size-12 line-height-18" >序列号</div>
									<div class="font-size-9 line-height-18" >S/N</div>
								</div>
							</th>
							<th class="sorting colwidth-13" onclick="orderBy('pch')" id="pch_order">
								<div class="important">
									<div class="font-size-12 line-height-18" >批次号</div>
									<div class="font-size-9 line-height-18" >S/N</div>
								</div>
							</th>
							<th class="sorting colwidth-9" onclick="orderBy('hcjz')" id="hcjz_order">
									<div class="font-size-12 line-height-18" >航材价值</div>
									<div class="font-size-9 line-height-18" >Material Value</div>
							</th>
							<th class="sorting colwidth-13" onclick="orderBy('kccb')" id="kccb_order">
							...
							<th class="sorting colwidth-10" onclick="orderBy('xhrq')" id="xhrq_order">
							...
							<tbody id="destructionDetaillist">
							</tbody>
		...
		<script type="text/javascript"
		src="${ctx}/static/js/thjw/material/destructionDetail/destructionDetail_main.js"></script>
