...
<body>
	...
	<input type="hidden" id="reserveStatus" value="${reserveMain.zt}" />
				...
				<form id="form">
					...
					<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10">
						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input type="text" class="form-control" name="yqqx" value="<fmt:formatDate value='${reserveMain.yqqx}' pattern='yyyy-MM-dd' />" data-date-format="yyyy-mm-dd" disabled="disabled"/>
							</div>
						</div>
				...
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0" style="margin-bottom: 10px;">
	            	...
	            	<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10">
						...
						<div style="margin-top: 10px;overflow-x: auto;">
							<table class="table table-bordered table-striped table-hover table-set table-thin" style="min-width: 2000px;">
								<thead>
							   		<tr>
										<th class="colwidth-3">
...
<script type="text/javascript" src="${ctx}/static/js/thjw/material/reserve/reserve_view.js"></script>
