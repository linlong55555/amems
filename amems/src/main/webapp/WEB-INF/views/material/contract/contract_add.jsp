...
<body>
	...
	<div class="page-content" id="contract_add">
		<div class="panel panel-primary">
			...
			<div class="panel-body padding-bottom-0">
					...
					<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10">
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<select class='form-control' id='htlx' name="htlx" onchange="changeContractType()">
						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input type="text" class="form-control" id="hth" name="hth" maxlength="20" />
							</div>
						</div>
						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<!-- <select class='form-control' id='gys' name="gys" onchange = "changePrice()">
							    </select> -->
						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input class="form-control date-picker" id="htqdrq" name="htqdrq" data-date-format="yyyy-mm-dd" type="text" />
							</div>
						</div>
						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input type="text" id="fjfy" name="fjfy" class="form-control "  placeholder='' onkeyup='clearNoNumTwo(this)' />
							</div>
						</div>
						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input type="text" id="htfy" name="htfy" class="form-control "  readonly />
							</div>
						</div>
				...
				<%@ include file="/WEB-INF/views/common/message/message_list_add.jsp"%>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/material/contract/contract_add.js"></script>
