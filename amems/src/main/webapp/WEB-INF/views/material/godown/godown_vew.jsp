					...
					<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10">
						...
						<div class="col-xs-12 col-sm-6 col-lg-3  padding-left-0 padding-right-0 margin-bottom-0 ">
							<label class="pull-left col-xs-4 col-sm-4 text-right padding-left-0 padding-right-0">
								...
								<div class="font-size-9">Number Warehouses</div>
							</label>
							<div class="col-xs-8 col-sm-8 padding-left-8 padding-right-0 form-group">
							<c:choose>
						...
						<div class="col-xs-12 col-sm-6 col-lg-3  padding-left-0 padding-right-0 margin-bottom-0 form-group">
							<label class="pull-left col-xs-4 col-sm-4 text-right padding-left-0 padding-right-0">
								<div class="font-size-12">库存成本(元)</div>
								<div class="font-size-9">Inventory Costs(YUAN)</div>
							</label>
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0 input-group">
								<c:choose>
									<c:when test="${GodownEntryDetails[0].materialHistory==null}">
										<input type="text" class="form-control" name="bccb" value="" id="kccb" disabled="disabled"/>
									</c:when>
									<c:otherwise>
										<input type="text" class="form-control" name="bccb" value="${GodownEntryDetails[0].materialHistory.kccb}" id="kccb" disabled="disabled"/>
									</c:otherwise>
								</c:choose>
							</div>
						</div>
						...
						<div class="col-xs-12 col-sm-6 col-lg-3  padding-left-0 padding-right-0 margin-bottom-0 ">
							...
							data-date-format="yyyy-mm-dd" type="text" disabled="disabled"/>
							</div>
						</div>
						...
						<div class="col-xs-12 col-sm-6 col-lg-3  padding-left-0 padding-right-0 margin-bottom-10 ">
							...
							<div class="col-xs-8 col-sm-8 padding-left-8 padding-right-0 ">
									<input class="form-control " id="fhdw" name="fhdw" value="${erayFns:escapeStr(godownEntry.fhdw)}" type="text" disabled="disabled"/>
							</div>
						</div>
						...
						<div class="clearfix"></div>
					 	...
					 	<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">
							...
							<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0 ">
								<textarea disabled="disabled" class="form-control" id="bz" name="bz" maxlength="300">${erayFns:escapeStr(godownEntry.bz)}</textarea>
							</div>
						</div>
						</div>
					</div>
				...
				<div class="panel-body" id="checkingId">
				    <div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">
						 <div class="col-lg-3 col-sm-6 col-xs-12 padding-left-0 margin-bottom-0 padding-right-0 form-group">
							...
							<div id="hclyDiv"  class=" col-lg-8 col-sm-8 col-xs-8  padding-left-8 padding-right-0 form-group">
								<input disabled="disabled" type="text" class="form-control" id="hcly"   value="${GodownEntryDetails[0].materialHistory.hcly}" />
							</div> 
	                 	</div>
						...
						<div class="col-lg-3 col-sm-6 col-xs-12 padding-left-0 margin-bottom-0 padding-right-0 form-group">
							...
							<input disabled="disabled" type="text" class="form-control" id="grn" maxlength="50"  value="${erayFns:escapeStr(GodownEntryDetails[0].materialHistory.grn)}" />
							</div>
						</div>
						...
						<div class="col-lg-3 col-sm-6 col-xs-12 padding-left-0 margin-bottom-0 padding-right-0 form-group">
							...
							<div class=" col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input disabled="disabled" type="text" id="scrq"  name="scrq" class='form-control datepicker'  value="<fmt:formatDate pattern="yyyy-MM-dd" value="${GodownEntryDetails[0].materialHistory.hjsm}"/>" data-date-format="yyyy-mm-dd"/>
							</div>
						</div>
						...
						<div class="col-lg-3 col-sm-6 col-xs-12 padding-left-0 margin-bottom-0 padding-right-0 form-group">
							...
							<div class=" col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input disabled="disabled" type="text" id="hjsm"  name="hjsm" class='form-control datepicker'  value="<fmt:formatDate pattern="yyyy-MM-dd" value="${GodownEntryDetails[0].materialHistory.hjsm}"/>" data-date-format="yyyy-mm-dd"/>
							</div>
						</div>
				   ...
				   <div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">
						...
						<div class="col-lg-3 col-sm-6 col-xs-12 padding-left-0 margin-bottom-0 padding-right-0 form-group">
							...
							<div class=" col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0 form-group">
								<input disabled="disabled" type="text" value="${erayFns:escapeStr(GodownEntryDetails[0].materialHistory.tsn)}" id="tsn"  name="tsn" maxlength="50" class="form-control " />
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-xs-12 padding-left-0 margin-bottom-0 padding-right-0 form-group">
							...
							<div class=" col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0 form-group">
								<input disabled="disabled" type="text" value="${erayFns:escapeStr(GodownEntryDetails[0].materialHistory.csn)}" id="csn"  name="csn" maxlength="50" class="form-control " />
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-xs-12 padding-left-0 margin-bottom-0 padding-right-0 form-group">
							<label class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0">
							...
							<div class=" col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0 form-group">
								<input disabled="disabled" type="text" value="${erayFns:escapeStr(GodownEntryDetails[0].materialHistory.tso)}" id="tso"  name="tso"  maxlength="50" class="form-control "  />
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-xs-12 padding-left-0 margin-bottom-0 padding-right-0 form-group">
							<label class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0">
							...
							<div class=" col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0 form-group">
								<input disabled="disabled" type="text" value="${erayFns:escapeStr(GodownEntryDetails[0].materialHistory.cso)}" id="cso"  name="cso"  maxlength="50" class="form-control "  />
							</div>
						</div>
					</div>
				     <div class="col-lg-6 col-sm-12 col-xs-12 padding-left-0 margin-bottom-0 padding-right-0 form-group">
						...
						<div class="col-lg-10 col-sm-10 col-xs-8  padding-left-8 padding-right-0 form-group">
							<textarea disabled="disabled" class="form-control" id="cfyq" name="cfyq" maxlength="150" placeholder="">${GodownEntryDetails[0].materialHistory.cfyq}</textarea>
						</div>
					</div>
				     <div class="col-lg-6 col-sm-12 col-xs-12 padding-left-0 margin-bottom-0 padding-right-0 form-group">
						<label class="col-lg-2 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0">
						...
						<div class="col-lg-10 col-sm-10 col-xs-8  padding-left-8 padding-right-0 form-group">
							<textarea disabled="disabled" class="form-control" id="jybz" name="jybz" maxlength="300" placeholder="">${GodownEntryDetails[0].materialHistory.bz}</textarea>
						</div>
					</div>
			 ...
			 <div class="panel panel-default">
					...
					<div class="panel-heading padding-left-0 padding-top-3  col-xs-12  " >
						...
						<c:choose>
							...
							<select class="form-control" id="ckh" name="ckh"  onchange="onchage();" disabled="disabled">
							</select>
						</div>
							...
							<table class="table table-thin table-bordered table-striped table-hover" style="min-width:900px">
								...
								<c:forEach items="${GodownEntryDetails}" var="item" varStatus="status">
									<tr   style="cursor:pointer" >
										<input type="hidden"  name='godownEntryDetailsId' onkeyup='onkeyup4Code(this);' value="${item.id}"  readonly>
										<input type="hidden"  name='kwhs'   value='${item.materialHistory.kwid}'  readonly>
										<td style='vertical-align: middle; ' align='left' >
											<select class='form-control' name='kwh' disabled="disabled">
											</select>
										</td>
										...
										<td style='vertical-align: middle; ' align='right'>
											<input type='text' class='form-control' disabled="disabled" name='kcsl' value='${item.materialHistory.kcsl}' onkeyup='clearNoNum(this);'>
										</td>
									</tr>
								</c:forEach>
								</tbody>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/material/godown/godown_vew.js"></script>
