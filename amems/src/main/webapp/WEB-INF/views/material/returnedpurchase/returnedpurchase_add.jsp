...
<input type="hidden" value="${user.jgdm}" id="dprtcode">
					...
					<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10">
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class='input-group'>
								...
								<input class="form-control " type="hidden" value="${user.id}" type="text" id="thrid" name="thrid" readonly="readonly" />
								<input class="form-control" type="hidden"  id="thbmid" value="${user.bmdm}" readonly />
						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input class="date-picker form-control" id="thrq" name="thrq" data-date-format="yyyy-mm-dd" type="text" readonly/>
							</div>
						</div>
						...
						<div class="col-xs-8 col-sm-8 padding-left-8 padding-right-0 form-group">
								<input id="fhdw" class="form-control" type="text" maxlength="160"  />
						</div>
					</div>
						<div class="clearfix"></div>
					 	<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">
							...
							<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0 ">
								<textarea class="form-control" id="bz" name="bz" maxlength="300" placeholder="长度最大为300"></textarea>
							</div>
						</div>
					</div>
				</form>
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/material/returnedpurchase/returnedpurchase_add.js"></script>
