...
<body >
	<input type="hidden" id="adjustHeight" value="244">
	<div class="page-content ">
		<div class="panel panel-primary">
			<div class="panel-heading" id="NavigationBar"></div>		
			<div class="panel-body padding-bottom-0">
					
				<div id="audit" class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10  row-height">
					...
					<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						...
						<div id="shsj" class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							
						</div>
					</div>
					
					<div style="padding-left:0!important;margin-left:40px;" class="col-xs-1 pull-left ">   
						<button type="button" class=" btn btn-primary padding-top-1 padding-bottom-1 checkPermission" permissioncode="aerialmaterial:takestock:history:03" onclick="audit();">
				...
				<div class="col-sm-2 padding-left-0 border-r">
					<ul class="pandian">
				...
				<div class="col-sm-10">
					...
					<div class="pull-left padding-left-0 padding-right-0 margin-bottom-10" >   
                   		<label style=' font-weight:normal'><input type="radio" name="viewType" value="1" checked=true onclick="searchRevision()"/>
                   		全部</label>
                   		&nbsp;
                   		&nbsp;
                   		<label style=' font-weight:normal'><input type="radio" name="viewType" value="2"  onclick="searchRevision()" />
                   		盈亏</label>
                   		&nbsp;
                   		&nbsp;
                   		<label style=' font-weight:normal'><input type="radio" name="viewType" value="3" onclick="searchRevision()" />
                   		盈</label>
                   		&nbsp;
                   		&nbsp;
                   		<label style=' font-weight:normal'><input type="radio" name="viewType" value="4" onclick="searchRevision()" />
                   		亏</label>
                   		&nbsp;
                   		&nbsp;
                   		&nbsp;
					...
					<div class="col-xs-12 col-lg-12 col-sm-12 table-m  padding-left-0 padding-right-0" style="margin-top: 10px;overflow-x: scroll;">
						<table id="take_audit_table" class="table table-thin table-bordered table-striped table-hover table-set" style="min-width: 1400px;">
							<thead>
								<tr>
									<th class="colwidth-3" >
...
<script type="text/javascript" src="${ctx}/static/js/thjw/material/takestock/takeStock_audit.js"></script>	
</body>
</html>