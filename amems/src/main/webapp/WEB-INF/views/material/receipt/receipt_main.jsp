...
<body class="page-header-fixed">
	...
	<div class="page-content">
		...
		<div class="panel-heading" id="NavigationBar"></div>
				...
				<div class="padding-left-0 pull-left form-group" style='margin-right:8px;'>
					<button class="btn btn-primary padding-top-1 padding-bottom-1 checkPermission" 
					permissioncode="aerialmaterial:receipt:add" type="button" onclick="goToAddPage();">
				...
				<div class=" pull-right padding-left-0 padding-right-0 form-group" >
					...
					<div class=" pull-left padding-left-0 padding-right-0" style="width:250px;" >
						<input placeholder="收货单号/相关单据/收货人" id="keyword_search" class="form-control " type="text">
					</div>
                    <div class=" pull-right padding-left-5 padding-right-0 ">   
						<button type="button" class=" btn btn-primary padding-top-1 padding-bottom-1 " onclick="searchReceipt();">
				...
				<div class="col-lg-12 col-sm-12 col-xs-12 triangle  padding-top-10 margin-bottom-10 display-none border-cccccc margin-top-0" id="divSearch">
					<div class="col-xs-12 col-sm-6 col-lg-3  padding-left-0 padding-right-0 margin-bottom-10 ">
						<span class="pull-left col-xs-4 col-sm-4 text-right padding-left-0 padding-right-0">
							...
							<div class="font-size-9">Receipt Type</div>
						</span>
						<div class="col-xs-8 col-sm-8 padding-left-8 padding-right-0">
							<select class='form-control' id='shlx'>
					...
					<div class="col-xs-12 col-sm-6 col-lg-3  padding-left-0 padding-right-0 margin-bottom-10 ">
						<span class="pull-left col-xs-4 col-sm-4 text-right padding-left-0 padding-right-0">
							...
							<div class="font-size-9">Receipt Date</div>
						</span>
						<div class="col-xs-8 col-sm-8 padding-left-8 padding-right-0">
								<input type="text" class="form-control" name="date-range-picker" id="shrq" readonly />
						</div>
					</div>
				...
				<div class="col-lg-12 col-md-12 padding-left-0 padding-right-0 margin-top-0 table-height" style="overflow-x: scroll;">
					<table id="receipt_main_table" class="table table-thin table-bordered table-striped table-hover table-set" style="min-width:1890px">
						<thead>
							<tr>
								...
								<th id="shdh_order"  class="sorting colwidth-15" onclick="orderBy('shdh')">
									<div class="important">
										<div class="font-size-12 line-height-18">收货单号</div>
										<div class="font-size-9 line-height-18">Receipt No.</div>
									</div>
								</th>
								<th id="shlx_order" class="sorting colwidth-10" onclick="orderBy('shlx')" >
								...
								<th class="colwidth-15">
									<div class="important">
										...
										<div class="font-size-9 line-height-18">Related Form</div>
									</div>
								</th>
								<th class="colwidth-15">
								...
								<th id="zt_order"  class="sorting colwidth-10" onclick="orderBy('zt')" >
									<div class="font-size-12 line-height-18">状态</div>
									<div class="font-size-9 line-height-18">State</div>
								</th>
								<th class="colwidth-20 downward cursor-pointer" onclick="vieworhideZjqkContentAll()" name="th_zjqk">
									<div class="font-size-12 line-height-18">质检情况</div>
									<div class="font-size-9 line-height-18">Quality inspection</div>
								</th>
								<th class="colwidth-20 downward cursor-pointer" onclick="vieworhideWorkContentAll()" name="th_return">
									<div class="font-size-12 line-height-18" >退货情况</div>
								...
								<th id="shrq_order" class="colwidth-13 sorting" onclick="orderBy('shrq')" >
								...
								<th id="dprtcode_order"  class="sorting colwidth-15" onclick="orderBy('dprtcode')">
...
<script type="text/javascript" src="${ctx}/static/js/thjw/material/receipt/receipt_main.js"></script>
</body>
</html>