			...
			<div class="panel-body">
				<form id="form">
					...
					<div class=" col-xs-8 padding-left-8 padding-right-0 input-group">
						...
						<input type="text" class="form-control" name="inventorysqr" id="inventorysqr" value="${erayFns:escapeStr(user.username)} ${erayFns:escapeStr(user.realname)}" readonly />
								<input type="hidden" name="inventorysqbmid" id="inventorysqbmid" value="${user.bmdm}"/>
								<input type="hidden"  name="inventorysqrid" id="inventorysqrid" value="${user.id}"/>
				...
				<div class="panel-heading padding-left-16 padding-top-3 padding-bottom-10  col-xs-12 margin-bottom-10 " style="border-bottom: 1px solid #ccc;">
	            	...
	            	<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10">
						...
						<div class="overflow-auto">
							<table id="detailTable" class="table table-bordered table-striped table-hover table-set" style="min-width:1500px">
								<thead>
							   		<tr>
								...
								<tbody id="detailTBody">
									...
									<input  type="hidden" name="id" value="${item.id}"><input  type="hidden" name="bjh" value="${erayFns:escapeStr(item.bjh)}">${erayFns:escapeStr(item.bjh)}
										...
										<td style="vertical-align: middle;" class="text-left">
										<input class="form-control" type="text" name="cksl" placeholder="长度最大为10" onkeyup="clearNoNum(this)"   maxlength="10">
										</td>
							 		 </tr>		
									</c:forEach>
								</tbody>
...
<div class="modal fade" id="alertModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria- hidden="true">
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/material/outstock/dumpingbackout_history.js"></script>
