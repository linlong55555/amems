...
<body class="page-header-fixed">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div id="borrow_view_form">
					<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">
						<div class="panel-heading margin-left-16 padding-top-3 margin-bottom-10 " style="border-bottom: 1px solid #ccc;">
							...
							<input type="hidden" id="borrowApplyId" value="${borrowApplyId}"/>
						...
						<div class="col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group">
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<select class="form-control"  name="borrow_view_jddxlx" id="borrow_view_jddxlx" disabled>
								</select>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group">
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input type="hidden" class="form-control"  name="borrow_view_jddx" id="borrow_view_jddx"/>
								<input type="text" class="form-control"  name="borrow_view_jddxms" id="borrow_view_jddxms" readonly/>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group">
							<label class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0">
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input class="form-control"  name="borrow_view_fjzch" id="borrow_view_fjzch" readonly/>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group">
							<label class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0">
						...
						<div class="col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group">
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0 input-group">
								<input type="text" class="form-control" name="borrow_view_sqrmc" id="borrow_view_sqrmc"  readonly />
								<input type="hidden" id="borrow_view_sqrid" />
								<input type="hidden" id="borrow_view_sqbmid" />
						...
						<div class="col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group">
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0 input-group">
								<input type="text" class="form-control" name="borrow_view_rkrmc" id="borrow_view_rkrmc"  readonly />
								<input type="hidden" id="borrow_view_rkrid" />
								<input type="hidden" id="borrow_view_rkbmid" />
								<span class="input-group-btn">
				...
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0" style="overflow-x:auto;">
					<table class="table table-thin table-bordered table-hover table-set" style="min-width:1550px">
						<thead>
							<tr>
								<th class="colwidth-3">
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/material/instock/borrow_instock_view.js"></script>
</body>
</html>