...
<body>
	...
	<div class="page-content">
			   ...
			   <form id="form" >
					...
					<div class="col-lg-8 col-sm-8 col-xs-12 padding-left-0 padding-right-0 form-group" >
						<label  class="col-xs-3 text-right padding-left-0 padding-right-0"><div
							...
							<div class=" col-xs-9 padding-left-8 padding-right-0">
							<input  type="text" class="form-control" maxlength="50" id="menuCode" name="menuCode" >
						</div>
					</div>
					...
					<div class=" col-lg-8 col-sm-8 col-xs-12  padding-left-0 padding-right-0 form-group">
						<label class="col-xs-3 text-right padding-left-0 padding-right-0"><div
						 ...
						 <div class="col-xs-9 padding-left-8 padding-right-0" >
							<input  type="text" class="form-control " maxlength="30" id="menuName" name="menuName" >
						</div>
					</div>
					<div class="clearfix"></div>
					...
					<div class=" col-lg-8 col-sm-8 col-xs-12  padding-left-0 padding-right-0 form-group">
						<label class="col-xs-3 text-right padding-left-0 padding-right-0"><div
						 ...
						 <div class="col-xs-9 padding-left-8 padding-right-0" >
							<input  type="text" class="form-control "  maxlength="100" id="menuFname"  name="menuFname">
						</div>
					</div>
					<div class="clearfix"></div>
					...
					<div class=" col-lg-8 col-sm-8 col-xs-12  padding-left-0 padding-right-0 form-group">
						<label class="col-xs-3 text-right padding-left-0 padding-right-0"><div
						 ...
						 <div class="col-xs-9 padding-left-8 padding-right-0" >
							<input type="text" class="form-control " maxlength="100"  id="iconPath"  name="iconPath">
						</div>
					</div>
					<div class="clearfix"></div>
					...
					<div class=" col-lg-8 col-sm-8 col-xs-12  padding-left-0 padding-right-0 form-group">
						<label class="col-xs-3 text-right padding-left-0 padding-right-0"><div
						 ...
						 <div class="col-xs-9 padding-left-8 padding-right-0" >
							<input placeholder='请输入数字...' onkeyup='clearNoNum(this)' maxlength="9" type="text" class="form-control "  id="menuOrder"  >
						</div>
					</div>
					<div class="clearfix"></div>
					...
					<div class=" col-lg-8 col-sm-8 col-xs-12  padding-left-0 padding-right-0 form-group">
						<label class="col-xs-3 text-right padding-left-0 padding-right-0"><div
						 ...
						 <div class="col-xs-9 padding-left-8 padding-right-0" >
							<input placeholder='请输入数字...' onkeyup='clearNoNum(this)' maxlength="9" type="text" class="form-control "   id="fullOrder">
						</div>
					</div>
					 <div class="clearfix"></div>
				...
				<div class=" pull-right" style="margin-bottom: 10px;">
				       <a href="javascript:void()" data-toggle="modal"  class="btn btn-primary padding-top-1 padding-bottom-1 pull-left"
						id="saveAddMenu"   style="float: left; margin-left: 10px;"><div class="font-size-12">保存</div>
	 ...
	 <script type="text/javascript" src="${ctx }/static/js/thjw/sys/add_menu.js"></script>  
</body>
</html>
