...
<body>
	<body class="page-header-fixed">
		...
		<input type="hidden" id="routinginspectionrecordId" name="routinginspectionrecordId" value=${routinginspectionrecord.id} />
		<input type="hidden" id="routinginspectionrecordDprtcode" name="routinginspectionrecordDprtcode" value=${routinginspectionrecord.dprtcode} />
		<!-- BEGIN CONTENT -->
<script type="text/javascript">
var pageParam = '${param.pageParam}';
$(document).ready(function(){
//导航
Navigation(menuCode,"修改巡检记录单","Edit");
});
</script>
			...
			<form id="form">
					<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
								class="font-size-12 line-height-18">巡视单编号</div>
							<div class="font-size-9 line-height-18">Patrol No.</div></label>
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control date-picker"  id="xjxmbh" name="xjxmbh" type="text" disabled="disabled" value="${erayFns:escapeStr(routinginspectionrecord.xjbh)}" />
						</div>
					</div>
					...
					<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class=" col-xs-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0 input-group">
								...
								<input class="form-control date-picker" id="xsrmc" name="xsrmc" type="text" onchange="usernameChange()" value="${erayFns:escapeStr(routinginspectionrecord.xsrmc)}" />
								<input class="form-control date-picker" id="xsrmcOld" name="xsrmcOld" type="hidden" value="${erayFns:escapeStr(routinginspectionrecord.xsrmc)}" />
								<input class="form-control date-picker" id="xsrid" name="xsrid" type="hidden" value="${routinginspectionrecord.xsrid}" />
					...
					<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control date-picker"  id="xsrq" name="xsrq" data-date-format="yyyy-mm-dd" type="text" value=<fmt:formatDate value='${routinginspectionrecord.xsrq}' pattern='yyyy-MM-dd ' /> />
						</div>
					</div>
					...
					<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control date-picker"  id="kssj" name="kssj" type="text" maxlength="20" value="${erayFns:escapeStr(routinginspectionrecord.kssj)}" />
						</div>
					</div>
					...
					<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control date-picker"  id="jssj" name="jssj" type="text" maxlength="20" value="${erayFns:escapeStr(routinginspectionrecord.jssj)}" />
						</div>
					</div>
					...
					<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								...
								<option value="1" <c:if test="${routinginspectionrecord.isYhxs eq 1 }">selected='selected'</c:if>>是</option>
								<option value="0" <c:if test="${routinginspectionrecord.isYhxs eq 0 }">selected='selected'</c:if>>否</option>
								</select>
						</div>
					</div>
					<div class="clearfix"></div>
								...
								<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0 form-group" >
									<table class="table table-thin table-bordered table-striped table-hover text-center">
											...
											<td width="11%" class='text-left'>
												<input id="detailId0101" name="detailId0101" type="hidden">
											...
											<td class='text-left'>
												<input id="detailId0102" name="detailId0102" type="hidden">
											...
											<td class='text-left'>
												<input id="detailId0103" name="detailId0103" type="hidden">
											...
											<td class='text-left'>
												<input id="detailId0104" name="detailId0104" type="hidden">
											...
											<td class='text-left'>
												<input id="detailId0105" name="detailId0105" type="hidden">
											...
											<td class='text-left'>
												<input id="detailId0201" name="detailId0201" type="hidden">
											...
											<td class='text-left'>
												<input id="detailId0301" name="detailId0301" type="hidden">
											...
											<td class='text-left'>
												<input id="detailId0302" name="detailId0302" type="hidden">
											...
											<td class='text-right'>疑似新增超高物</td>
											<td class='text-left'>
												<input id="detailId0401" name="detailId0401" type="hidden">
											...
											<td class='text-left'>
												<input id="detailId0501" name="detailId0501" type="hidden">
											...
											<td class='text-left'>
												<input id="detailId0601" name="detailId0601" type="hidden">
											...
											<td class='text-left'>
												<input id="detailId0701" name="detailId0701" type="hidden">
											...
											<td class='text-left'>
												<input id="detailId0801" name="detailId0801" type="hidden">
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/airportensure/routinginspectionrecord/routinginspectionrecord_edit.js"></script>
