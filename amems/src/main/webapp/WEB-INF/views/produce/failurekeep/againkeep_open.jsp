							...
							<div class="panel-body padding-bottom-0 padding-left-0 padding-right-0  padding-top-0">	 	
								<div class="col-xs-12 margin-top-8 padding-left-0  padding-right-0" >
									...
									<!-- <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group" >
										<label class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
											<div class="font-size-12 margin-topnew-2">
												<label class="required" style="color: red"></label>首次保留期限
											</div>
											<div class="font-size-9 ">First Expiry Date</div>
										</label>
										<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 ">
											<input type="text" readonly="readonly" id="Againkeep_Open_Modal_blqx" name="Againkeep_Open_Modal_blqx" class="noteditable form-control padding-left-3 padding-right-3"  />
										</div>
									</div> -->
									...
									<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group" >
										...
										<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 ">
											<input type="text"  id="zcSqrq" name="zcSqrq" onchange="again_keep_open.onchangebllx(2)" class="noteditable form-control padding-left-3 padding-right-3 date-picker"  />
										</div>
									</div>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/produce/failurekeep/againkeep_open.js"></script><!--再次保留弹窗的js  -->
