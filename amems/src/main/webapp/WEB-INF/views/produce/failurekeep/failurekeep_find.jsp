  						...
  						<div class="panel panel-default padding-right-0">
							...
							<div class="panel-body padding-bottom-0 padding-left-0 padding-right-0  padding-top-0">	 	
								 ...
								 <div class='clearfix'></div>
								   ...
								   <!--部件号 -->
									<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
										...
										<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 ">
											<input id="gzblBjh" type="text" maxlength="100" class="noteditable form-control padding-left-3 padding-right-3"  />
										</div>
									</div>
									<!--序列号 -->
									<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
										...
										<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 ">
											<input id="gzblXlh" type="text" maxlength="100" class="noteditable form-control padding-left-3 padding-right-3"  />
										</div>
									</div>
								 ...
								 <div class='clearfix'></div>
								 	...
								 	<div id="bllbDiv" class="col-lg-12 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group" >
										...
										<div class="col-lg-11 col-md-10 col-sm-9 col-xs-10 padding-leftright-8" >
					                    	 <span class='label-input'><input type='radio' onclick="FailureKeep_Open_Modal.onchangebllx();" class="noteditable" name='bllx' value="1" checked />&nbsp;A&nbsp;</span>
					                    	 <span class='label-input'><input type='radio' onclick="FailureKeep_Open_Modal.onchangebllx();" class="noteditable" name='bllx' value="2"/>&nbsp;B&nbsp;</span>
					                    	 <span class='label-input'><input type='radio' onclick="FailureKeep_Open_Modal.onchangebllx();" class="noteditable" name='bllx' value="3" />&nbsp;C&nbsp;</span>
					                    	 <span class='label-input'><input type='radio' onclick="FailureKeep_Open_Modal.onchangebllx();" class="noteditable" name='bllx' value="4" />&nbsp;D&nbsp;</span>
					                    	 <span class='label-input'><input type='radio' onclick="FailureKeep_Open_Modal.onchangebllx();" class="noteditable" name='bllx' value="5" />&nbsp;CDL&nbsp;</span>
					                    	 <span class='label-input'><input type='radio' onclick="FailureKeep_Open_Modal.onchangebllx();" class="noteditable" name='bllx' value="9" />&nbsp;其他&nbsp;</span>
										</div>
									</div>
								...
								<div class="col-lg-11 col-sm-11 col-xs-11 form-group" style="padding-left: 9%;padding-right: 55px; ">
									...
									<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group" id="scBlqxDiv" >
										<span class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
											<div class="font-size-12 margin-topnew-2">
												<label class="required" style="color: red"></label>
												日历
				...
				<div class="panel panel-default padding-right-0  margin-top-10">
					...
					<div class="panel-body padding-bottom-0 padding-left-0 padding-right-0  padding-top-0">	 	
						<div class="col-xs-12 margin-top-8 padding-left-0  padding-right-0" >
							...
							<div id="zcbllbDiv" class="col-lg-12 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group" >
								<label class="col-lg-1 col-md-2 col-sm-3 col-xs-2 text-right padding-left-0 padding-right-0">
										<div class="font-size-12 margin-topnew-2">保留类别</div>
										<div class="font-size-9 ">Type</div>
								</label>
								<div class="col-lg-11 col-md-10 col-sm-9 col-xs-10 padding-leftright-8" >
			                    	 <span class='label-input'><input type='radio' onclick="again_keep_open.onchangebllx(1);" class="noteditable" name='bllx2' value="1" checked />&nbsp;A&nbsp;</span>
			                    	 <span class='label-input'><input type='radio' onclick="again_keep_open.onchangebllx(1);" class="noteditable" name='bllx2' value="2"/>&nbsp;B&nbsp;</span>
			                    	 <span class='label-input'><input type='radio' onclick="again_keep_open.onchangebllx(1);" class="noteditable" name='bllx2' value="3" />&nbsp;C&nbsp;</span>
			                    	 <span class='label-input'><input type='radio' onclick="again_keep_open.onchangebllx(1);" class="noteditable" name='bllx2' value="4" />&nbsp;D&nbsp;</span>
			                    	 <span class='label-input'><input type='radio' onclick="again_keep_open.onchangebllx(1);" class="noteditable" name='bllx2' value="5" />&nbsp;CDL&nbsp;</span>
			                    	 <span class='label-input'><input type='radio' onclick="again_keep_open.onchangebllx(1);" class="noteditable" name='bllx2' value="9" />&nbsp;其他&nbsp;</span>
								</div>
							</div>
						    ...
						    <div class="col-lg-11 col-sm-11 col-xs-11 form-group" style="padding-left: 9%;padding-right: 55px; ">
						 	...
						 	<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group" id="zcBlqxDiv" >
								<span class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
										<div class="font-size-12 margin-topnew-2">
											<span class="required icon-zcblqx" style="color: red">*</span>日历
										</div>
										<div class="font-size-9 ">Date</div>
								</span>
								<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 ">
							 ...
							 <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group" id="fhDiv2">
								...
								<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 ">
								     <div class="input-group" style='width:100%;'> 
								     	<input readonly="readonly" class="form-control input-sm" maxlength="10" onkeyup="FailureKeep_Open_Modal.validateFH(this)" type="text" id="zcFhInput">
								     	<span class="input-group-addon dw" style="min-width:45px;background-color:white;font-size: 12px;padding: 0 0 0 0;">FH</span>
								     </div>
								</div>
							</div>
							...
							<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group"  id="fcDiv2">
								...
								<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 ">
								     <div class="input-group" style='width:100%;'> 
								     <input readonly="readonly" class="form-control input-sm" maxlength="10" onkeyup="FailureKeep_Open_Modal.validateFC(this)" type="text" id="zcFcInput">
								     <span class="input-group-addon dw" style="min-width:45px;background-color:white;font-size: 12px;padding: 0 0 0 0;">FC</span>
								     </div>
								</div>
							</div>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/produce/failurekeep/failurekeep_find.js"></script><!--查看故障保留弹窗的js  -->
</body>
</html>