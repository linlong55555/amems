			  ...
			  <div  class='searchContent row-height' >
				<div class='margin-top-0'>
					<div class=" col-lg-3 col-md-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0  form-group">
						...
						<a href="javascript:exportExcel();"  class="btn btn-primary padding-top-1 margin-left-10 padding-bottom-1 pull-left  checkPermission" permissioncode='produce:reservation:defect:main:08'>
...
<!--日志END  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/produce/defectkeep/defectkeep_main.js"></script><!--当前界面js  -->
<%@ include file="/WEB-INF/views/produce/defectkeep/defectkeep_open.jsp" %> <!--新增编辑界面  -->
