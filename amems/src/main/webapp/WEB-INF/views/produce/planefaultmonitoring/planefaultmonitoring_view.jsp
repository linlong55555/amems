				...
				<div class="panel-body col-xs-12">
				    <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<span  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="font-size-9 line-height-18">A/C REG</div></span>
					   ...
					   <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<span  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="font-size-9 line-height-18">Failure times</div></span>
					  ...
					  <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<span  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="font-size-9 line-height-18">Latest date</div></span>
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-10 padding-right-0">					
					  ...
					  <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<span  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="font-size-9 line-height-18">Status</div></span>
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-10 padding-right-0">							
						...
						<span  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="font-size-9 line-height-18">ATA</div></span>
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-10 padding-right-0">
							<span><input type="text"  class="form-control" title="${erayFns:escapeStr(planeFaule.paramsMap.zjhms)}" disabled="disabled" value="${erayFns:escapeStr(planeFaule.paramsMap.zjhms)}"  />
							</span>
						</div>
					  </div>
					  <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<span  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="font-size-9 line-height-18">Maintainer</div></span>
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-10 padding-right-0">
					  ...
					  <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<span  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="font-size-9 line-height-18">Maintenace Time</div></span>
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-10 padding-right-0">
					  ...
					  <div class=" col-lg-12 col-sm-12 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<span  class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0"><div
								class="font-size-12 line-height-18">故障信息</div>
							<div class="font-size-9 line-height-18">Fault info</div></span>
							<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0">
							<textarea class="form-control" title="${erayFns:escapeStr(planeFaule.gzxx) }" id="gzxx" name="gzxx"  maxlength="1300" style="min-height:80px" disabled='disabled'>${erayFns:escapeStr(planeFaule.gzxx) }</textarea>
						</div>
					  </div>
					   
					 <div class=" col-lg-12 col-sm-12 col-xs-12  padding-left-0 margin-bottom-10 padding-right-0 form-group">
								<span class="col-lg-1 col-sm-1 col-xs-2 text-right padding-left-0 padding-right-0 padding-top-8"  >
								...
								<div class="col-lg-11 col-sm-11 col-xs-10 padding-left-8 form-group padding-right-0 " style='margin-bottom:0px;'>
									<textarea class="form-control" id="bz" title="${erayFns:escapeStr(planeFaule.bz) }" name="bz"  maxlength="600" style="min-height:80px" disabled='disabled'>${erayFns:escapeStr(planeFaule.bz) }</textarea>
					</div>
					</div>
					 <div class="col-lg-12 col-sm-12 col-xs-12  padding-left-0 margin-bottom-0 padding-right-0 form-group" >
						<span  class="col-lg-1 col-sm-1 col-xs-2 text-right padding-left-0 padding-right-0 padding-top-0"><div
								class="font-size-12 line-height-18">附件</div>
							<div class="font-size-9 line-height-18">Enclosure</div></span>
					  ...
					  <div class="col-lg-12 col-sm-12 col-xs-12  padding-left-0 margin-bottom-0 padding-right-0 padding-top-5 form-group" style="overflow: auto;min-width: 900px" >
						<span  class="col-lg-1 col-sm-1 col-xs-2 text-right padding-left-0 padding-right-0 padding-top-0"><div
							...
							<div class="font-size-9 line-height-18">Single fault processing</div></span>
							<div class="col-lg-11 col-sm-11 col-xs-10 padding-left-8  padding-right-0">
							...
							<thead>
								<tr>
									...
									<th class="colwidth-10 " >
										...
										<div class="font-size-9 line-height-18">Instruction number</div></th>
									...
									<th class="colwidth-13 "  name="fj">
										<div class="font-size-12 line-height-18">附件</div>
										<div class="font-size-9 line-height-18">Enclosure</div></th>
								</tr>
							</thead>
