...
<input type="hidden" id="userType" value="${user.userType}" />
		...
		<div class="page-content">
			<div class="panel panel-primary">
				...
				<div class=" panel-body padding-bottom-0" >
					...
					<div class=' margin-top-0 searchContent  row-height'>
						<div class=" col-lg-6 col-md-6 col-sm-12 col-xs-12   padding-left-0 padding-right-0  form-group">
							<a href="javascript:add();"  permissioncode="aircraftinfo:main:01"  class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission">
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" style='padding-left:15px;'>
							<div class="col-xs-12 input-group input-group-search">
			                    ...
			                    <div class="input-group-addon btn-searchnew" >
			                    	<button id="aircraftinfoMainSearch" type="button" class=" btn btn-primary padding-top-1 padding-bottom-1" onclick="aircraftinfoMain.reload();" style='margin-right:0px !important;'>
				...
				<div class="clearfix"></div>
					...
					<div id="aircraftinfo_main_table_top_div" class="col-lg-12 col-md-12 padding-left-0 margin-top-0 padding-right-0 table-height table-set" style="overflow-x: auto;width: 100%;">
						<table id="quality_check_list_table" class="table table-thin table-striped table-bordered table-set table-hover" >
							<thead>
								<tr>
									...
									<th class="sorting colwidth-8" onclick="orderBy('fjjx')" id="fjjx_order">
									...
									<th class="sorting colwidth-9" onclick="orderBy('scrq')" id="scrq_order">
										<div class="font-size-12 line-height-18">生产日期</div>
										<div class="font-size-9 line-height-18">PD</div>
									</th>
									<th class="sorting colwidth-9" onclick="orderBy('ccrq')" id="ccrq_order">
										<div class="font-size-12 line-height-18">出厂日期</div>
										<div class="font-size-9 line-height-18">MFD</div>
									</th>
									<th class="sorting colwidth-9" onclick="orderBy('gmrq')" id="gmrq_order">
									...
									<th class="sorting colwidth-7" onclick="" id="">
										...
										<div class="font-size-9 line-height-18">Remains</div>
									</th>
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/produce/aircraftinfo/aircraftinfo_main.js"></script>
