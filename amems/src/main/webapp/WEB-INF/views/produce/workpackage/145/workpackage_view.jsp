			...
			<div class="panel-body">
				<div class="panel panel-primary" >
					...
					<div class="panel-body" style="padding-bottom:0px;padding-left:0px;padding-right:0px">
						...
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-8 form-group">
							...
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
								<input type="text" class="form-control " id="ms" name="ms" maxlength="100" disabled="disabled" />
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-8 form-group">
							<span class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
							...
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
								<input type="text" class="form-control " id="wxlx" name="wxlx" maxlength="15" disabled="disabled" />
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-8 form-group">
							<span class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
								<div class="font-size-12 ">工包状态</div>
								<div class="font-size-9">Status</div>
							</span>
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
								<input type="text" class="form-control " id="gbzt" name="gbzt"  disabled="disabled" />
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-8 form-group">
						<span class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<span class='margin-right-15 label-input'>	<input type="radio" name="xfdw_radio" value="0" checked="checked" disabled="disabled"/>&nbsp;内部</span>
							<span class='margin-left-15 label-input'>	<input type="radio" name="xfdw_radio" value="1" disabled="disabled" />&nbsp;外委</span>
						</div>						
					</div>
					<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-8 form-group" id="xfdw_bmdiv">
						<span class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<div class='input-group ' style="min-width:100%">
								<input type="text"  value="" name="xfdw" disabled="disabled" class="form-control " placeholder='' maxlength="100" 
									id="xfdw">							
							</div>
						</div>					
					</div>
					 <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-8 form-group" id="xfdw_khxxdiv">
							<span class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
								<div class="font-size-12 ">客户信息</div>
								<div class="font-size-9">Customer Info</div>
							</span>
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
								<input type="text" value="" name="workpackage_modal_khxx" class="form-control" disabled="disabled"  id="gzworkpackage_modal_khxx"/>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-8 form-group" id="workpackage_modal_xfdw_xmbhdiv">
							<span class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
							...
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0  ">
								<div class='input-group ' style="min-width:100%">
									<input type="text" value="" name="xmbh" disabled="disabled" class="form-control"
									 id="xmbh"  />				
								</div>
							</div>					
						</div>
				...
				<div  id='bottom_hidden_content' class='displayContent' style='overflow-x: auto;'>
				  	<ul id="myTab" class="nav nav-tabs">
                      	<li class="active"><a href="#Dropdown" data-toggle="tab" aria-expanded="false">工单明细</a></li>
...
<!--                       	</div> -->
	...
	<script src="${ctx}/static/js/thjw/produce/workpackage/145/workpackage_view.js"></script>
