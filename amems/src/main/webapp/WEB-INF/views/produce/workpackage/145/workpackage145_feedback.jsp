            ...
            <div class="modal-body" >
              	...
              	<div class="input-group-border">										
					...
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-4 col-sm-4 col-xs-4 padding-left-0 padding-right-8">
...
<!--  弹出框结束-->
 <script type="text/javascript" src="${ctx }/static/js/thjw/produce/workpackage/145/workpackage145_feedback.js"></script>