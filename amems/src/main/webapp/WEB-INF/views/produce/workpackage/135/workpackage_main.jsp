				...
				<div class="panel-body padding-bottom-0">
				 <div  class='searchContent row-height'>
				 	<div class='margin-top-0'>
						<div class=" col-lg-3 col-md-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0  form-group ">
							<a href="javascript:add();"  class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission"
								permissioncode='produce:workpackage:main:01'>
							...
							<a href="#" onclick="exportExcel()"  class="btn btn-primary padding-top-1 margin-left-10 padding-bottom-1 pull-left checkPermission"
								permissioncode='produce:workpackage:main:11' >
						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" >
							...
							<span  class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-right padding-left-0 padding-right-0">
								<span class='margin-right-10 label-input'>
									<input type="radio" name="zxdw_search_radio" value="-1" checked="checked" onclick="clickZxdw()"/>
									全部
								</span>
								<span class='margin-right-10 label-input'>
									<input type="radio" name="zxdw_search_radio" value="0" onclick="clickNbZxdw()"/>
									内部
								</span>
								<span class='label-input'>
									<input type="radio" name="zxdw_search_radio" value="1" onclick="clickWbZxdw()" />
									外委
								</span>
							</span>
							<span  class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-right padding-left-8 padding-right-0">
						...
						<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" style='padding-left:15px;'>
							...
							<input type="text" placeholder='工包编号/描述/预计执行单位'  class="form-control" id="wp_keyword_search" >
					...
					<div class="col-lg-12 col-sm-12 col-xs-12 triangle  padding-top-10 margin-bottom-10 display-none border-cccccc margin-top-0" id="divSearch">
						...
						<div class="col-lg-3 col-sm-6 col-xs-12   padding-left-0 padding-right-0 form-group ">
							<span class="pull-left col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0">
								<div class="font-size-12">下发日期</div>
								<div class="font-size-9">Date</div>
							</span>
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input type="text" class="form-control date-range-picker" name="date-range-picker" id="xfqx_search" readonly />
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-xs-12   padding-left-0 padding-right-0 form-group ">
							<span class="pull-left col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0">
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input type="text" class="form-control date-range-picker" name="date-range-picker" id="jhwcrq_search" readonly />
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-xs-12   padding-left-0 padding-right-0 form-group ">
							<span class="pull-left col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0">
				...
				<div class='table_pagination'>				
					<div class="col-lg-12 col-md-12 padding-left-0 margin-top-0 padding-right-0 table-height table-set" c-height="40%" style="overflow-x: auto;" id="packing_list_table_div">
						<table id="packing_list_table" class="table table-thin table-bordered table-striped table-hover table-set" style="min-width: 1700px !important">
							...
							<th class="sorting colwidth-10" onclick="orderBy('zdrq')" id="zdrq_order">
							...
							<th class="sorting colwidth-9" onclick="orderBy('gbxfdwid')" id="gbxfdwid_order">
							...
							<th class="sorting colwidth-20" onclick="orderBy('gbxfdwid')" id="gbxfdwid_order">
								<div class="important">
							...
							<th class="sorting colwidth-10" onclick="orderBy('wgbs')" id="wgbs_order">
...
<!-- 		                      	</div> -->
    ...
    <script type="text/javascript" src="${ctx }/static/js/thjw/produce/workpackage/135/workpackage_main.js"></script>
	...
	<%@ include file="/WEB-INF/views/open_win/department.jsp"%><!-- 选择部门 -->
	 ...
	 <script type="text/javascript" src="${ctx}/static/js/thjw/produce/workorder/135/workorder_add.js"></script> <!-- 新增工单js -->
