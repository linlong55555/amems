...
<div class="modal modal-new" id="workpackage_close_modal" tabindex="-1" role="dialog"  aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">     
 <div class="modal-dialog" style='width:85%;'>
					...
					<form id="workpackage_close_form">
						...
						<div class="panel-body" style="padding-bottom:0px;padding-left:0px;padding-right:0px">		
							...
							<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-8 form-group">
								...
								<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
									<span class='margin-right-15 label-input'>	<input type="radio" name="workpackage_close_zxdw_radio" value="0" checked="checked" />&nbsp;内部</span>
									<span class='label-input margin-left-15'>	<input type="radio" name="workpackage_close_zxdw_radio" value="1"  />&nbsp;外委</span>
								</div>
							</div>
							<div class="clearfix"></div>
							<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-8 form-group" id="workpackage_close_zxdw_bmdiv">
								<label class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
							...
							<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-8 form-group" id="workpackage_close_zxdw_gysdiv">
								<label class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
								...
								<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0 ">
									<div class='input-group ' style="min-width:100%">
										<input type="text" value="" name="workpackage_close_gys" maxlength="100" class="form-control readonly-style"
										 id="workpackage_close_gys" readonly="readonly"/>
										<span class="input-group-btn" id="workpackage_close_gysbutton">
											<button type="button" class="btn btn-default " id="gzzbtn"
											 data-toggle="modal"
											onclick="workpackage_close_modal.openGys('gys')">
											<i class="icon-search cursor-pointer"></i>
											</button>
										</span>
									</div>
								</div>					
								<input type="hidden" value="" name="workpackage_close_gysid" class="form-control " placeholder='' maxlength="" id="workpackage_close_gysid"/>
							</div>
							<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-8 form-group">
								<label class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
							...
							<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-8 form-group">
								<label class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
									...
									<div class="font-size-9">Checked</div>
								</label>
								<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
									<div class='input-group ' style="min-width:100%">
    ...
    <script type="text/javascript" src="${ctx }/static/js/thjw/produce/workpackage/135/workpackage_close.js"></script>