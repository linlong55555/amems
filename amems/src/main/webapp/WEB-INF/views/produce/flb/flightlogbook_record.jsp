			...
			<table name="flb_record_table" class="table table-thin">
				<thead class="nav-tabs">
					<tr>
						...
						<th class="border-all" colspan="5" children="rycyl,ryjyl,ryzyl,rysyyl,ryxhyl">
					...
					<tr>
						...
						<th style="min-width: 80px;" class="border-right" name="f1hytjl">
							<div class="font-size-12 line-height-12">滑油添加量</div>
							<div class="font-size-9 line-height-12">Oil</div>
						</th>
						...
						<th style="min-width: 80px;" class="border-right" name="f2hytjl">
							<div class="font-size-12 line-height-12">滑油添加量</div>
							<div class="font-size-9 line-height-12">Oil</div>
						</th>
						...
						<th style="min-width: 80px;" class="border-right" name="f3hytjl">
							<div class="font-size-12 line-height-12">滑油添加量</div>
							<div class="font-size-9 line-height-12">Oil</div>
						</th>
						...
						<th style="min-width: 80px;" class="border-right" name="f4hytjl">
							<div class="font-size-12 line-height-12">滑油添加量</div>
							<div class="font-size-9 line-height-12">Oil</div>
						</th>
						...
						<th style="min-width: 80px;" class="border-right" name="apuhytjl">
							<div class="font-size-12 line-height-12">滑油添加量</div>
							<div class="font-size-9 line-height-12">Oil</div>
						</th>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/produce/flb/flightlogbook_record.js"></script>
