				...
				<div class="col-xs-12 padding-leftright-8" >
					<div class="input-group">
						...
						<span class="input-group-addon modalfooterbtn">
							<button class="btn btn-primary padding-top-1 padding-bottom-1 btn-save checkPermission" permissioncode='produce:flb:main:01,produce:flb:main:02' onclick="flb_detail.save()">
			                   	<div class="font-size-12">保存</div>
								<div class="font-size-9">Save</div>
							</button>
							<button class="btn btn-primary padding-top-1 padding-bottom-1 btn-submit checkPermission" permissioncode='produce:flb:main:03' onclick="flb_detail.submit()">
			                   	<div class="font-size-12">提交</div>
								<div class="font-size-9">Submit</div>
							</button>
							<button class="btn btn-primary padding-top-1 padding-bottom-1 btn-revision checkPermission" permissioncode='produce:flb:main:03' onclick="flb_detail.revision()">
			                   	<div class="font-size-12">修订</div>
								<div class="font-size-9">Revision</div>
							</button>
							<button class="btn btn-primary padding-top-1 padding-bottom-1 btn-delete checkPermission" permissioncode='produce:flb:main:04' onclick="flb_detail.del()">
			                   	<div class="font-size-12">删除</div>
								<div class="font-size-9">Delete</div>
							</button>
							<button class="btn btn-primary padding-top-1 padding-bottom-1 btn-scrap checkPermission" permissioncode='produce:flb:main:05' onclick="flb_detail.discard()">
...
<%@ include file="/WEB-INF/views/produce/flb/flightlogbook_workorder.jsp"%>
<%@ include file="/WEB-INF/views/produce/flb/flightlogbook_manual.jsp"%>
