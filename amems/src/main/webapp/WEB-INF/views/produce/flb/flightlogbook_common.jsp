	...
	<div class="">
		<ul class="nav nav-tabs tabNew-style" role="tablist" id="tablist">
			<li class="active">
		  		<a href="#work_hd1" onclick="" data-toggle="tab" hd="1" hdms="航前">
		  			<div class="font-size-12 line-height-12">航前</div>
	                <div class="font-size-9 line-height-9">Before</div>
		  		</a>
		  	</li>
		  	<li class="">
		  		<a href="#work_hd3" onclick="" data-toggle="tab" hd="3" hdms="过站">
		  			<div class="font-size-12 line-height-12">过站</div>
	                <div class="font-size-9 line-height-9">Station</div>
		  		</a>
		  	</li>
		  	<li class="">
		  		<a href="#work_hd5" onclick="" data-toggle="tab" hd="5" hdms="过站" class="hidden">
		  			<div class="font-size-12 line-height-12">过站</div>
	                <div class="font-size-9 line-height-9">Station</div>
		  		</a>
		  	</li>
		  	<li class="">
		  		<a href="#work_hd7" onclick="" data-toggle="tab" hd="7" hdms="过站" class="hidden">
		  			<div class="font-size-12 line-height-12">过站</div>
	                <div class="font-size-9 line-height-9">Station</div>
		  		</a>
		  	</li>
		  	<li class="">
		  		<a href="#work_hd99" onclick="" data-toggle="tab" hd="99" hdms="航后">
		  			<div class="font-size-12 line-height-12">航后</div>
	                <div class="font-size-9 line-height-9">After</div>
		  		</a>
		  	</li>
		  	<li class="">
		  		<a href="#work_hd101" onclick="" data-toggle="tab" hd="101" hdms="停场">
		  			<div class="font-size-12 line-height-12">停场</div>
	                <div class="font-size-9 line-height-9">Stop</div>
		  		</a>
		  	</li>
		</ul>
		<div class="tab-content margin-bottom-10  padding-leftright-8">
			<div class="tab-pane fade active in margin-top-0" id="work_hd1" hd="1" hdms="航前">
               	<%@ include file="/WEB-INF/views/produce/flb/flightlogbook_work.jsp"%>
            </div>
            <div class="tab-pane fade margin-top-0" id="work_hd3" hd="3" hdms="过站">
               	<%@ include file="/WEB-INF/views/produce/flb/flightlogbook_work.jsp"%>
            </div>
            <div class="tab-pane fade margin-top-0" id="work_hd5" hd="5" hdms="过站">
               	<%@ include file="/WEB-INF/views/produce/flb/flightlogbook_work.jsp"%>
            </div>
            <div class="tab-pane fade margin-top-0" id="work_hd7" hd="7" hdms="过站">
               	<%@ include file="/WEB-INF/views/produce/flb/flightlogbook_work.jsp"%>
            </div>
            <div class="tab-pane fade margin-top-0" id="work_hd99" hd="99" hdms="航后">
               	<%@ include file="/WEB-INF/views/produce/flb/flightlogbook_work.jsp"%>
            </div>
            <div class="tab-pane fade margin-top-0" id="work_hd101" hd="101" hdms="停场">
               	<%@ include file="/WEB-INF/views/produce/flb/flightlogbook_work.jsp"%>
            </div>
		</div>
	</div>
