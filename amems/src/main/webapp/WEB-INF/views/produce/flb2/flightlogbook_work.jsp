...
<div>
	...
	<div class="col-lg-3 padding-left-10 padding-right-10">
		<span class="pull-left col-xs-3 col-sm-3 text-right padding-left-0 padding-right-0">
			<div class="font-size-12">是否跟机</div>
			<div class="font-size-9">With The Crew</div>
		</span>
		<div class="col-xs-9 col-sm-9 padding-left-9 padding-right-0">
			<label class="padding-left-5" style="margin-top:6px;font-weight:normal;">
				<input name="work_gjbs" value="1" style="vertical-align:text-bottom" type="checkbox">
			</label>
		</div>
	</div>
			...
			<thead>
		  		<tr>
					...
					<th class="colwidth-20">
						<div class="font-size-12 line-height-12">除防冰液类型</div>
						<div class="font-size-9 line-height-12">Type</div>
					</th>
					<th class="colwidth-20">
						<div class="font-size-12 line-height-12">配比</div>
						<div class="font-size-9 line-height-12">Matching</div>
					</th>
					<th class="colwidth-15">
