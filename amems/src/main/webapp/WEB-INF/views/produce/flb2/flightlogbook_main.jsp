					...
					<div class="row" style="margin-left: 0px; margin-right: 0px;">
						<div class="pull-left form-group">
							<button type="button" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" 
								permissioncode='produce:flb2:main:01,produce:flb2:main:03' style="margin-right:3px;" onclick="flb.add()">
...
<%@ include file="/WEB-INF/views/produce/flb2/flightlogbook_detail.jsp"%><!-------飞行记录本明细 -------->
...
<script type="text/javascript" src="${ctx}/static/js/thjw/produce/flb2/flightlogbook_main.js"></script>
