...
<head>
	...
	<script>
		...
		var paramGdzt = '${param.gdzt}';
		var paramWgbs = '${param.wgbs}';
		var gdid = "${param.gdid}";
	</script>
...
<body class="page-header-fixed">
			...
			<div class="panel-body" style='padding-bottom:2px;'>
				...
				<div  class='row-height margin-top-0 searchContent'>
					...
					<div class="pull-left padding-left-0 " style='margin-right:3px;'>
						<a href="#" onclick="workorder135_main.openWinAdd(true)" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode='produce:workorder:main:01' >
							<div class="font-size-12">新增</div>
							<div class="font-size-9">Add</div>
						</a> 
					</div>
					<div class="pull-left" style='margin-right:3px;'>
						<a href="#"  onclick="workorder135_main.exportExcel()" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode='produce:workorder:main:09'>
				...
				<div class='table_pagination'>
					<div  class='col-lg-12 col-md-12 padding-left-0 margin-top-0 padding-right-0 table-height table-set' c-height="45%" style="overflow-x: auto;" id="workorder135_table_div">
						<table class='table table-thin table-bordered table-striped table-hover table-set' style='margin-bottom:0px !important;min-width:2500px;' id="workorder135_table" >
							<thead>
								<tr>
									...
									<th class='colwidth-12  sorting'  onclick="workorder135_main.orderBy('gbbh')"  id="gbbh_order">
										<div class="important">
											<div class="font-size-12 line-height-12">工包编号</div>
					                        <div class="font-size-9 line-height-12">Workpackage No.</div>
					                    </div>
									</th>
    ...
    <%@ include file="/WEB-INF/views/produce/workorder/135/workorder_add.jsp"%><!-- -工单新增-->
   ...
   <%@ include file="/WEB-INF/views/open_win/installationlist_replace.jsp"%><!-------拆换记录-------->
    ...
    <%@ include file="/WEB-INF/views/produce/workorder/135/issued_info_modal.jsp"%>
	...
	<script type="text/javascript">
		$(function(){
			...
			if(paramWgbs != null && paramWgbs != ''){
				$("#fkzt_search").val(paramWgbs);
				paramWgbs = null;
			}
