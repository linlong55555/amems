...
<div class="modal modal-new" id="workorder145_feedback_Modal" tabindex="-1" role="dialog"  aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header modal-header-new" >
                       <h4 class="modal-title" >
                          <div class='pull-left'>
		                      <div class="font-size-14 " id="modalHeadCN">工单完成反馈</div>
							  <div class="font-size-12" id="modalHeadENG">Workorder Complete feedback</div>
						  </div>
            ...
            <div class="modal-body" >
             	<div class="col-xs-12 margin-top-8 ">
						...
						<form id="wo145feedback_from">
								...
								<table id="workorder_feedback_table" class="table table-thin table-bordered table-striped table-hover table-set" style="min-width: 900px !important">
									<thead>
										...
										<th class="colwidth-10" >
											<div class="font-size-12 line-height-18" id="workorder_feedback_title">工单标题</div>
											<div class="font-size-9 line-height-18" id="workorder_feedback_Etitle">WO Title</div>
										</th>
										<th class="colwidth-9">
							...
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
								<label class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-right padding-left-0 padding-right-0">
									<div class="font-size-12 "><span style="color:red" id="workorder145_feedback_Modal_sjwcrq_remark">*</span>实际完成时间</div>
									<div class="font-size-9">Finished Time</div>
								</label>
								<div class="col-lg-6 col-sm-6 col-xs-6 padding-left-8 padding-right-0">
									<input class="form-control date-picker" id="wo145feedback_sjJsrq" name="wo145feedback_sjJsrq" data-date-format="yyyy-mm-dd" type="text">
								</div>
								<div class="col-lg-3 col-sm-3 col-xs-3 padding-left-0 padding-right-8">
									<input class="form-control time-masked" name="wo145feedback_sjJssj" id="wo145feedback_sjJssj" style="border-left: 0;" type="text">
								</div>
							</div>
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
								<label class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-right padding-left-0 padding-right-0">
								...
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 padding-leftright-8">
									<input type="text" class="form-control date-picker" maxlength="10" data-date-format="yyyy-mm-dd" id="wo145feedback_sjksrq" />
								</div>
							</div>
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
								<label class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-right padding-left-0 padding-right-0">
								...
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 padding-leftright-8">
									<input type="text" id="wo145feedback_sjgs" name="wo145feedback_sjgs" class="form-control" maxlength="10" >
								</div>
							</div>
							<div class="clearfix"></div>               									
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
								...
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 padding-leftright-8 pull-left">
									<input class="form-control" id="wo145feedback_sjgzzid" type="hidden">
									<div class="input-group col-xs-12">
										<input id="wo145feedback_sjgzz" type="text" name="wo145feedback_sjgzz" class="form-control readonly-style" maxlength="100" readonly="readonly" />
				                		<span class="input-group-addon btn btn-default" id="wo145feedback_sjgzz_btn" onclick="Workorder145FeedbackWin.openGzzWin()">
					                    	<i class="icon-search cursor-pointer"></i>
					                    </span>
				                	</div>
								</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
								...
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 padding-leftright-8 pull-left">
									<input class="form-control" id="wo145feedback_sjjczid" type="hidden">
									<div class="input-group col-xs-12">
										<input id="wo145feedback_sjjcz" type="text" name="wo145feedback_sjjcz" class="form-control " maxlength="100" />
				                		<span class="input-group-addon btn btn-default" id="wo145feedback_sjjcz_btn" onclick="Workorder145FeedbackWin.openJczWin()">
					                    	<i class="icon-search cursor-pointer"></i>
					                    </span>	
				                	</div>
								</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
								...
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 padding-leftright-8">
									<input type="text" id="wo145feedback_sjzd" name="wo145feedback_sjzd" class="form-control" maxlength="100" >
								</div>
							</div>
							<div class="col-lg-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-8  form-group">
								<span class="col-lg-1 col-md-1 col-sm-2 col-xs-3 text-right  padding-right-0"><div class="font-size-12 ">故障信息</div>
							 	...
							 	<div class="col-lg-11 col-md-11  col-sm-10 col-xs-9 padding-left-8 padding-right-0">
										<textarea class="form-control" id="wo145feedback_gzxx" name="wo145feedback_gzxx" placeholder=''   maxlength="1000" style="height:55px"></textarea>
								</div>
							</div>
							<div class="col-lg-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-8  form-group">
								<span class="col-lg-1 col-md-1 col-sm-2 col-xs-3 text-right  padding-right-0"><div class="font-size-12 ">处理措施</div>
							 	...
							 	<div class="col-lg-11 col-md-11  col-sm-10 col-xs-9 padding-left-8 padding-right-0">
										<textarea class="form-control" id="wo145feedback_clcs" name="wo145feedback_clcs" placeholder=''   maxlength="1000" style="height:55px"></textarea>
								</div>
							</div>
							<div class="clearfix"></div>	
						</form>
					...
					<div class="clearfix"></div>
					<!-- Start:引用页面 -->
					<div id="wo145feedback_replacementRecord_div" style="display:none">
						<%@ include file="/WEB-INF/views/produce/workorder/145/replacementRecord.jsp"%><!-- 拆换件记录 -->
					</div>	
					
					<div class="clearfix"></div>
					<div id="wo145feedback_attachments_list_workorderedit" style="display:none">							
           		...
           		<div class="col-xs-12 padding-leftright-8" >
					<div class="input-group">
	                    ...
	                    <span class="input-group-addon modalfooterbtn">
	                      <button type="button" id="workorder145_feedback_Modal_save" class="btn btn-primary padding-top-1 padding-bottom-1" onclick="Workorder145FeedbackWin.submitFeedback()" >
...
<!--  弹出框结束-->
<script type="text/javascript" src="${ctx}/static/js/thjw/produce/workorder/145/workorder_feedback.js"></script><!-- 145工单完工反馈 -->