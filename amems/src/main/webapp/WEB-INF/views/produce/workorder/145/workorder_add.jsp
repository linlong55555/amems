              		...
              		<div class="input-group-border">
						...
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							...
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8">
								<input class="form-control" id="wo145add_gdbh" placeholder="不填写则自动生成" name="wo145add_gdbh" type="text" maxlength="50"/>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							<label class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
								<div class="font-size-12 margin-topnew-2"><span style="color: red">*</span>工包号</div>
							...
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8">
								...
								<input id="wo145add_gbid" type="hidden" class="form-control" />									
			                    	...
			                    	<span id="wo145add_gbbtn" class=" btn btn-default" onclick="Workorder145AddWin.openWin145Package()"><i class='icon-search'></i></span>
			                	</div>
							</div>
						</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							...
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8">
								<div class="input-group col-xs-12">
									<input id="wo145add_lyrwh" type="text" class="form-control" ondblclick="Workorder145AddWin.openWinLyrwh()" onblur="Workorder145AddWin.resetLyrInfo()"/>
						...
						<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 form-group">
							...
							<div class="col-lg-10 col-md-11 col-sm-10 col-xs-9 padding-leftright-8 label-input-div" >
								...
								<label class='label-input' style='color:#333;'><input type='radio' name='wo145add_gdlx' value="2"/>&nbsp;EO</label>
								<label class='label-input' style='color:#333;'><input type='radio' name='wo145add_gdlx' checked="checked" value="1"/>&nbsp;维修项目</label>
								<label class='label-input' style='color:#333;'><input type='radio' name='wo145add_gdlx' value="4"/>&nbsp;MO/MCC</label>
								<label class='label-input' style='color:#333;'><input type='radio' name='wo145add_gdlx' value="5"/>&nbsp;其它指令</label>
							</div>
						</div>
						...
						<div class="col-xs-12 padding-left-0 padding-right-0 form-group">
							<label class="col-lg-1 col-md-1 col-sm-2 col-xs-3 text-right padding-left-0 padding-right-0">
								<div class="font-size-12 margin-topnew-2"><span style="color: red">*</span>工单标题</div>
						...
						<div class="col-xs-12 padding-left-0 padding-right-0 form-group" id="wo145add_qxmsdiv">
							<label class="col-lg-1 col-md-1 col-sm-2 col-xs-3 text-right padding-left-0 padding-right-0">
								<div class="font-size-12 margin-topnew-2">缺陷描述</div>
								<div class="font-size-9">Defect description</div>
							</label>
							<div class="col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8">
								<textarea style="height: 95px;" class="form-control" id="wo145add_qxms" name="" maxlength="1000" ></textarea>
							</div>
						</div>
...
<!--  弹出框结束-->
<script type="text/javascript" src="${ctx}/static/js/thjw/produce/workorder/145/workorder_add.js"></script> <!-- 新增工单 -->
