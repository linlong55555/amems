...
<script type="text/javascript" src="${ctx}/static/js/thjw/produce/workorder/135/workorder_lycardwin.js"></script>
<div class="modal fade in modal-new" id="workorder135_lycard_Modal" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="open_win_evaluation_modal" aria-hidden="true">
		             ...
		             <!-- start:搜索框 -->
			   		<div class=" pull-right padding-left-0 padding-right-8 margin-top-0 modalSearch">
								...
								<div class="pull-left padding-right-0" style='width:200px;'>
									<select class='form-control' id='gklx_search' onchange="Workorder135LycardWin.doSearch()"></select>
								</div>
								<div class='clearfix'></div>
							</div>	
							<!-- 搜索框start -->
							<div class=" pull-right padding-left-0 padding-right-0">
								<div class=" pull-left padding-left-0 padding-right-0" style="width: 250px;">
									<input type="text" placeholder='工卡编号/标题' id="workorder135_lycard_keyword_search" class="form-control" />
								</div>
			                    <div class=" pull-right padding-left-5 padding-right-0 ">   
									<button name="keyCodeSearch" type="button" class=" btn btn-primary padding-top-1 padding-bottom-1 " onclick="Workorder135LycardWin.doSearch()">
					...
					<div class="margin-left-8 margin-right-8" style='margin-top:5px;'>
						<div style="overflow-x:auto;" class='table-content'>
							<table class="table table-bordered table-thin table-striped table-hover table-set" style="min-width: 1000px !important">
								<thead>
							   		<tr>
										...
										<th id="checkAll" style='text-align:center;vertical-align:middle;width:70px;'>
											...
											<a href="#" class="margin-left-5" onclick="SelectUtil.performSelectClear('workorder135_lycard_list')" ><img src="${ctx}/static/assets/img/d2.png" alt="不全选" /></a>
										</th>
								...
								<tbody id="workorder135_lycard_list">
								
								</tbody>
							</table>
						</div>
						<div class="col-xs-12 text-center page-height padding-right-0 padding-left-0" id="workorder135_lycard_pagination"></div>
					</div>
					<!-- end:table -->
		           	...
		           	<div class="col-xs-12 padding-leftright-8"  >
		           		<div class="input-group">
							...
							<span class="input-group-addon modalfooterbtn">
		                       <button type="button" class="btn btn-primary padding-top-1 padding-bottom-1" onclick="Workorder135LycardWin.save();">
									<div class="font-size-12">确定</div>
									<div class="font-size-9">Confirm</div>
								</button>
								<button type="button" class="btn btn-primary padding-top-1 padding-bottom-1" onclick="Workorder135LycardWin.clear();">
