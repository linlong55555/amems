              	...
              	<div class="col-xs-12 margin-top-8 ">
              		<div class="input-group-border">
						...
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							...
							<div id="add_order_lx" class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 label-input-div" >
								<label class='label-input' style='color:#333;'><input type='radio' name='wo135add_gdlx' checked="checked" value="4"/>&nbsp;MO/MCC</label>
								<label class='label-input' style='color:#333;'><input type='radio' name='wo135add_gdlx' value="5"/>&nbsp;其它指令</label>
							</div>
							<div id="edit_order_lx" class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 label-input-div" >
								<input id="edit_gdlx_id" type="hidden" class="form-control " disabled="disabled"  />
								<input id="edit_gdlx_name" type="text" class="form-control " disabled="disabled"  />
							</div>
						</div>
						
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group" id="wo135add_lyrwh_div">
							<label class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
						...
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							...
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8">
								<div class="input-group col-xs-12">
									...
									<input class="form-control readonly-style" id="wo135add_gbbh" name="" type="text" ondblclick="Workorder135AddWin.openWin135Package()" readonly="readonly"/>
...
<!-- 									<div ondblclick="Workorder135AddWin.openStationWin()" id="efjzw" class='form-control base-color readonly-style' style='border-right:0px;border-radius:0px;min-height:34px;height:auto;padding-left:3px;padding-right:3px;'></div>  -->
						...
						<div class="col-lg-6 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							<label class="col-lg-2 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
								<div class="font-size-12 margin-topnew-2">完成时限</div>
								<div class="font-size-9">Completion Lime Limit</div>
							</label>
						...
						<div class="col-xs-12 padding-left-0 padding-right-0 form-group" id="wo135add_qxmsdiv">
							<label class="col-lg-1 col-md-1 col-sm-2 col-xs-3 text-right padding-left-0 padding-right-0">
								<div class="font-size-12 margin-topnew-2">缺陷描述</div>
								<div class="font-size-9">Defect description</div>
							</label>
							<div class="col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8">
								<textarea style="height: 95px;" class="form-control" id="wo135add_qxms" name="" maxlength="1000" ></textarea>
							</div>
						</div>
