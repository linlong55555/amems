...
<body class="page-header-fixed">
				...
				<div  class='row-height margin-top-0 searchContent' >
				    <!-- 上传按钮  -->
				    	<div class=" col-lg-3 col-md-6 col-sm-12 col-xs-12   padding-left-0 padding-right-0  form-group " >
							<div class="pull-left padding-left-0" style='margin-right:3px;'>
								<a href="#" onclick="workorder145_main.openWinAdd(true)" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode='produce:workorder145:main:01' >
									<div class="font-size-12">新增</div>
									<div class="font-size-9">Add</div>
								</a> 
							</div>
							<div class="pull-left" style='margin-right:3px;'>
								<a href="#" onclick="workorder145_main.exportExcel()" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode='produce:workorder145:main:09' >
		 		...
		 		<!-- 	<div class="col-xs-12 col-sm-6 col-lg-3  padding-left-0 padding-right-0 margin-bottom-10 " >
						...
						<div class="col-xs-12 col-sm-6 col-lg-3  padding-left-0 padding-right-0 margin-bottom-10 " >
							...
							<div class="col-xs-8 col-sm-8 padding-left-8 padding-right-0">
								<select id="dprtcode_search" class="form-control "  name="dprtcode_search"  onchange="workorder145_main.changeDprtcode();">
						...
						<table class='table table-bordered table-striped table-thin table-hover table-set' style='margin-bottom:0px !important;min-width:2500px;' id="workorder145_table" >
							<thead>
								<tr>
									...
									<th class='colwidth-13 sorting'  onclick="workorder145_main.orderBy('gdbh')"  id="gdbh_order">
										<div class="important">
    ...
    <%@ include file="/WEB-INF/views/produce/workorder/145/workorder_add.jsp"%><!-- -工单新增-->
	...
	<script type="text/javascript">
		$(function(){
			...
			if(gbid){
				...
				$("#wo145add_gbbh").attr("disabled",true);
				$("#wo145add_gbbh").removeClass("readonly-style");
				$("#wo145add_gbbtn").hide();
