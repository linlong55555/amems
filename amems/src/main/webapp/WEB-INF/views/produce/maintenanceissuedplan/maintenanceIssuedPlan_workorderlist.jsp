...
<div class="panel panel-primary" id="gd_panel_div">
				...
				<div  class='row-height margin-top-0 searchContent'>
					...
					<div class=" pull-right padding-left-0 padding-right-0 form-group">
						...
						<div class="pull-right padding-left-10 padding-right-0">
							<div class=" pull-left padding-left-0 padding-right-0" style="width: 250px;">
								<input id="keyword_gd_search" type="text" placeholder='工单编号/任务信息/工单标题/来源工卡'  class="form-control" >
							</div>
		                    <div class=" pull-right padding-left-5 padding-right-0 ">   
								<button onclick="maintencePlanList.searchGd()" type="button" class=" btn btn-primary padding-top-1 padding-bottom-1" >
					...
					<div>
						...
						<div class="pull-left form-group" style='margin-right:3px;'>
							<a href="#" onclick="maintencePlanList.exportExcel()" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode="produce:maintenanceissuedplan:main:01">
				...
				<div  class='col-lg-12 col-md-12 padding-left-0 padding-right-0 table-height' c-height="45%" style="overflow-x: auto;" id="maintenanceIssuedPlane_workorder_div">
				<table class='table table-thin table-nonbordered table-striped table-hover table-set' style='margin-bottom:0px !important;min-width:2000px;' id="maintenanceplane_workorder_table">
					<thead>
						<tr>
							<th class=" colwidth-7 selectAllImg">
								<a href="#" onclick="SelectUtil.performSelectAll('maintenanceIssuedPlane_workorder_div')" ><img src="${ctx}/static/assets/img/d1.png" alt="全选" /></a>
								<a href="#" class="margin-left-5" onclick="SelectUtil.performSelectClear('maintenanceIssuedPlane_workorder_div')" ><img src="${ctx}/static/assets/img/d2.png" alt="不全选" /></a>
							</th>
							<th class='colwidth-7'>
					...
					<tbody id='maintenanceIssuedPlan_list'>
					</tbody>
				</table>
				</div>
