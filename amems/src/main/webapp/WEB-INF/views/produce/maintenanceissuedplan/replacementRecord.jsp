...
<script type="text/javascript" src="${ctx}/static/js/thjw/produce/workorder/135/replacementRecord.js"></script> <!-- 135工单管理主列表 -->
			...
			<table class="table table-thin table-bordered table-striped table-hover table-set" style="min-width:900px" id="replacementRecord_table">
				<thead>
					<tr>
						...
						<th class="colwidth-13">
							<div class="font-size-12 line-height-12">装上件初始化信息</div>
							<div class="font-size-9 line-height-12">Init Info</div>
						</th>										
					</tr>
				</thead>
