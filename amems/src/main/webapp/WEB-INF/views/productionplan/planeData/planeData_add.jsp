		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0" style="margin-bottom:10px;">
					...
					<div class="panel-heading"><h3 class="panel-title">飞机基本信息 Basic Information</h3></div>
					<div class="panel-body padding-bottom-0">
						<div class="col-lg-12">
							...
							<div class="col-lg-3 col-sm-6 col-xs-12 padding-right-0 form-group" >
								...
								<div class=" col-lg-7 col-sm-7 col-xs-7 padding-left-8 padding-right-0">
									<input type="text" class="form-control" name="fjzch" id="fjzch" maxlength="20"/>
								</div>
							</div>
							
							<div class="col-lg-3 col-sm-6 col-xs-12  padding-right-0 form-group">
								<label class="col-lg-5 col-sm-5 col-xs-5 text-right padding-left-0 padding-right-0">
									<div class="font-size-12 line-height-18"><span style="color: red">*</span>序列号</div>
									<div class="font-size-9 line-height-18">S/N</div>
								</label>
								 <div class="col-lg-7 col-sm-7 col-xs-7 padding-left-8 padding-right-0" >
									<input type="text" class="form-control" name="xlh" id="xlh" maxlength="20"/>
								</div>
							</div>
							...
							<div class="col-lg-3 col-sm-6 col-xs-12  padding-right-0 form-group">
								...
								<div class="col-lg-7 col-sm-7 col-xs-7 padding-left-8 padding-right-0">
									<input type="text" class="form-control" name="bzm" id="bzm" maxlength="16"/>
								</div>
							</div>
						</div>
					...
					<!-- 	<div class="col-lg-12">
							<div class="col-lg-3 col-sm-6 col-xs-12  padding-right-0 form-group">
								...
								<div class="col-lg-7 col-sm-7 col-xs-7 padding-left-8 padding-right-0">
									<input type="text" class="form-control" name="gjdjzh" id="gjdjzh" maxlength="50"/>
								</div>
							</div>
							...
							<div class="col-lg-3 col-sm-6 col-xs-12   padding-right-0 form-group">
								...
								<div class=" col-lg-7 col-sm-7 col-xs-7 padding-left-8 padding-right-0">
									<input type="text" class="form-control" name="shzh" id="shzh" maxlength="50"/>
								</div>
							</div>
							...
							<div class="col-lg-3 col-sm-6 col-xs-12 padding-right-0 form-group">
								...
								<div class=" col-lg-7 col-sm-7 col-xs-7 padding-left-8 padding-right-0">
									<input type="text" class="form-control" name="wxdtxkzh" id="wxdtxkzh" maxlength="50"/>
								</div>
							</div>
							...
							<div class="col-lg-3 col-sm-6 col-xs-12 padding-right-0 form-group">
								...
								<div class=" col-lg-7 col-sm-7 col-xs-7 padding-left-8 padding-right-0">
									<input type="text" class="form-control date-picker" name="dtzzjkrq" id="dtzzjkrq" data-date-format="yyyy-mm-dd"  maxlength="10"/>
								</div>
							</div>
						</div> -->
						<div class="clearfix"></div>
						...
						<div class="col-lg-12 ">
							<div class="col-lg-3 col-sm-6 col-xs-12   padding-right-0 form-group" >
								...
								<div class=" col-lg-7 col-sm-7 col-xs-7 padding-left-8 padding-right-0">
									<input class="form-control date-picker" name="ccrq" data-date-format="yyyy-mm-dd" type="text"  id="ccrq" maxlength="10"/>
								</div>
							</div>
							<div class="col-lg-3 col-sm-6 col-xs-12 padding-right-0 form-group" >
								<label  class="col-lg-5 col-sm-5 col-xs-5 text-right padding-left-0 padding-right-0"><div
										class="font-size-12 line-height-18"><span style="color: red">*</span>基地</div>
						...
						<div class="col-lg-12 col-sm-12 col-xs-12">
								...
								<div class="col-xs-11 padding-left-8 padding-right-0" style="width: 90%">
									<textarea rows="3" name="jsgzjl" class="form-control" id="jsgzjl" maxlength="160"></textarea>
								</div>
							</div>
						</div>
						<div class="clearfix"></div>
					...
					<div class="col-lg-12 padding-left-0 padding-right-0">
							<div class="col-lg-4 col-sm-6 col-xs-12  padding-right-0 form-group">
								...
								<div class="col-lg-8 col-sm-7 col-xs-7 padding-left-8 padding-right-0">
									<input type="text" class="form-control" name='gjdjzh'  id='gjdjzh'/>
								</div>
							</div>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12   padding-right-0 form-group">
								...
								<div class=" col-lg-9 col-sm-7 col-xs-7 padding-left-8 padding-right-0">
									<input type="text" class="form-control date-picker" data-date-format="yyyy-mm-dd" name='gjdjzh_yxq'  id='gjdjzh_yxq'/>
								</div>
							</div>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12 padding-right-0 form-group" >
								...
								<div class="col-xs-9 col-sm-7 col-xs-7 padding-left-8 padding-right-0 "  >
						...
						<div class="col-lg-12 padding-left-0 padding-right-0">
							<div class="col-lg-4 col-sm-6 col-xs-12  padding-right-0 form-group">
								...
								<div class="col-lg-8 col-sm-7 col-xs-7 padding-left-8 padding-right-0">
									<input type="text" class="form-control" name='shzh' id='shzh'/>
								</div>
							</div>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12   padding-right-0 form-group">
								...
								<div class=" col-lg-9 col-sm-7 col-xs-7 padding-left-8 padding-right-0">
									<input type="text" class="form-control date-picker" data-date-format="yyyy-mm-dd" name='shzh_yxq' id='shzh_yxq'/>
								</div>
							</div>
						...
						<div class="col-lg-12 padding-left-0 padding-right-0">
							<div class="col-lg-4 col-sm-6 col-xs-12  padding-right-0 form-group">
								...
								<div class="col-lg-8 col-sm-7 col-xs-7 padding-left-8 padding-right-0">
									<input type="text" class="form-control" name='wxdtxkzh' id='wxdtxkzh' />
								</div>
							</div>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12   padding-right-0 form-group">
								...
								<div class=" col-lg-9 col-sm-7 col-xs-7 padding-left-8 padding-right-0">
									<input type="text" class="form-control date-picker" data-date-format="yyyy-mm-dd" name='wxdtxkzh_yxq'   id='wxdtxkzh_yxq'/>
								</div>
							</div>
					...
					<!--  <div class="col-lg-4 col-sm-6 col-xs-10  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
					 ...
					 <div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0" style="overflow: auto;">
						<table class="table-set table table-bordered table-striped table-hover text-center" style="min-width: 900px">
							<thead>
							    ...
							    <tbody id="filelist">
									 <tr class="non-choice"><td colspan="6">暂无数据 No data.</td></tr>
								</tbody>
						</table>
					 </div>
					</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label  class="col-xs-5 text-right padding-left-0 padding-right-0"><div
										...
										<input class="form-control date-picker" name="init_date_rq" data-date-format="yyyy-mm-dd" type="text"  id="init_date_rq" maxlength="10"/>
									</div>
								</div>
								...
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0" >
									<label  class="col-xs-5 text-right padding-left-0 padding-right-0"><div
										...
										<div class=" col-xs-7 padding-left-8 padding-right-0">
										<input type="text" class="form-control" name="init_time_jsfx" maxlength="10">
									</div>
								</div>
								<div class="col-lg-2 col-sm-6 col-xs-12  padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
									 ...
									 <div class="col-xs-7 padding-left-8 padding-right-0" >
										<input type="text" class="form-control " name="init_time_ssd" maxlength="10">
									</div>
								</div>
							 	<div class="col-lg-2 col-sm-6 col-xs-12  padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
									...
									<div class="col-xs-7 padding-left-8 padding-right-0">
										<input type="text" class="form-control " name="init_time_jc" maxlength="10">
									</div>
								</div>
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
									 ...
									 <div class="col-xs-7 padding-left-8 padding-right-0" >
										<input type="text" class="form-control " name="init_loop_qlj" maxlength="10">
									</div>
								</div>
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
									...
									<div class="col-xs-7 padding-left-8 padding-right-0">
										<input type="text" class="form-control " name="init_loop_jc" maxlength="10">
									</div>
								</div>
							</div>
							<div class="clearfix"></div>
							...
							<div class="col-lg-12">
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
									 ...
									 <div class="col-xs-7 padding-left-8 padding-right-0" >
										<input type="text" class="form-control " name="init_loop_wdg" maxlength="10">
									</div>
								</div>
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
									 ...
									 <div class="col-xs-7 padding-left-8 padding-right-0" >
										<input type="text" class="form-control " name="init_loop_ts1" maxlength="10">
									</div>
								</div>
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
									...
									<div class="col-xs-7 padding-left-8 padding-right-0">
										<input type="text" class="form-control " name="init_loop_ts2" maxlength="10">
									</div>
									<div class="clearfix"></div>
								</div>
							</div>
							...
							<div class="col-lg-12">
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
									 ...
									 <div class="col-xs-7 padding-left-8 padding-right-0" >
										<input type="text" class="form-control " name="init_loop_l_n1" maxlength="10">
									</div>
								</div>
								...
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									...
									<div class="col-xs-7 padding-left-8 padding-right-0">
										<input type="text" class="form-control " name="init_loop_l_n2" maxlength="10">
									</div>
								</div>
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
									 ...
									 <div class="col-xs-7 padding-left-8 padding-right-0" >
										<input type="text" class="form-control " name="init_loop_l_n3" maxlength="10">
									</div>
								</div>
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
									...
									<div class="col-xs-7 padding-left-8 padding-right-0">
										<input type="text" class="form-control " name="init_loop_l_n4" maxlength="10">
									</div>
								</div>
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
									 ...
									 <div class="col-xs-7 padding-left-8 padding-right-0" >
										<input type="text" class="form-control " name="init_loop_l_n5" maxlength="10">
									</div>
								</div>
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
									...
									<div class="col-xs-7 padding-left-8 padding-right-0">
										<input type="text" class="form-control " name="init_loop_l_n6" maxlength="10">
									</div>
								</div>
							</div>
							<div class="clearfix"></div>
							...
							<div class="col-lg-12">
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
										...
										<div class="font-size-9 line-height-18">N1</div></label>
									 <div class="col-xs-7 padding-left-8 padding-right-0" >
										<input type="text" class="form-control " name="init_loop_r_n1" maxlength="10">
									</div>
								</div>
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
										...
										<div class="font-size-9 line-height-18">N2</div> </label>
									<div class="col-xs-7 padding-left-8 padding-right-0">
										<input type="text" class="form-control " name="init_loop_r_n2" maxlength="10">
									</div>
								</div>
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
										...
										<div class="font-size-9 line-height-18">N3</div></label>
									 <div class="col-xs-7 padding-left-8 padding-right-0" >
										<input type="text" class="form-control " name="init_loop_r_n3" maxlength="10">
									</div>
								</div>
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
										...
										<div class="font-size-9 line-height-18">N4</div> </label>
									<div class="col-xs-7 padding-left-8 padding-right-0">
										<input type="text" class="form-control " name="init_loop_r_n4" maxlength="10">
									</div>
								</div>
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
										...
										<div class="font-size-9 line-height-18">N5</div></label>
									 <div class="col-xs-7 padding-left-8 padding-right-0" >
										<input type="text" class="form-control " name="init_loop_r_n5" maxlength="10">
									</div>
								</div>
								<div class="col-lg-2 col-sm-6 col-xs-12 padding-right-0 form-group padding-left-0">
									<label class="col-xs-5 text-right padding-left-0 padding-right-0"><div
										...
										<div class="font-size-9 line-height-18">N6</div> </label>
									<div class="col-xs-7 padding-left-8 padding-right-0">
										<input type="text" class="form-control " name="init_loop_r_n6" maxlength="10">
									</div>
								</div>
							</div>
							<div class="clearfix"></div>
...
<!-- 查看工单End -->
	...
	<script src="${ctx}/static/js/thjw/productionplan/planeData/planeData_add.js"></script>
</body>
</html>