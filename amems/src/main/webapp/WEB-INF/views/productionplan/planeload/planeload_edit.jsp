...
<body>
					...
					<table id="fjzt_list_table" class="table table-thin table-bordered table-set" >
						...
						<tbody>
							<tr>
								...
								<th class='text-right colwidth-10' style='vertical-align:middle;'><span style="color: red">*</span>日期</th>
								<td>
							...
							<table class='table table-bordered'>
									...
									<tbody>
										...
										<td><input type='text' id="zxyzd_x1" class='form-control' value="${erayFns:escapeStr(planeLoad.zxyzd_x1)}" maxlength="9" /></td>
										<th style='vertical-align:middle;'>Y1</th>
										<td><input type='text' id="zxyzd_y1" class='form-control' value="${erayFns:escapeStr(planeLoad.zxyzd_y1)}" maxlength="9" /></td>
										<th style='vertical-align:middle;'>Z1</th>
										<td><input type='text' id="zxyzd_z1" class='form-control' value="${erayFns:escapeStr(planeLoad.zxyzd_z1)}" maxlength="9" /></td>
										</tr>
										<tr>
										<th style='vertical-align:middle;'>X2</th>
										<td><input type='text' id="zxyzd_x2" class='form-control' value="${erayFns:escapeStr(planeLoad.zxyzd_x2)}" maxlength="19" /></td>
										<th style='vertical-align:middle;'>Y2</th>
										<td><input type='text' id="zxyzd_y2" class='form-control' value="${erayFns:escapeStr(planeLoad.zxyzd_y2)}" maxlength="19" /></td>
										<th style='vertical-align:middle;'>Z2</th>
										<td><input type='text' id="zxyzd_z2" class='form-control' value="${erayFns:escapeStr(planeLoad.zxyzd_z2)}" maxlength="9" /></td>
										</tr>
										<tr>
										<th style='vertical-align:middle;'>X3</th>
										<td><input type='text' id="zxyzd_x3" class='form-control' value="${erayFns:escapeStr(planeLoad.zxyzd_x3)}" maxlength="9" /></td>
										<th style='vertical-align:middle;'>Y3</th>
										<td><input type='text' id="zxyzd_y3" class='form-control' value="${erayFns:escapeStr(planeLoad.zxyzd_y3)}" maxlength="9" /></td>
										<th style='vertical-align:middle;'>Z3</th>
										<td><input type='text' id="zxyzd_z3" class='form-control' value="${erayFns:escapeStr(planeLoad.zxyzd_z3)}" maxlength="9" /></td>
										</tr>
									</tbody>
								</table>
								<table class='table table-bordered'>
								...
								<td><input type='text' id="wjzd" class='form-control' value="${erayFns:escapeStr(planeLoad.wjzd)}" maxlength="9" /></td></tr>
								</tbody>
								</table>
							</td>
							...
							<table class='table table-bordered'>
									...
									<tbody id='bjzd_list'>
										...
										<td>
											<input type='text' id="zdz1" class='form-control' maxlength="9"/>
										...
										<td>
											<input type='text' id="zdz2" class='form-control' maxlength="9"/>
										...
										<td>
											<input type='text' id="zdz3" class='form-control' maxlength="9"/>
							...
							<tr class='zxsj_tr'>
								...
								<td colspan='5'>
								<textarea id="gx" class='form-control' maxlength="1000">${erayFns:escapeStr(planeLoad.gx)}</textarea>
								</td>
							</tr>
							<tr class='zxsj_tr'>
								<th class='text-right colwidth-10' style='vertical-align:middle;'>
								...
								<td>
									<input type='text' id="fjzl_sz" class='col-lg-8 form-control text-left' style="width:66%" value="${erayFns:escapeStr(planeLoad.fjzl_sz)}" maxlength="9"/>
								...
								<td>
									<input type='text'  id="zxzx_sz"  class='col-lg-8 form-control text-left' style="width:66%" value="${erayFns:escapeStr(planeLoad.zxzx_sz)}" maxlength="9" />
								...
								<td>
									<input type='text' id="hxzx_sz" class='col-lg-8 form-control text-left' style="width:66%" value="${erayFns:escapeStr(planeLoad.hxzx_sz)}" maxlength="9" />
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/productionplan/planeload/planeload_edit.js"></script>
