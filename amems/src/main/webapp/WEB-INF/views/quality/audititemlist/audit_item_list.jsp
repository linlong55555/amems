...
<body class="page-header-fixed">
	<!-- 隐藏审核通知单id -->
	<input type="hidden" id="shtzdid" value=${shtzdid} >
			...
			<div class="panel-body padding-bottom-0">
			  <div  class='searchContent row-height margin-top-0'>
				<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" >
				   <a href="javascript:void(0);" onclick="openWinAdd()" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode="quality:audititemlist:main:01" >
						<div class="font-size-12">新增</div>
						<div class="font-size-9">Add</div>
					</a>
                   <a href="javascript:exportExcel();" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode="quality:audititemlist:main:05" style="float: left;margin-left:8px;">
	...
	<%@ include file="/WEB-INF/views/quality/audititemlist/audit_item_list_add.jsp"%><!-------新增对话框对话框 -------->
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/quality/audititemlist/audit_item_list.js"></script>
