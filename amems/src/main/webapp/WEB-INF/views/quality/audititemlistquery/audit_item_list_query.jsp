...
<body class="page-header-fixed">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body padding-bottom-0">
			  <div  class='searchContent row-height margin-top-0'>
				<div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" >
				   
                   <a href="javascript:exportExcel();" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode="quality:audititemlistquery:main:01" style="float: left;margin-left:8px;">
				...
				<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group pull-right" style='padding-left:15px;'>
					...
					<div class="col-xs-12 input-group input-group-search">
							...
							<input type="text" id="shrq_search" class="form-control " name='date-range-picker'>
		                    <div class="input-group-addon btn-searchnew">
		                    	<button type="button" class=" btn btn-primary padding-top-1 padding-bottom-1 " onclick="audititemMain.reload();">
				...
				<div id="work_card_main_table_top_div" class="col-lg-12 col-md-12 padding-left-0 margin-top-0 padding-right-0 table-h table-set" style="overflow-x: auto;">
					<table id="work_card_main_table" class="table table-thin table-bordered table-striped table-hover table-set" >
						<thead>                              
							<tr>
								<th class="fixed-column colwidth-5 sorting" onclick="orderBy('zt')" id="zt_order">
									<div class="font-size-12 line-height-18" >状态</div>
									<div class="font-size-9 line-height-18">Status</div>
								</th>
								<th class="colwidth-13 sorting" onclick="orderBy('shxmdbh')" id="shxmdbh_order">
									<div class="font-size-12 line-height-18">审核项目单号</div>
									<div class="font-size-9 line-height-18">Audit item No.</div>
								</th>
								<th class="colwidth-5 sorting" onclick="orderBy('lx')" id="lx_order">
									<div class="font-size-12 line-height-18">类型</div>
									<div class="font-size-9 line-height-18">Type</div>
								</th>
								<th class="colwidth-9 sorting"onclick="orderBy('shdxid')" id="shdxid_order">
								...
								<th class="downward  colwidth-15" onclick="audititemMain.getGroupInfoAll()" name="th_return" >
						...
						<tbody id="auditItem_list">
						</tbody>
					</table>
				</div>
				<div class="col-xs-12 text-center page-height padding-right-0 padding-left-0" id="auditItem_pagination"></div>
				<div class="clearfix"></div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/quality/audititemlistquery/audit_item_list_query.js"></script>
</body>
</html>