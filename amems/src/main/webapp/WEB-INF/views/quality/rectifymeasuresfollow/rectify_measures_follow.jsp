...
<input type="hidden" id="zdbmid" name="zdbmid" value="${user.bmdm}" />
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body padding-bottom-0">
			  <div  class='searchContent row-height margin-top-0'>
				<div class="col-lg-1 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" >
				   <a href="javascript:void(0);" onclick="exportExcel()" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode="quality:rectifymeasuresfollow:main:05" >
				...
				<div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" >
				     <div class='pull-right'>
							...
							<label class='padding-left-5' style='margin-top:6px;font-weight:normal;'>
								<input type='checkbox' name='zt_radio' value='4' style='vertical-align:text-bottom;'/>&nbsp;待验证&nbsp;&nbsp;
							</label>
							<label class='padding-left-5' style='margin-top:6px;font-weight:normal;'>
								<input type='checkbox' name='zt_radio' value='5' style='vertical-align:text-bottom;'/>&nbsp;待关闭&nbsp;&nbsp;
							</label>
							<label class='padding-left-5' style='margin-top:6px;font-weight:normal;'>
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" >
						<span  class="col-lg-3 col-md-3 col-sm-3 col-xs-1 text-right padding-left-0 padding-right-0">
							...
							<div class="font-size-9 " style='line-height:15px;margin-top:1px;'>Object</div>
						</span>
				...
				<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group pull-right" style='padding-left:15px;'>
					...
					<div class="col-xs-12 input-group input-group-search">
							...
							<input type="text"  class="form-control " id="keyword_search" placeholder='问题编号'>
	...
	<%@ include file="/WEB-INF/views/quality/rectifymeasuresfollow/rectify_measures_assessment.jsp"%><!-------新增对话框对话框 -------->	
	<%@ include file="/WEB-INF/views/quality/rectifymeasuresfollow/rectify_measures_verified.jsp"%>	
	<%@ include file="/WEB-INF/views/quality/rectifymeasuresfollow/rectify_measures_close.jsp"%>
		<script type="text/javascript" src="${ctx}/static/js/thjw/quality/rectifymeasuresfollow/rectifymeasuresfollow_main.js"></script>
