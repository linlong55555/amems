...
<div class="modal fade in modal-new" id="rectify_measures_close_alert_Modal" tabindex="-1" role="dialog"  aria-labelledby="rectify_measures_close_alert_Modal" aria-hidden="true" data-backdrop='static' data-keyboard= false>
	           	...
	           	<div class="col-xs-12 padding-leftright-8" >
					<div class="input-group">
	                    ...
	                    <span class="input-group-addon modalfooterbtn">
	                        <button id="save_btn" type="button" onclick="rectify_measures_close.saveData();" class="operation-btn btn btn-primary padding-top-1 padding-bottom-1">
...
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/rectifymeasuresfollow/rectify_measures_close.js"></script>