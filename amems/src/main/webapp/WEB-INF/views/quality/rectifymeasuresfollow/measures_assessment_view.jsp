	...
	<div class="col-sm-12 col-xs-12 padding-left-0 padding-right-0 form-group">
		...
		<div class="col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8">
			...
			<label class='padding-left-5' style='margin-top:6px;font-weight:normal;'>
				<input type='radio' name='group_type' value='1' style='vertical-align:text-bottom'  checked="checked" disabled/>&nbsp;是&nbsp;&nbsp;
			</label>
			<label class='padding-left-5' style='margin-top:6px;font-weight:normal;'>
				<input type='radio' name='group_type' value='2' style='vertical-align:text-bottom;' disabled/>&nbsp;否&nbsp;&nbsp;
			</label>
		</div>
	</div>
	<div class="col-sm-12 col-xs-12 padding-left-0 padding-right-0 form-group">
		...
		<div class="col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8">
			...
			<label class='padding-left-5' style='margin-top:6px;font-weight:normal;'>
				<input type='radio' name='group_type1' value='1' style='vertical-align:text-bottom'  checked="checked" disabled/>&nbsp;是&nbsp;&nbsp;
			</label>
			<label class='padding-left-5' style='margin-top:6px;font-weight:normal;'>
				<input type='radio' name='group_type1' value='2' style='vertical-align:text-bottom;' disabled/>&nbsp;否&nbsp;&nbsp;
			</label>
		</div>
	</div>
	<div class="col-sm-12 col-xs-12 padding-left-0 padding-right-0 form-group">
		...
		<div class="col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8">
			...
			<label class='padding-left-5' style='margin-top:6px;font-weight:normal;'>
				<input type='radio' name='group_type2' value='1' style='vertical-align:text-bottom'  checked="checked" disabled/>&nbsp;是&nbsp;&nbsp;
			</label>
			<label class='padding-left-5' style='margin-top:6px;font-weight:normal;'>
				<input type='radio' name='group_type2' value='2' style='vertical-align:text-bottom;' disabled/>&nbsp;否&nbsp;&nbsp;
			</label>
		</div>
	</div>
