...
<div class="modal fade in modal-new" id="rectify_measures_verified_alert_Modal" tabindex="-1" role="dialog"  aria-labelledby="rectify_measures_verified_alert_Modal" aria-hidden="true" data-backdrop='static' data-keyboard= false>
      <div class="modal-dialog" style='width:75%;'>
            ...
            <div class="modal-body" >
					...
					<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8">
							<span class='input-group-btn' >
								<i class="attachment-view3 glyphicon glyphicon glyphicon-list color-blue cursor-pointer"  style="font-size:15px"  style="float: left;text-decoration:none;position:relative; margin-left: 10px;"></i>
							</span>
						</div>
					</div>
					<div class='clearfix'></div>
				 ...
				 <!-- 附件列表 -->
				 <div id="attachments_list_invalid" >
	           	...
	           	<div class="col-xs-12 padding-leftright-8" >
					<div class="input-group">
	                    ...
	                    <span class="input-group-addon modalfooterbtn">
	                        <button id="save_btn" type="button" onclick="rectify_measures_verified.saveData(5);" class="operation-btn btn btn-primary padding-top-1 padding-bottom-1">
								<div class="font-size-12">验证提交</div>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/rectifymeasuresfollow/rectify_measures_verified.js"></script>