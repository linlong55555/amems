	...
	<div class="page-content">
		<div class="panel panel-primary">
			...
			<div class="panel-body padding-bottom-0" >
		 		...
		 		<input class="form-control" id="auditnoticeId" value="${auditnoticeId}"  type="hidden" >
				<div class="input-group-border">
              	 <div class="col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-sm-8 col-xs-9 padding-leftright-8">
							<input id="jcdbh" type="text"  class="form-control" maxlength="16" placeholder='不填写时系统生成编号'/>
						</div>
				  </div>
				  <div class="col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						<label  class="col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
						...
						<div class="col-sm-8 col-xs-9 padding-leftright-8">
							<input id="jhShrq" type="text" class="form-control" maxlength="10" name='date-picker' data-date-format="yyyy-mm-dd"/>
						</div>
					</div>
				  <div class="col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						<label  class="col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
...
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/creatingauditnotice/creating_audit_notice_view.js"></script>
</body>
</html>
