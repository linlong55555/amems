...
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/creatingauditnotice/creating_audit_notice_add.js"></script>
<div class="modal fade in modal-new" id="audit_notice_alert_Modal" tabindex="-1" role="dialog"  aria-labelledby="audit_notice_alert_Modal" aria-hidden="true" data-backdrop='static' data-keyboard= false>
      <div class="modal-dialog" style='width:70%;'>
            <div class="modal-content">
				<div class="modal-header modal-header-new" >
					<h4 class="modal-title" >
                       	<div class='pull-left'>
                      		<div class="font-size-14" id="modalHeadCN">维护审核通知单</div>
							<div class="font-size-12" id="modalHeadENG">Maintenance audit notice</div>
				  		</div>
        	...
        	<input id="auditNoticeId" type="hidden" class="form-control" />
            <div class="modal-body" >
              	...
              	<form id="form">
              	 <div class="col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-sm-8 col-xs-9 padding-leftright-8">
							<input id="jcdbh" type="text" name="jcdbh" class="form-control" maxlength="50" placeholder='不填写时系统生成编号'/>
						</div>
				  </div>
				  <div class="col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						<label  class="col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
								<div class="font-size-12  margin-topnew-2"><span style="color: red">*</span>计划审核日期</div>
								<div class="font-size-9 ">Date</div>
						</label>
						<div class="col-sm-8 col-xs-9 padding-leftright-8">
							<input id="jhShrq" type="text" class="form-control date-picker" name='jhShrq' data-date-format="yyyy-mm-dd"/>
						</div>
					</div>
				  <div class="col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group" >
						<label  class="col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
					...
					<div class="col-sm-12 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-sm-10 col-xs-9 padding-leftright-8" id="audit_audit_member">
					...
					<div class="col-sm-12 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-sm-10 col-xs-9 padding-leftright-8">
							<textarea class="form-control" id="jcnr" rows="3" cols="34" maxlength="1300"></textarea>
						</div>
					</div>
				...
				<div id="attachments_list_audit" style="display:none">
	           	...
	           	<div class="col-xs-12 padding-leftright-8" >
					<div class="input-group">
	                    ...
	                    <span class="input-group-addon modalfooterbtn">
	                    	<button id="save_btn" type="button" onclick="javascript:creating_audit_notice_add.setData(0);" class="operation-btn btn btn-primary padding-top-1 padding-bottom-1">
								<div class="font-size-12">保存</div>
								<div class="font-size-9">Save</div>
							</button>
							<button id="submit_btn" type="button" onclick="javascript:creating_audit_notice_add.setData(1);"  class="operation-btn btn btn-primary padding-top-1 padding-bottom-1">
