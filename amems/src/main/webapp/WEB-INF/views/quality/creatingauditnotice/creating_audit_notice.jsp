...
<script type="text/javascript">
	...
	var plan_shdxbh = "${param.shdxbh}";
	var plan_dprtcode = "${param.dprtcode}";
	var id = "${param.id}";
...
<body class="page-header-fixed">
			...
			<div class="panel-body padding-bottom-0">
			  <div  class='searchContent row-height margin-top-0'>
				<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" >
				   <a href="javascript:void(0);" onclick="openWinAdd()" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode="quality:auditnotice:main:01" >
						<div class="font-size-12">新增</div>
						<div class="font-size-9">Add</div>
					</a>
                   <a href="javascript:exportExcel();" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode="quality:auditnotice:main:07" style="float: left;margin-left:8px;">
					...
					<table id="quality_check_list_table" class="table table-thin table-bordered table-striped table-hover table-set" >
						<thead>                              
							<tr>
								...
								<th class="colwidth-20 sorting" onclick="orderBy('shdxid')" id="shdxid_order" >
									<div class="font-size-12 line-height-18">审核对象</div>
									<div class="font-size-9 line-height-18">Object</div>
								</th>
								<th class="colwidth-7  sorting" onclick="orderBy('shlb')" id="shlb_order" >
								...
								<th class="colwidth-10 sorting" onclick="orderBy('jcnr')" id="jcnr_order" >
									<div class="font-size-12 line-height-18">审核检查内容</div>
	...
	<%@ include file="/WEB-INF/views/quality/creatingauditnotice/creating_audit_notice_add.jsp"%><!-------新增对话框对话框 -------->
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/quality/creatingauditnotice/creating_audit_notice.js"></script>
</body>
</html>