...
<input type="hidden" id="shxmdid" name="shxmdid" value="${shxmdid}" />
			...
			<div class="panel-body padding-bottom-0">
			  <div  class='searchContent row-height margin-top-0'>
				<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" >
				    <div class="col-xs-12 input-group input-group-search">
				             <div class="input-group-addon btn-searchnew" >
		                    	<a href="javascript:void(0);" onclick="openWinAdd()" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode="quality:noticeofdiscovery:main:01" >
									<div class="font-size-12">新增</div>
									<div class="font-size-9">Add</div>
								</a> 
		                    </div>
		                     <div class="input-group-addon btn-searchnew" >
		                    	<a href="javascript:exportExcel();"  class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode="quality:noticeofdiscovery:main:05" >
				...
				<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group pull-right" style='padding-left:15px;'>
					...
					<!-- 搜索框start -->
					<div class="col-xs-12 input-group input-group-search">
							<input type="text"  class="form-control " id="keyword_search" placeholder='问题单编号/审核内容'>
		                    <div class="input-group-addon btn-searchnew">
