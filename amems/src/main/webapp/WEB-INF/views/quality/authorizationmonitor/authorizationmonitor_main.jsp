		...
		$(this).keydown(function(event) {
			...
			if(e.keyCode==13){
				...
				if(formatUndefine(winId) != ""){
					...
					authorizationmonitor.search();//调用主列表页查询
				}
			}
		});
	});
		...
		<div class="panel panel-primary">
			  ...
			  <div  class='searchContent row-height ' >
				<div class='margin-top-0'>
					<div class=" col-lg-3 col-md-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0  form-group">
						<a href="#"  onclick="exportExcel()" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left  checkPermission" permissioncode='quality:authorizationmonitor:main:export,quality:authorizationmonitor:list:export' >
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" >
						...
						<div class="col-xs-8 col-sm-8 padding-left-8 padding-right-0">
							<select id="dprtcode" class="form-control " onchange="authorizationmonitor.search();">
					...
					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" style='padding-left:15px;'>	
						...
						<div class=" col-xs-12 input-group input-group-search">
						    <input type="text" placeholder='人员编号/姓名/颁发单位'  id="authorizationmonitor_keyword_search" class="form-control ">
                            <div class="input-group-addon btn-searchnew " style="padding-right: 0px !important;">
			                    <button type="button" class=" btn btn-primary padding-top-1 padding-bottom-1" onclick="authorizationmonitor.search();" style='margin-right:0px !important;'>
			...
			<div class='table_pagination'>
				...
				<div class="col-lg-12 col-md-12 padding-left-0 padding-right-0  table-height"  id="tableId" style="overflow-x: auto;">
						<table  id="authorizationmonitor_Table" class="table table-thin table-bordered table-striped table-hover table-set">
							<thead>
								<tr>
									...
									<th class="sorting  colwidth-8" onclick="authorizationmonitor.orderBy('b-rybh')" id="b-rybh_order" sortFiled="b.rybh">
										<div class="important">
											<div class="font-size-12 line-height-18">人员编号</div>
											<div class="font-size-9 line-height-18">No.</div>
										</div>
									</th>
									<th  class="sorting  colwidth-10" onclick="authorizationmonitor.orderBy('b-xm')" id="b-xm_order">
										<div class="important">
									...
									<th class="sorting  colwidth-10" onclick="authorizationmonitor.orderBy('b-wbbs')" id="b-wbbs_order">
							...
							<tbody id="authorizationmonitor_list">
							</tbody>
					</table>
				</div>	
				
				<div class="col-xs-12 text-center page-height padding-right-0 padding-left-0" id="authorizationmonitor_pagination">
				</div>
				<div class='clearfix'></div>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/authorizationmonitor/authorizationmonitor_main.js"></script><!--当前界面js  -->
