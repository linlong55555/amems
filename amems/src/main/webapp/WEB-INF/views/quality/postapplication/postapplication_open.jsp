		...
		<div class="modal-content">
			<div class="modal-header modal-header-new" >
				<h4 class="modal-title" >
                	<div class='pull-left'>
                    	<div class="font-size-12 " id="modalName">授权申请</div>
						<div class="font-size-9 " id="modalEname">Authorized Application</div>
					</div>
				...
				<form id="form1">	
					...
					<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8">
							<div class="input-group" style="width: 100%">
								...
								<input type="text"  name="xm" id="xm"  class="form-control noteditable readonly-style colse "   readonly="readonly" ondblclick="">
								<span class="required input-group-btn" >
									<button type="button" class="btn btn-default form-control checkPermission"  permissioncode='quality:post:application:main:06' style='height:34px;' data-toggle="modal" onclick="Post_Open_Modal.openPersonelWin();">
					...
					<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							...
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8">
								...
								<input type="text" class="form-control readonly-style colse  colsegwsq"   id="sqgwms" name="sqgwms"   readonly="readonly" ondblclick="Post_Open_Modal.openProjectWin();"/>
								<span class="required requiredgwsq input-group-btn" >
		            ...
		            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							<span class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
								<div class="font-size-12 margin-topnew-2"><span class="identifying" style="color: red">*</span>审核领导</div>
							...
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 ">
							  <div class='input-group'>
									<input type="hidden"  name="shrid"  id="shrid">
										...
										<input type="text"  name="shr" id="shr"  class="form-control  readonly-style "  readonly="readonly" ondblclick="Post_Open_Modal.openUser('shr');">
					...
					<div class="input-group">
						<span class="pull-left modalfootertip" >
					 	...
					 	<span class="input-group-addon modalfooterbtn">
							<button id="baocuns" type="button" onclick="Post_Add_Modal.save();" class="btn btn-primary padding-top-1 padding-bottom-1">
								<div class="font-size-12">保存</div>
								<div class="font-size-9">Save</div>
							</button>
							<button id="tijiao" type="button" onclick="Post_Add_Modal.submit();" class="btn btn-primary padding-top-1 padding-bottom-1">
								<div class="font-size-12">提交</div>
								<div class="font-size-9">Submit</div>
							</button>
							<button id="xgshr" type="button" onclick="Post_Update_Shr_Modal.save();" class="btn btn-primary padding-top-1 padding-bottom-1">
								<div class="font-size-12">保存</div>
								<div class="font-size-9">Save</div>
							</button>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/postapplication/postapplication_add.js"></script><!--新增岗位申请弹窗的js  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/postapplication/postapplication_update.js"></script><!--修改岗位申请弹窗的js  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/postapplication/postapplication_updateshr.js"></script><!--修改审核人弹窗的js  -->