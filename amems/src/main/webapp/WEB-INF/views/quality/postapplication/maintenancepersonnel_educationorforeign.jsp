				...
				<thead>
					<tr>
					   <th class="colwidth-10">
			   			...
			   			<th>
					   		<div class="font-size-12 line-height-12">教育经历/外语水平</div>
			           		<div class="font-size-9 line-height-12">Education/Foreign</div>
				   		</th>
					</tr>
				</thead>
				<tbody id="maintenance_educationorforeign_list">
...
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/postapplication/maintenancepersonnel_educationorforeign.js"></script>