...
<body >
						...
						<div id="ztsDiv" class="col-lg-9 col-md-9 col-sm-8 col-xs-10 padding-left-8 padding-right-0 label-input-div" >
							<select class='form-control' id="zts"  onchange="search()">
								...
								<c:forEach items="${postStatusEnum}" var="item">
										<option value="${item.id}" <c:if test="${item.id eq 2}">selected='selected'</c:if>>${item.name}</option>
								</c:forEach>
						    </select>
						</div>
				</div> 
				...
				<div class="col-xs-12 col-lg-12 col-sm-12 triangle  padding-top-10  margin-bottom-10 display-none border-cccccc" id="divSearch">
					<div class="col-xs-12 col-sm-6 col-lg-3  padding-left-0 padding-right-0 margin-bottom-10 ">
						...
						<div class="col-xs-8 col-sm-8 padding-left-8 padding-right-0">
							<input type='text' placeholder='人员编号/姓名' id="sqrs"  class='form-control'/>
						</div>
					</div>
					<div class="col-xs-12 col-sm-6 col-lg-3  padding-left-0 padding-right-0 margin-bottom-10 ">
						<span class="pull-left col-xs-4 col-sm-4 text-right padding-left-0 padding-right-0">
						...
						<table  id="postapplicationTable" class="table table-thin table-bordered table-striped table-hover table-set">
							<thead>
								<tr>
									...
									<th class="colwidth-15 sorting" onclick="orderBy('rybh')" id="rybh_order" >
										<div class="important">
											<div class="font-size-12 line-height-18">人员编号</div>
											<div class="font-size-9 line-height-18">Maintenance No.</div>
										</div>
									</th>
									<th class="colwidth-15 sorting" onclick="orderBy('xm')" id="xm_order">
										<div class="important">
									...
									<th class="colwidth-15 sorting" onclick="orderBy('szdw')" id="szdw_order">
										<div class="important">
											<div class="font-size-12 line-height-18">部门</div>
											<div class="font-size-9 line-height-18">Department</div>
										</div>
									</th>
									<th class="colwidth-8 sorting" onclick="orderBy('sqlx')" id="sqlx_order">
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/quality/postapplicationreview/postapplicationreview_main.js"></script><!--当前界面js  -->
	<%@ include file="/WEB-INF/views/quality/postapplicationreview/postapplicationreview_open.jsp" %> <!--新增编辑弹出框  -->
