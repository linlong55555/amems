...
<body class="page-header-fixed">
    ...
    <input id="year_search" type="hidden">
			...
			<div class="panel-heading" style='border-bottom:0px;'>
				<div class="font-size-12 line-height-12">待批准</div>
				<div class="font-size-9 line-height-9">To be approved</div>
			</div>
			<div class="panel-body padding-left-0 padding-right-0"  style='padding-top:0px;' >
				<!-- 搜索 -->
			    ...
			    <div class="col-xs-12 padding-leftright-8 margin-top-8">
					<div class="input-group input-group-new">
						...
						<textarea id="pfyj" class="form-control" style='height: 55px;' maxlength="100"></textarea>
                	</div><!-- /input-group -->
				</div>
				<div class="col-xs-12 padding-leftright-8 margin-top-8" style='margin-bottom:0px;'>
				   <div class='pull-right'>
					<a class="btn btn-primary padding-top-1 padding-bottom-1 margin-left-3 pull-left checkPermission" 
                    	id="add_btn" onclick="annual_plan_approval_main.approvalBh()" href="javascript:void(0);"  
                    	permissioncode='quality:annualplan:main:08'>
						<div class="font-size-12">批准驳回</div>
						<div class="font-size-9">Rejected</div>
					</a>
					<a class="btn btn-primary padding-top-1 padding-bottom-1 margin-left-3 pull-left checkPermission"
						 id="revision_btn" onclick="annual_plan_approval_main.approval()" href="javascript:void(0);" 
						 permissioncode='quality:annualplan:main:08'>
	...
	<%-- <%@ include file="/WEB-INF/views/quality/annualplan/annual_plan_add.jsp"%><!-------新增对话框对话框 -------->
	<%@ include file="/WEB-INF/views/quality/annualplan/annual_plan_attachment.jsp"%><!-------附件 --------> --%>
	<script type="text/javascript" src="${ctx}/static/js/thjw/quality/annualplan/annual_plan_approval.js"></script>
