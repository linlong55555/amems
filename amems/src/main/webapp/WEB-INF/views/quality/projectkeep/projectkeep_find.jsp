...
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/projectkeep/projectkeep_open.js"></script><!--项目保留弹窗的js  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/projectkeep/projectkeep_find.js"></script><!--查看项目保留弹窗的js  -->
</body>
</html>