		  ...
		  <div  class='searchContent  row-height' >
			<div class='margin-top-0'>
				<div class=" col-lg-3 col-md-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0  form-group">
					<a href="javascript:Project_Add_Modal.open();"  class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode='project2:assessment:main:01'>
						<div class="font-size-12">新增</div>
						<div class="font-size-9">Add</div>
					</a>
					<a href="javascript:Assessment_Open_Modal.show(1);"  class="btn btn-primary padding-top-1 margin-left-10 padding-bottom-1 pull-left row-height checkPermission" permissioncode='project2:assessment:main:01'>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/projectkeep/projectkeep_main.js"></script><!--当前界面js  -->
<%@ include file="/WEB-INF/views/quality/projectkeep/projectkeep_open.jsp" %> <!--新增编辑界面  -->
