			  ...
			  <div  class='searchContent row-height'>
				<div class='margin-top-0'>
					<div class=" col-lg-3 col-md-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0  form-group">
						<a href="javascript:FailureKeep_Add_Modal.open();"  class="btn btn-primary padding-top-1 padding-bottom-1 pull-left  checkPermission" permissioncode='produce:reservation:fault:main:01'>
							<div class="font-size-12">新增</div>
							<div class="font-size-9">Add</div>
						</a>
						<a href="javascript:Assessment_Open_Modal.show(1);"  class="btn btn-primary padding-top-1 margin-left-10 padding-bottom-1 pull-left  checkPermission" permissioncode='produce:reservation:fault:main:09'>
						...
						<thead>
							<tr>
								...
								<th  class="sorting  colwidth-15" onclick="orderBy('gzms')" id="gzms_order">
									...
									<div class="font-size-9 line-height-18">Defect Des</div>
								</th>
								...
								<th  class="sorting colwidth-10"  onclick="orderBy('sc_blqx')" id="sc_blqx_order">
									<div class="font-size-12 line-height-18">首次保留期限</div>
									<div class="font-size-9 line-height-18">Expiry Date</div>
								</th>
								<th  class="sorting  colwidth-10" onclick="orderBy('zc_sqrq')" id="zc_sqrq_order">
									<div class="font-size-12 line-height-18">再次保留申请日期</div>
									<div class="font-size-9 line-height-18">Second Date</div>
								</th>
								<th  class="sorting  colwidth-12" onclick="orderBy('zc_blqx')" id="zc_blqx_order">
...
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/failurekeep/failurekeep_main.js"></script><!--当前界面js  -->
<%@ include file="/WEB-INF/views/quality/failurekeep/failurekeep_open.jsp" %> <!--新增编辑界面  -->
