								...
								<div class="col-xs-12 margin-top-8 padding-left-0  padding-right-0" >
									...
									<div class='clearfix'></div>
										...
										<div class="col-lg-10 col-md-11 col-sm-10 col-xs-9 padding-leftright-8" >
											<div class="input-group input-group-new">
							                    <span class="input-group-addon" style="padding-left:0px">
							                    	<label><input type='radio' onclick="FailureKeep_Open_Modal.onchangebllx();" class="noteditable" name='bllx' value="1" checked />&nbsp;A&nbsp;</label>
							                    </span>
							                     <span class="input-group-addon">
							                    	 <label><input type='radio' onclick="FailureKeep_Open_Modal.onchangebllx();" class="noteditable" name='bllx' value="2"/>&nbsp;B&nbsp;</label>
												 </span>
							                     <span class="input-group-addon">
							                    	 <label><input type='radio' onclick="FailureKeep_Open_Modal.onchangebllx();" class="noteditable" name='bllx' value="3" />&nbsp;C&nbsp;</label>
												 </span>
							                     <span class="input-group-addon">
							                    	 <label><input type='radio' onclick="FailureKeep_Open_Modal.onchangebllx();" class="noteditable" name='bllx' value="4" />&nbsp;D&nbsp;</label>
												 </span>
							                     <span class="input-group-addon">
							                    	 <label><input type='radio' onclick="FailureKeep_Open_Modal.onchangebllx();" class="noteditable" name='bllx' value="5" />&nbsp;CDL&nbsp;</label>
												 </span>
							                     <span class="input-group-addon">
							                    	 <label><input type='radio' onclick="FailureKeep_Open_Modal.onchangebllx();" class="noteditable" name='bllx' value="9" />&nbsp;其他&nbsp;</label>
												 </span>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/failurekeep/failurekeep_add.js"></script><!--新增故障保留弹窗的js  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/failurekeep/failurekeep_update.js"></script><!--修改故障保留弹窗的js  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/failurekeep/failurekeep_approval.js"></script><!--批准故障保留弹窗的js  -->
