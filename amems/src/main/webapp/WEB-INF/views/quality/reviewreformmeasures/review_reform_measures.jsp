			...
			<div class="panel-body padding-bottom-0" >
			  <div  class='searchContent row-height margin-top-0'>
				<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" >
				   <a href="javascript:void(0);" onclick="batchApproveWin()" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode="quality:correctivemeasures:main:03" >
						<div class="font-size-12">反馈</div>
						<div class="font-size-9">Feedback</div>
					</a>
				   <a href="javascript:exportExcel();" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode="quality:correctivemeasures:main:04" style="float: left;margin-left:8px;">
				...
				<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" >
				     <div class='pull-right'>
						<label class='padding-left-5' style='margin-top:6px;font-weight:normal;'>
							...
							<label class='padding-left-5' style='margin-top:6px;font-weight:normal;'>
								<input type='checkbox' name='zt_radio' value='1' style='vertical-align:text-bottom;' checked/>&nbsp;未填写&nbsp;&nbsp;
							</label>
							<label class='padding-left-5' style='margin-left:5px;margin-top:6px;font-weight:normal;'>
								<input type='checkbox' id="ztYtx" name='zt_radio' value='2' style='vertical-align:text-bottom'  checked="checked"/>&nbsp;已执行&nbsp;&nbsp;
							</label>
							<label class='padding-left-5' style='margin-top:6px;font-weight:normal;'>
						...
						<thead>                              
							<tr>
								...
								<th class="colwidth-15 sorting" onclick="orderBy('zgjy')" id="zgjy_order" >
										...
										<div class="font-size-9 line-height-18">Advice</div>
								</th>
