			  ...
			  <div  class='searchContent row-height' >
				<div class='margin-top-0'>
					<div class=" col-lg-3 col-md-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0  form-group">
						<a href="javascript:Defectkeep_Add_Modal.open();"  class="btn btn-primary padding-top-1 padding-bottom-1 pull-left  checkPermission" permissioncode='produce:reservation:defect:main:01'>
							<div class="font-size-12">新增</div>
							<div class="font-size-9">Add</div>
						</a>
						<a href="javascript:Assessment_Open_Modal.show(1);"  class="btn btn-primary padding-top-1 margin-left-10 padding-bottom-1 pull-left  checkPermission" permissioncode='produce:reservation:defect:main:08'>
					...
					<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group row-height" style='padding-left:15px;'>
					...
					<table  id="defrctkeepTable" class="table table-thin table-bordered table-striped table-hover table-set">
						<thead>
							<tr>
								...
								<th  class="sorting  colwidth-18" onclick="orderBy('xdgdbh')" id="xdgdbh_order">
								...
								<th  class="sorting  colwidth-13" onclick="orderBy('whr')" id="whr_order">
...
<!--日志END  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/defectkeep/defectkeep_main.js"></script><!--当前界面js  -->
<%@ include file="/WEB-INF/views/quality/defectkeep/defectkeep_open.jsp" %> <!--新增编辑界面  -->
<%@ include file="/WEB-INF/views/quality/failurekeep/filesDown.jsp" %> <!--附件列表界面  -->
<%@ include file="/WEB-INF/views/quality/defectkeep/shutDown.jsp" %> <!--关闭 -->
