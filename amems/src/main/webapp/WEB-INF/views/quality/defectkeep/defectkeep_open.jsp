...
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/defectkeep/defectkeep_open.js"></script><!--项目保留弹窗的js  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/defectkeep/defectkeep_add.js"></script><!--新增项目保留弹窗的js  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/defectkeep/defectkeep_update.js"></script><!--修改项目保留弹窗的js  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/quality/defectkeep/defectkeep_approval.js"></script><!--批准项目保留弹窗的js  -->
