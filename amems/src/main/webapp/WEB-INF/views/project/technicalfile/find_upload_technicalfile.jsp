...
Navigation(menuCode,"查看技术文件","View");
		...
		<div class="panel panel-primary">
			...
			<div class="col-lg-12 col-sm-12 col-xs-12 widget-body clearfix padding-left-0 padding-right-0  margin-right-0 margin-bottom-10" id="yxdxList">
                  ...
                  <div class="tab-content">
                  			 <div class="col-lg-12 col-sm-12 col-xs-12 padding-right-0">
								...
								<div class="col-xs-12 text-center margin-bottom-5 padding-left-0 padding-right-0 padding-top-0 "  style="overflow-x:auto;">
									<table class="table table-bordered table-striped table-hover text-center padding-right-0" style="min-width:1000px">
										<thead> 
									   		<tr>
				...
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">
					...
					<div class="clearfix"></div>
					<div class=" col-lg-12 col-sm-12 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 padding-top-8 form-group">
						<label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0">关闭条件
							<div class="font-size-9 line-height-18">Close Condition</div>
						</label>
                   ...
                   <div class=" col-lg-12 col-sm-12 col-xs-12  padding-left-0 margin-bottom-10 padding-right-0 form-group">
					...
					<div class=" col-lg-12 col-sm-12 col-xs-12  padding-left-0 margin-bottom-10 padding-right-0 form-group">
						...
						　
						<div class="pull-left padding-right-10">
						<div class="font-size-12 line-height-18">批准人　<label style="margin-right: 50px; font-weight:normal">${technicalFile.pfr_user.displayName}</label></div><%-- <fmt:formatDate value='${technicalFile.pfsj}' pattern='yyyy-MM-dd' /> --%>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project/technicalfile/find_upload_technicalfile.js"></script>
</body>
</html>