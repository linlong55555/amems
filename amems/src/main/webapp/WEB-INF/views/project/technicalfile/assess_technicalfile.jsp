...
<input id="technicalFileDprtcode" value="${technicalFile.dprtcode}" type="hidden"></input>
...
//导航
Navigation(menuCode,"评估技术文件","Assessment");
});
</script>
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<label  style="font-weight:normal" class="form-control " readonly="readonly">${erayFns:escapeStr(technicalFile.pgdh)}</label>
						</div>
				</div>
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
						 ...
						 <div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0" >
								<input type="text" id="zdsj" value="<fmt:formatDate value='${technicalFile.zdsj}' pattern='yyyy-MM-dd' />" name="zdsj" placeholder='长度最大为30'   maxlength="30" class="form-control"  disabled="disabled">
						</div>
				</div>
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
						 ...
						 <div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0" >
							<a href=javascript:downfile("${technicalUpload.id}")>${erayFns:escapeStr(technicalUpload.wbwjm)}.${technicalUpload.hzm}</a>
						</div>
				</div>
				...
				<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 form-group padding-right-0">
					<textarea class="form-control" id="bz"   maxlength="300" disabled="disabled">${technicalFile.bz}</textarea>
				</div>
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control  date-picker" type="text" name="fbrq" id="fbrq" data-date-format="yyyy-mm-dd" value="<fmt:formatDate value='${technicalFile.fbrq}' pattern='yyyy-MM-dd' />" />
						</div>
				</div>
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control" type="text" name="dj" id="dj" value="${erayFns:escapeStr(technicalFile.dj)}" maxlength="15" />
						</div>
				</div>
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control" type="text" name="jjcd" id="jjcd" value="${erayFns:escapeStr(technicalFile.jjcd)}" maxlength="15"/>
						</div>
				</div>
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<select class="form-control" name="wczl" id="wczl">
					...
					<div class=" col-lg-12 col-sm-12 col-xs-12  padding-left-0 margin-bottom-10 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-sm-6 col-xs-4 padding-left-8 form-group padding-right-0 " style='margin-bottom:0px;'>
							<textarea class="form-control" id="xgwj"  maxlength="50" >${erayFns:escapeStr(technicalFile.xgwj)}</textarea>
						</div>
					</div>
					...
					<div class=" col-lg-12 col-sm-12 col-xs-12  padding-left-0 margin-bottom-10 padding-right-0 form-group" >
						...
						<div class="col-lg-8 col-sm-6 col-xs-4 padding-left-8 form-group padding-right-0 " style='margin-bottom:0px;'>
							<textarea class="form-control" id="wjzt"  maxlength="100" >${erayFns:escapeStr(technicalFile.wjzt)}</textarea>
						</div>
					</div>
				...
				<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0">
							<textarea class="form-control" id="sjgz" placeholder='长度最大为300'   maxlength="300">${erayFns:escapeStr(technicalFile.sjgz)}</textarea>
				</div>
				...
				<div class="form-group margin-top-10">
						...
						<div class="font-size-9 line-height-18">Abstract</div></label>
						<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8  padding-right-0">
							<textarea class="form-control" id="wjzy" placeholder='长度最大为300'   maxlength="300">${erayFns:escapeStr(technicalFile.wjzy)}</textarea>
					</div>
				</div>

				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group margin-top-10" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<select id="syx" class="form-control"  name="syx"  onchange="showOrHide(this.value);" >
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group margin-top-10" id="syxdxms" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
								class="font-size-12 line-height-18">受影响对象描述</div>
							<div class="font-size-9 line-height-18">Desc</div></label>
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control"  name="syxdx" value="${erayFns:escapeStr(technicalFile.syxdx)}" id="syxdx" maxlength="60"/>
						</div>
				</div>
				...
				<label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0 "  >
						...
						<div class="font-size-9 line-height-18">Order</div></label>
						<div class="col-lg-11 col-sm-9 col-xs-8 padding-left-8 padding-right-0">
						<div class="col-lg-12 col-sm-12 col-xs-12  ">
							<div class="col-lg-3 col-sm-6 col-xs-12  ">
							 	<label style="font-weight:normal"><input class="pull-left margin-right-5 " type="checkbox" id="isJstg" value="${technicalFile.isJstg}" name="isJstg"  /><div class="pull-right"><div class="font-size-12 line-height-18">维护提示</div><div class="font-size-9 line-height-12">Technical Bulletin</div></div> </label> 
							</div>
							<div class="col-lg-3 col-sm-6 col-xs-12  ">
						 		<label style="font-weight:normal"><input class="pull-left margin-right-5 " type="checkbox" id="isJszl" value="${technicalFile.isJszl}" name="isJszl"   /><div class="pull-right"><div class="font-size-12 line-height-18">技术指令</div><div class="font-size-9 line-height-12">Technical Order</div></div> </label> 
						 	</div>
							<div class="col-lg-3 col-sm-6 col-xs-12  ">
						 		<label style="font-weight:normal"><input class="pull-left margin-right-5 " type="checkbox" id="isWxfa" value="${technicalFile.isWxfa}" name="isWxfa"   /><div class="pull-right"><div class="font-size-12 line-height-18">修订维修方案</div><div class="font-size-9 line-height-12">Amendment Maintenance</div></div> </label> 
							</div>
							<div class="col-lg-3 col-sm-6 col-xs-12  ">
						 		<label style="font-weight:normal"><input class="pull-left margin-right-5 " type="checkbox" id="isXdmel" value="${technicalFile.isXdmel}" name="isXdmel"   /><div class="pull-right"><div class="font-size-12 line-height-18">修订MEL</div><div class="font-size-9 line-height-12">Amendment MEL</div></div> </label> 
							</div>
						</div>
						<div class="col-lg-12 col-sm-12 col-xs-12  ">
							<div class="col-lg-3 col-sm-6 col-xs-12  ">
						 		<label style="font-weight:normal"><input class="pull-left margin-right-5 " type="checkbox" id="isXdgk" value="${technicalFile.isXdgk}" name="isXdgk"   /><div class="pull-right"><div class="font-size-12 line-height-18">修订工卡</div><div class="font-size-9 line-height-12">Amendment Card</div></div> </label> 
							</div>
							<div class="col-lg-3 col-sm-6 col-xs-12  " >
						 	<label style="font-weight:normal"><input class="pull-left margin-right-5 " type="checkbox" id="isGczl" value="${technicalFile.isGczl}" name="isGczl"  /><div class="pull-right"><div class="font-size-12 line-height-18">工程指令</div><div class="font-size-9 line-height-12">Engineering Order</div></div> </label> 
							</div>
							<div class="col-lg-3 col-sm-6 col-xs-12  ">	
								 <label style=" font-weight:normal"><input class="pull-left margin-right-5 " type="checkbox" id="isFjgd" value="${technicalFile.isFjgd}" name="isFjgd"   /><div class="pull-right"><div class="font-size-12 line-height-18">附加工单</div><div class="font-size-9 line-height-12">Attached W/O</div></div> </label> 
							</div>
							<div class="col-lg-3 col-sm-6 col-xs-12  ">
							 	<label style="font-weight:normal"><input class="pull-left margin-right-5 " type="checkbox" id="isFlxgd" value="${technicalFile.isFlxgd}" name="isFlxgd"   /><div class="pull-right"><div class="font-size-12 line-height-18">排故工单</div><div class="font-size-9 line-height-12">Troubleshooting W/O</div></div> </label> 
						 	</div>
						 	<div class="col-lg-3 col-sm-6 col-xs-12  ">
						 		<label style="font-weight:normal"><input class="pull-left margin-right-5 " type="checkbox" id="isZjfj" value="${technicalFile.isZjfj}" name="isZjfj"   /><div class="pull-right"><div class="font-size-12 line-height-18">转交飞行部</div><div class="font-size-9 line-height-12">Flight Dept</div></div> </label> 
							</div>
							<div class="col-lg-3 col-sm-6 col-xs-12  " >
								<div class="input-group">
									 <label  class='input-group-addon padding-left-0' style="border:0px;background:none; font-weight:normal">
										 <input class="pull-left margin-right-5" onclick="showOrHides(this.value);" type="checkbox" id="isQt" value="${technicalFile.isQt}" name="isQt"  />
										 <div class="pull-left"><div class="font-size-12 line-height-18">其他</div><div class="font-size-9 line-height-12">Other</div></div> 
									 </label>   
									<input maxlength="30" class="form-control" id="qtMs" value="${erayFns:escapeStr(technicalFile.qtMs)}" name="qtMs" id="qtMs" >
								</div>
							</div>
					 	</div>
					</div>
			...
			<div class="col-xs-12 widget-body clearfix padding-left-0 padding-right-0  margin-right-10 margin-bottom-10" id="yxdxList">
                  ...
                  <div class="tab-content">
                  			 <div class="col-lg-12 col-xs-12 padding-right-0">
							    <div class="text-left margin-top-10 padding-right-0">
				                </div>
								<!-- start:table -->
								<div class="margin-top-10 ">
								<div class="col-xs-12 text-center margin-bottom-5 padding-left-0 padding-right-0 padding-top-0 "  style="overflow-x:auto;">
									<table class="table table-bordered table-striped table-hover padding-right-0 text-center table-set" style="min-width:1000px">
										<thead> 
									   		<tr>
												<th class="colwidth-3">
													<a href="javascript:addRotatableCol();"  >
														<button class="line6"><i class="icon-plus" ></i></button>
													</a>
												</th>
					...
					<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0">
						...
						<div class="col-lg-8 col-sm-8 col-xs-8  padding-left-8 padding-right-0 form-group">
							<label style="margin-right: 20px;font-weight: normal">
								<c:choose>
									<c:when test="${technicalFile.isMfhc eq null}">
										<input name="isMfhc" type="radio" value="1" checked />是
									</c:when>
									<c:otherwise>
										<input name="isMfhc" type="radio" value="1"  <c:if test="${'1' eq technicalFile.isMfhc}">checked</c:if> />是
									</c:otherwise>
								</c:choose>
							...
							<label style="font-weight: normal">
								<c:choose>
									<c:when test="${technicalFile.isMfhc eq null}">
										<input name="isMfhc" type="radio" value="0" />否
									</c:when>
									<c:otherwise>
										<input name="isMfhc" type="radio" value="0" <c:if test="${'0' eq technicalFile.isMfhc}">checked</c:if> />否 
									</c:otherwise>
								</c:choose>
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0">
						...
						<div class="col-lg-8 col-sm-8 col-xs-8  padding-left-8 padding-right-0 form-group">
							<label style="margin-right: 20px;font-weight: normal">
							<c:choose>
									<c:when test="${technicalFile.isZbhc eq null}">
										<input name="isZbhc" type="radio" value="1" checked />是
									</c:when>
									<c:otherwise>
										<input name="isZbhc" type="radio" value="1"  <c:if test="${'1' eq technicalFile.isZbhc}">checked</c:if> />是
									</c:otherwise>
							</c:choose>
							</label> 
							...
							<c:choose>
									<c:when test="${technicalFile.isZbhc eq null}">
										<input name="isZbhc" type="radio" value="0"  />否
									</c:when>
									<c:otherwise>
										<input name="isZbhc" type="radio" value="0"  <c:if test="${'0' eq technicalFile.isZbhc}">checked</c:if> />否
									</c:otherwise>
							</c:choose>
							</label> 
						</div>
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0">
						...
						<div class="col-lg-8 col-sm-8 col-xs-8  padding-left-8 padding-right-0 form-group">
							<label style="margin-right: 20px;font-weight: normal">
							<c:choose>
									<c:when test="${technicalFile.isTsgj eq null}">
										<input name="isTsgj" type="radio" value="1" checked />是
									</c:when>
									<c:otherwise>
										<input name="isTsgj" type="radio" value="1"  <c:if test="${'1' eq technicalFile.isTsgj}">checked</c:if> />是
									</c:otherwise>
							</c:choose>
							</label> 
							...
							<label style="font-weight: normal">
															<c:choose>
									<c:when test="${technicalFile.isTsgj eq null}">
										<input name="isTsgj" type="radio" value="0"  />否
									</c:when>
									<c:otherwise>
										<input name="isTsgj" type="radio" value="0"  <c:if test="${'0' eq technicalFile.isTsgj}">checked</c:if> />否
									</c:otherwise>
							</c:choose>
							</label> 
						</div>
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0">
						...
						<div class="col-lg-8 col-sm-8 col-xs-8  padding-left-8 padding-right-0 form-group">
							<label style="margin-right: 20px;font-weight: normal">
							<c:choose>
									<c:when test="${technicalFile.isYxzlph eq null}">
										<input name="isYxzlph" type="radio" value="1" checked />是
									</c:when>
									<c:otherwise>
										<input name="isYxzlph" type="radio" value="1"  <c:if test="${'1' eq technicalFile.isYxzlph}">checked</c:if> />是
									</c:otherwise>
							</c:choose>	
							</label> 
							...
							<c:choose>
									<c:when test="${technicalFile.isYxzlph eq null}">
										<input name="isYxzlph" type="radio" value="0"  />否
									</c:when>
									<c:otherwise>
										<input name="isYxzlph" type="radio" value="0"  <c:if test="${'0' eq technicalFile.isYxzlph}">checked</c:if> />否
									</c:otherwise>
							</c:choose>	
							</label> 
						</div>
				...
				<div class=" col-lg-12 col-sm-12 col-xs-12  padding-left-0 margin-bottom-10 padding-right-0 form-group padding-top-8">
						<label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0">关闭条件
							...
							<div class=" col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control" type="text" name="gbtj" id="gbtj" value="${erayFns:escapeStr(technicalFile.gbtj)}" maxlength="50"/>
						</div>
				</div>
                ...
                <div class=" col-lg-12 col-sm-12 col-xs-12  padding-left-0  padding-right-0 form-group">
						<label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0"><div class="font-size-12 line-height-18">服务信件内容</div>
							...
							<div class=" col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control" name="fwxjnr" id="fwxjnr" value="${erayFns:escapeStr(technicalFile.fwxjnr)}" maxlength="300" placeholder='长度最大为300'>
						</div>
				</div>
				...
				<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0">
							<textarea class="form-control" id="pgyj" placeholder='长度最大为150'   maxlength="150">${erayFns:escapeStr(technicalFile.pgyj)}</textarea>
				</div>
				...
				<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-top-8 padding-right-0">
							<textarea class="form-control" id="shyj" disabled="disabled">${erayFns:escapeStr(technicalFile.shyj)}</textarea>
				</div>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project/technicalfile/assess_technicalfile.js"></script>
</body>
</html>