...
<input id="syx1" value="${erayFns:escapeStr(technicalFile.syx)}" type="hidden" />
<input id="zt" value="${technicalFile.zt}" type="hidden" />
<input id="pgrid1" value="${technicalFile.pgrid}" type="hidden" />
<input type="hidden" id="technicalFileId" value="${technicalFile.id}" />
...
//导航
Navigation(menuCode,"查看技术文件","View");
});
</script>
			...
			<div class="panel-body">
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
					 	...
					 	<input id="pgrid" class="form-control " name="pgrid" value="${technicalFile.pgrid}" disabled="disabled" />
						</div>
				</div>
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control date-picker" value="${technicalFile.sxrqDate}" id="sxrq" name="sxrq" data-date-format="yyyy-mm-dd" type="text" disabled="disabled"/>
						</div>
				</div>
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
						 ...
						 <div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0" >
								<input class="form-control  date-picker" value="${technicalFile.pgqxDate}" id="pgqx" name="pgqx" data-date-format="yyyy-mm-dd" type="text" disabled="disabled"/>
						</div>
				</div>
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control"  name="ztnum" value="${technicalFile.zt}" id="ztnum" disabled="disabled"/>
						</div>
				</div>
				...
				<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control"  name="ztnum" value="${technicalFile.zdrid}" id="ztnum" disabled="disabled"/>
						</div>
				</div>
				...
				<div class="col-lg-11 col-sm-9 col-xs-8 padding-left-8 form-group">
				...
				<div class=" col-lg-3 col-sm-3 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8">
							<select class="form-control" name="wczl" id="wczl" disabled="disabled">
				...
				<div class="clearfix"></div>
					...
					<div class="col-lg-11 col-sm-9 col-xs-8 padding-left-8">
				...
				<br/>
					...
					<div class=" col-lg-3 col-sm-3 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
								class="font-size-12 line-height-18">适用性</div>
					...
					<div class=" col-lg-3 col-sm-3 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" id="syxdxms" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
...
<div class="col-xs-12 widget-body clearfix padding-left-0 padding-right-0  margin-right-10 margin-bottom-10" style="width: 90%; margin-left: 9%;" id="yxdxList">
				...
				<div class="col-lg-12 col-sm-4 col-xs-12 padding-left-0 padding-right-0">
					...
					<div class="clearfix"></div>
					<div class=" col-lg-12 col-sm-4 col-xs-12  padding-left-0 margin-bottom-10 padding-top-8 form-group">
						<label class="col-xs-1 text-right padding-left-0 padding-right-0">关闭条件
                   ...
                   <div class=" col-lg-12 col-sm-4 col-xs-12  padding-left-0 margin-bottom-10 form-group">
						<label class="col-xs-1 text-right padding-left-0 padding-right-0"><div class="font-size-12 line-height-18">服务信件内容</div>
					...
					<label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0 padding-top-8"  >
						...
						<div class="font-size-9 line-height-18">Engineer Opinion</div></label>
					...
					<label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0 padding-top-8"  >
						...
						<div class="font-size-12 line-height-18">评估人　<label style="margin-right: 50px; font-weight:normal">${technicalFile.pgrid}</label></div>
				...
				<div class="clearfix"></div>
					...
					<label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0 padding-top-8"  >
						...
						<div class="font-size-9 line-height-18">Director Opinion</div></label>
						<div class="col-lg-11 col-sm-9 col-xs-8 padding-left-8 padding-top-8">
					...
					<div class="clearfix"></div>
						...
						　<label style="margin-right: 50px"></label>　
						<div class="pull-left padding-right-10">
						<div class="font-size-12 line-height-18">审核人　<label style="margin-right: 50px; font-weight:normal">${technicalFile.shrid}</label></div>
					...
					<div class="clearfix"></div>
						...
						<div class="font-size-9 line-height-12">Manager/Authorized Opinion</div></label>
						<div class="col-lg-11 col-sm-9 col-xs-8 padding-left-8 padding-top-8">
							<textarea class="form-control" id="pfyj" disabled="disabled">${erayFns:escapeStr(technicalFile.pfyj)}</textarea>
					</div>
					<div class="clearfix"></div>
						<label class="col-lg-1 col-sm-1 col-xs-1 text-right padding-left-0 padding-right-0 padding-top-8"  >
						</label>
						<div class="col-lg-11 col-sm-11 col-xs-11 padding-left-8 padding-top-8">
						　
						<div class="pull-left padding-right-10">
						<div class="font-size-12 line-height-18">批准人　<label style="margin-right: 50px; font-weight:normal">${technicalFile.pfrid}</label></div><%-- <fmt:formatDate value='${technicalFile.pfsj}' pattern='yyyy-MM-dd' /> --%>
				...
				<div class="clearfix"></div>
				  <div class="text-right">
                     <!-- <button onclick="btnSave()" class="btn btn-primary padding-top-1 padding-bottom-1 margin-bottom-10" ><div
					  ...
					  <button onclick="btnSave1()" class="btn btn-primary padding-top-1 padding-bottom-1 margin-bottom-10" ><div
						class="font-size-12">审核驳回</div>
					<div class="font-size-9">Save</div></button>&nbsp;&nbsp;&nbsp;&nbsp; -->
                     	<!-- <button class="btn btn-primary padding-top-1 padding-bottom-1 margin-bottom-10" onclick="back()"><div
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project/technicalfile/find_searce_technicalfile.js"></script>
</body>
</html>