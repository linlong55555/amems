...
<input id="zt" value="${erayFns:escapeStr(technicalFile.zt)}" type="hidden" />
                  ...
                  <div class="tab-content">
                  			 <div class="col-lg-12 col-xs-12 padding-right-0">
								...
								<div class="col-xs-12 text-center margin-bottom-5 padding-left-0 padding-right-0 padding-top-0 "  style="overflow-x:auto;">
									<table class="table table-bordered table-striped padding-right-0 table-hover text-center" style="min-width:1000px">
										<thead> 
									   		<tr>
