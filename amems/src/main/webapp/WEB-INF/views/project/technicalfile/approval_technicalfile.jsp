...
//导航
Navigation(menuCode,"技术文件批准","Approval");
});
</script>
			...
			<div class="panel-body">
				...
				<div class="clearfix"></div>
					...
					<div class=" col-lg-12 col-sm-12 col-xs-12  padding-left-0  padding-right-0 ">
						...
						<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0" style='margin-bottom:0px;'>
				...
				<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-top-8 padding-right-0">
							<textarea class="form-control" id="pfyj" maxlength="150">${erayFns:escapeStr(technicalFile.pfyj)}</textarea>
				</div>
				
				<div class="clearfix"></div>
			
				<label class="col-lg-1 col-sm-2 col-xs-1 text-right padding-left-0 padding-right-0 padding-top-8"  >
				</label>
				<div class="col-lg-11 col-sm-10 col-xs-11 padding-left-8 padding-top-8">
						<div class="pull-left padding-right-10">
				...
				<button onclick="btnSave1()" class="btn btn-primary padding-top-1 padding-bottom-1 " ><div
						class="font-size-12">批准驳回</div>
					<div class="font-size-9">Rejected</div></button>
                  <button onclick="btnSave2()" class="btn btn-primary padding-top-1 padding-bottom-1 " ><div
						class="font-size-12">中止(关闭)</div>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project/technicalfile/approval_technicalfile.js"></script>
</body>
</html>