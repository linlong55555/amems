...
<body class="page-header-fixed">
				...
				<div class="modal-body padding-bottom-0" id="alertModalStoreBody">
					<div class="panel panel-primary">
						<div class="panel-heading  padding-top-3 padding-bottom-1">
							...
							<div class="font-size-9 ">Instruction Over</div>
						</div>
								...
								<div class="margin-top-12 ">
									<div
										...
										<label
											...
											<div class="font-size-9 line-height-18">Over Cause</div></label>
	...
	<script type="text/javascript"
		src="${ctx }/static/js/thjw/project/technicalfile/technicalfile_approval_list.js"></script>
</body>
</html>