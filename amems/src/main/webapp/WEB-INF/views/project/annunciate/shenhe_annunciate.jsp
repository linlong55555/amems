...
//导航
Navigation(menuCode,"审核维护提示","Review");
});
</script>
			...
			<div class="panel-body">
				...
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0" >
					<div class="col-lg-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0">
								...
								<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0 form-group padding-right-0" style="overflow-x:auto;">
					...
					<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0">
							<textarea class="form-control" id="shyj" maxlength="150">${erayFns:escapeStr(annunciate.shyj)}</textarea>
					</div>
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/project/annunciate/shenhe_annunciate.js"></script>
</body>
</html>