...
<script type="text/javascript">
			...
			<div class="panel-body">
					...
					<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control date-picker"  id="zdr" name="zdr" data-date-format="yyyy-mm-dd" type="text" disabled="disabled" value="${erayFns:escapeStr(annunciate.zdr_user.displayName)}" />
						</div>
					</div>
					...
					<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control date-picker"  id="zdbm" name="zdbm" data-date-format="yyyy-mm-dd" type="text" disabled="disabled" value="${annunciate.bm_dprt.dprtname }" />
						</div>
					</div>
			...
			<form id="form">
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0" >
					<div class="col-lg-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0">
								...
								<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0 form-group" style=":auto;">
					...
					<div class=" col-lg-12 col-sm-12 col-xs-12 padding-right-0 padding-left-0 margin-bottom-10 form-group ">
						<label class="col-lg-1 col-sm-2 col-xs-4 text-right  padding-right-0"><div class="font-size-12 line-height-18"><span style="color: red">*</span>主题</div>
						 ...
						 <div class="col-lg-11 col-sm-10 col-xs-8 padding-left-20 padding-left-8 padding-right-0">
							<input maxlength="100" placeholder="长度最大为100" name="zhut" id="zhut" class="form-control date-picker" data-bv-field="zhut" type="text" disabled="disabled" value="${annunciate.zhut }">
					...
					<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0 ">
							<textarea class="form-control" id="shyj" disabled="disabled" maxlength="150" >${erayFns:escapeStr(annunciate.shyj)}</textarea>
					</div>
				...
				<div class="col-lg-12 text-right padding-left-0 padding-right-0">
                    <button onclick="save1()" class="btn btn-primary padding-top-1 padding-bottom-1" ><div
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/project/annunciate/edit_annunciate_tj.js"></script>
</body>
</html>