...
//导航
Navigation(menuCode,"批准维护提示","Approved");
});
</script>
		...
		<div class="page-content">
			...
			<form id="form">
				...
				<label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0 padding-top-8"  >
					...
					<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-top-8 padding-right-0">
						<textarea class="form-control" id="pfyj" maxlength="150">${erayFns:escapeStr(annunciate.pfyj)}</textarea>
					</div>
				...
				<div class="col-lg-12 text-right padding-left-0 padding-right-0">
                    <button class="btn btn-primary padding-top-1 padding-bottom-1" onclick="javascript:agreedMainAnnunciate()"><div
				class="font-size-12">批准通过</div>
					<div class="font-size-9">Approved</div></button>
					     <button class="btn btn-primary padding-top-1 padding-bottom-1" onclick="javascript:rejectedMainAnnunciate()"><div
						class="font-size-12">批准驳回</div>
					<div class="font-size-9">Rejected</div></button>
					<button class="btn btn-primary padding-top-1 padding-bottom-1" onclick="javascript:suspendMainAnnunciate()"><div
						...
						<div class="panel-body padding-top-0 padding-bottom-0">
				           <div class="clearfix"></div>	     
								...
								<div  style="margin-top: 20px">
									...
									<div class="col-xs-12 text-center"  style="margin-top: 20px;" id="pagination">
									</div>
								<!-- end:table -->
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/project/annunciate/pifu_annunciate.js"></script>
</body>
</html>