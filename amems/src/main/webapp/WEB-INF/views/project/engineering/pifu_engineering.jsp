...
<body>
<!-- 隐藏域 -->
<input type="hidden"  id="jg" class="form-control" value="0" />
...
//导航
Navigation(menuCode,"批准EO指令","Approved");
});
</script>
	<div class="page-content">
		<div class="panel panel-primary">
						...
						<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">
							...
							<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
								<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
									...
									<div class="font-size-9 line-height-18">Reinspection</div>
								</label>
								<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
									<input type="text"  maxlength="100" name="cj" id="cj" class="form-control date-picker" value="${erayFns:escapeStr(engineering.cj) }" disabled="disabled" >
								</div>
							</div>
			  ...
			  <div class="panel-body">
			        <div class="col-lg-12 col-md-12 padding-left-0 padding-right-0" >
				       <label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0"  >
						...
						<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0">
							<textarea class="form-control" id="shyj" disabled="disabled" maxlength="150" >${erayFns:escapeStr(engineering.shyj)}</textarea>
					</div>
					...
					<div class="clearfix"></div>
						...
						<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-top-8 padding-right-0">
							<textarea class="form-control" id="pfyj" maxlength="150">${erayFns:escapeStr(engineering.pfyj)}</textarea>
					</div>
		 ...
		 <div class="col-lg-12 text-right padding-left-0 padding-right-0">
                    <button class="btn btn-primary padding-top-1 padding-bottom-1" onclick="javascript:agreedMain1()"><div
										class="font-size-12">批准通过</div>
									<div class="font-size-9">Approved</div></button>
									<button class="btn btn-primary padding-top-1 padding-bottom-1" onclick="javascript:rejectedMain1()"><div
										class="font-size-12">批准驳回</div>
									<div class="font-size-9">Rejected</div></button>
									 <button class="btn btn-primary padding-top-1 padding-bottom-1" onclick="javascript:suspendMain()"><div
