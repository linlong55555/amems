...
//导航
Navigation(menuCode,"审核EO指令","Review");
});
</script>
						...
						<div class="panel-body">
							...
							<div class=" col-lg-12 col-sm-12 col-xs-12 padding-right-0">
								<div class=" col-lg-12 col-sm-12 col-xs-12  padding-left-0 padding-right-0">
									...
									<div class="col-lg-11 col-sm-10 col-xs-8  padding-left-8 padding-right-0 form-group">
										<input maxlength="100" name="tcsj" id="tcsj" class="form-control date-picker" type="text" value="${engineering.tcsj }" disabled="disabled">
									</div>
								</div>
							</div>
							</form>
			  ...
			  <div class="panel-body">
			        <div class="col-lg-12 col-md-12 padding-left-0 padding-right-0" >
				       <label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0 "  >
						...
						<div class="font-size-9 line-height-18">Reviewer</div></label>
						<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0">
							<textarea class="form-control" id="shyj" maxlength="150">${erayFns:escapeStr(engineering.shyj)}</textarea>
					</div>
					...
					<div class="clearfix"></div>
						...
						<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-top-8 padding-right-0" >
							<textarea class="form-control" id="pfyj" disabled="disabled" maxlength="150">${erayFns:escapeStr(engineering.pfyj)}</textarea>
						</div>
						<label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0 padding-top-8"  >
						</label>
						<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-top-8 padding-right-0">
