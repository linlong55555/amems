...
Navigation(menuCode,"修改EO指令","Edit");
	     ...
	     <div class="panel panel-default">
			  ...
			  <div class="panel-body">
					...
					<label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0 padding-top-8"  >
						...
						<div class="font-size-12 line-height-18">审核人　<label style="margin-right: 50px; font-weight:normal">${engineering.shr_user.displayName}</label></div>
					...
					<div class="clearfix"></div>
						...
						　
						<div class="pull-left padding-right-10">
						<div class="font-size-12 line-height-18">批准人　<label style="margin-right: 50px; font-weight:normal">${engineering.pfr_user.displayName}</label></div>
						...
						<div class="panel-body padding-top-0 padding-bottom-0">
			            	<div class="col-lg-12 col-xs-12">
								...
								<div class="overflow-auto">
									...
									<div class="col-xs-12 text-center" id="paginationZjh">
									</div>
								</div>
								<!-- end:table -->
	...
	<!-------ATA章节号对话框 End-------->
	 ...
	 <script type="text/javascript" src="${ctx}/static/js/thjw/project/engineering/edit_engineering_tj.js"></script> 
