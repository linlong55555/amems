	...
	<input type="hidden" id="userId" value="${user.id}" />
		...
		<div class="page-content ">
			...
			<div class="panel-body">
				...
				<div id="melqdDiv" class="text-left col-lg-6 col-sm-6 col-xs-12  padding-left-0 padding-right-0" >
				</div>
				...
				<div class="clearfix"></div>
					...
					<div class="clearfix"></div>
					<div class="col-lg-12 text-right padding-left-0 padding-right-0" style="margin-top: 5px;">
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project/mel/mel_add.js"></script>
</body>
</html>