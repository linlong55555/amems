...
<script type="text/javascript">
	...
	//导航
	Navigation(menuCode,"查看技术指令","View");
	 var zt=$('#zt').val();
	//比较接收是否为当前查看人
	if(zt==1 || zt==2 || zt==3){
		var jsrid=$('#jsrid').val();
	...
	<input type="hidden" name="zt" id="zt" value="${instruction.zt}" >
		...
		<input type="hidden" name="jg" id="jg" value="1" >
		<!-------导航Start--->
		<!-- BEGIN CONTENT -->
			...
			<div class="panel-body">
					...
					<div class=" col-lg-12 col-sm-12 col-xs-12 padding-right-0 padding-left-0 margin-bottom-10 form-group ">
						...
						<label class="col-lg-1 col-sm-2 col-xs-4 text-right  padding-right-0"><div class="font-size-12 line-height-18">执行时限</div>
						 ...
						 <div class="col-lg-11 col-sm-10 col-xs-8 padding-left-20 padding-left-8 padding-right-0">
							...
							<small style="display: none;" class="help-block" data-bv-validator="stringLength" data-bv-for="zxsx" data-bv-result="NOT_VALIDATED">Please enter a value with valid length</small>
						</div>
				</div>	
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0" >	
				...
				<div class="col-lg-12 col-sm-12 col-xs-12  padding-top-10 padding-left-0 padding-right-0">
					...
					<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-top-8 padding-right-0">
							<textarea class="form-control" id="pfyj" disabled="disabled">${erayFns:escapeStr(instruction.pfyj)}</textarea>
					</div>
				...
				<div class="col-lg-12 text-right padding-left-0 padding-right-0">
                   <button class="btn btn-primary padding-top-1 padding-bottom-1" onclick="javascript:printInstruction()" type="button">
	...
	<!-------alert对话框 Start-------->
	<!-- <div class="modal fade" id="alertModalPgd" tabindex="-1" role="dialog"
		aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				
				<div class="modal-body padding-bottom-0" id="alertModalPgdBody">
					<div class="panel-heading  padding-top-3 padding-bottom-1">
						<div class="font-size-16 line-height-18">新增技术评估单</div>
						<div class="font-size-9 ">Add Role</div>
					</div>
					<table class="table table-thin table-bordered table-striped table-hover text-center">
							...
							<th><div class="font-size-12 line-height-18" >文件编号 </div><div class="font-size-9 line-height-18" >State</div></th>
							<th><div class="font-size-12 line-height-18" >评估单号</div><div class="font-size-9 line-height-18" >Derp code</div></th>
							<th><div class="font-size-12 line-height-18" >来源</div><div class="font-size-9 line-height-18" >Derp code</div></th>
							<th><div class="font-size-12 line-height-18" >机型</div><div class="font-size-9 line-height-18" >Derp code</div></th>
							<th><div class="font-size-12 line-height-18" >分类</div><div class="font-size-9 line-height-18" >Derp code</div></th>
							<th><div class="font-size-12 line-height-18" >版本</div><div class="font-size-9 line-height-18" >Derp code</div></th>
							<th ><div class="font-size-12 line-height-18" >文件主题</div><div class="font-size-9 line-height-18" >Derp code</div></th>
							<th ><div class="font-size-12 line-height-18" >生效日期</div><div class="font-size-9 line-height-18" >Derp code</div></th>
							<th ><div class="font-size-12 line-height-18" >评估期限</div><div class="font-size-9 line-height-18" >Assess period</div></th>
							<th ><div class="font-size-12 line-height-18" >评估状态</div><div class="font-size-9 line-height-18" >Derp code</div></th>
							</tr> 
			         		 </thead>
							<tbody id="Pgdlist">
							</tbody>
