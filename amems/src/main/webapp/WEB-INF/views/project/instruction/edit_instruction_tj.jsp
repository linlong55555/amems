...
Navigation(menuCode,"修改技术指令","Edit");
			...
			<div class="panel-body">
					...
					<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<select class="form-control " id="jx" name="jx" disabled="disabled">
								<option value="">please choose</option>
							</select>
						</div>
					</div>
					...
					<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0 "><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class="form-control date-picker" id="fcrq" name="fcrq" data-date-format="yyyy-mm-dd" type="text" disabled="disabled" value="<fmt:formatDate value='${instruction.fcrq}' pattern='yyyy-MM-dd' />" />
						</div>
					</div>
				...
				<form id="form">
						...
						<div class="col-lg-12 col-sm-12 col-xs-12  padding-left-0 padding-right-0">
								...
								<div style='overflow-x:auto' class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0 form-group " style="overflow-x:auto;">
					...
					<div class=" col-lg-12 col-sm-12 col-xs-12  padding-right-0 padding-left-0 margin-bottom-10 form-group ">
						...
						<label class="col-lg-1 col-sm-2 col-xs-4 text-right  padding-right-0"><div class="font-size-12 line-height-18"><span style="color: red">*</span>主题</div>
						 ...
						 <div class="col-lg-11 col-sm-10 col-xs-8 padding-left-20 padding-left-8 padding-right-0">
							<input maxlength="100" placeholder="长度最大为100" name="zhut" id="zhut" class="form-control date-picker" data-bv-field="zhut" type="text" disabled="disabled" value="${erayFns:escapeStr(instruction.zhut) }">
				...
				<div class=" col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0" >
					<div class=" col-lg-12 col-sm-12 col-xs-12  padding-right-0 padding-left-0 margin-bottom-10 form-group ">
						...
						<label class="col-lg-1 col-sm-2 col-xs-4 text-right  padding-right-0"><div class="font-size-12 line-height-18"><span style="color: red">*</span>执行时限</div>
						 ...
						 <div class="col-lg-11 col-sm-10 col-xs-8 padding-left-20 padding-left-8 padding-right-0">
							<input maxlength="100" placeholder="长度最大为100" name="zxsx" id="zxsx" class="form-control date-picker" data-bv-field="zxsx" type="text"  disabled="disabled" value="${erayFns:escapeStr(instruction.zxsx) }">
				...
				<div class="col-lg-12 col-sm-12 col-xs-12  padding-top-10 padding-left-0 padding-right-0">
					...
					<div class=" col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0" >
						...
						<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8  form-group padding-right-0">
							<textarea class="form-control" id="bz" name="bz" placeholder='长度最大为300'   maxlength="300" disabled="disabled">${erayFns:escapeStr(instruction.bz)}</textarea>
						</div>
					</div>
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/project/instruction/edit_instruction_tj.js"></script>
