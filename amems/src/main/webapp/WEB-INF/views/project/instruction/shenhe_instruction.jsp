...
//导航
Navigation(menuCode,"审核技术指令","Review");
});
</script>		
		...
		<div class="page-content ">
			...
			<div class="panel-body">
				...
				<div class="col-lg-12 col-sm-12 col-xs-12  padding-top-10 padding-left-0 padding-right-0">
					...
					<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0">
						<textarea class="form-control" id="shyj" maxlength="150" >${erayFns:escapeStr(instruction.shyj)}</textarea>
					</div>
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/project/instruction/shenhe_instruction.js"></script>
