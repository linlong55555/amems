...
$(function() {
	Navigation(menuCode,"查看定检项目","View");
});
</script>
</head>
<body>
	...
	<div class="page-content">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<form id="form">
					...
					<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10">
						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input type="text" id="pxh" name="pxh" value="${fixedCheckItem.pxh}" class="form-control" value="${pxh}"  />
							</div>
						</div>
						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class="col-lg-2 col-sm-2 col-xs-2 padding-left-8 padding-right-0">
								<input type="text" class="form-control" id="jhgsRs" name="jhgsRs" value="${erayFns:escapeStr(fixedCheckItem.jhgsRs)}" >
							</div>
							<div class="col-lg-1 col-sm-1 col-xs-1 padding-left-0 padding-right-0" style="padding: 6px 0; height: 34px; line-height: 24px;">人x</div>
							<div class="col-lg-2 col-sm-2 col-xs-2 padding-left-0 padding-right-0">
								<input type="text" class="form-control" id="jhgsXss" name="jhgsXss" value="${erayFns:escapeStr(fixedCheckItem.jhgsXss)}" >
							</div>
							<div class="col-lg-1 col-sm-1 col-xs-1 padding-left-0 padding-right-0" 	style="padding: 6px 0; height: 34px; line-height: 24px;">时=</div>
							<div class="col-lg-2 col-sm-2 col-xs-2 padding-left-0 padding-right-0">
				...
				<div class="panel-heading margin-left-16 padding-top-3 margin-bottom-10 " style="border-bottom: 1px solid #ccc;">
					<div class="font-size-16 line-height-18">工作内容&nbsp;&nbsp;<small class="text-muted">(说明：<i class="icon-circle pull-center"></i>&nbsp;表示工作内容发生变化)</small></div>
					<div>Contents</div>
				</div>
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10">
					<!-- start:table -->
