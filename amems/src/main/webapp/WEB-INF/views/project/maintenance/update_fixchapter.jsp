...
<title>修改ATA章节号</title>
<%@ include file="/WEB-INF/views/common_new.jsp"%>
</head>
 <script type="text/javascript" src="${ctx }/static/js/thjw/sys/update_menu.js"></script>  
<body>
						 ...
						 <div class="col-lg-12 col-sm-4 col-xs-12 padding-left-0 padding-right-0"  >
							<div class="col-lg-3 col-sm-4 col-xs-12 padding-left-0 padding-right-0 form-group">
								...
								<div class=" col-xs-8 padding-left-8 padding-right-0 form-group">
									<input name="zjh" type="text"  id="zjh" class="form-control" maxlength="16" readOnly="true"   value="${fc.zjh}">
							     </div>
							</div>
							...
							<div class=" col-lg-3 col-sm-4 col-xs-12  padding-left-0 padding-right-0">
								<label class="col-xs-4 text-right padding-left-0 padding-right-0"><div
										class="font-size-12 line-height-18">中文描述</div>
									<div class="font-size-9 line-height-18">CH.Name</div></label>
								 <div class="col-xs-8 padding-left-8 padding-right-0 form-group" >
									<input name="zwms" type="text" class="form-control "  id="zwms" maxlength="60" value="${fc.zwms}">
								</div>
							</div>
							...
							<div class=" col-lg-3 col-sm-4 col-xs-12  padding-left-0 padding-right-0">
								<label class="col-xs-4 text-right padding-left-0 padding-right-0">
								 ...
								 <div class="col-xs-8 padding-left-8 padding-right-0 form-group" >
									<input name="ywms" type="text" class="form-control "  id="ywms" maxlength="180"  value="${fc.ywms}">
								</div>
							</div>
                         </div>
					     ...
					     <div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 form-group">
					        <div class=" col-lg-12 col-sm-4 col-xs-12  padding-left-0 padding-right-0" >
								...
								<div class="col-xs-11 padding-left-8  padding-right-0 form-group">
									<textarea name="rJcsj"class="form-control"  id="rJcsj" maxlength="180">${fc.rJcsj}</textarea>
								</div>
						    </div>
						</div>
					  </form>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project/maintenance/update_fixchapter.js"></script>
</body>
</html>
