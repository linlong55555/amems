...
var pageParam = '${param.pageParam}';
	...
	<div class="page-content">
		...
		<input type="hidden" id="oldgkbh" name="oldgkbh" value="${jobCard.gdbh }"/>
		...
		<input type="hidden" id="jg" name="jg" value="1"/>
		<!-------导航Start--->
					...
					<div class="panel-body">
				       ...
				       <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
								class="font-size-12 line-height-18">工卡编号</div>
					   ...
					   <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
								class="font-size-12 line-height-18">工卡类型</div>
