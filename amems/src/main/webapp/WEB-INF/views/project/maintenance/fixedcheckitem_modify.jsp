			...
			<div class="panel-body">
				...
				<form id="form">
					...
					<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10">
						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0">
								<div class="font-size-12 line-height-18">新版本</div>
								<div class="font-size-9 line-height-18">Revision</div>
							</label>
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input type="text" id="newbb" name="newbb" value="${erayFns:escapeStr(newbb)}" class="form-control " readonly />
							</div>
						</div>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project/maintenance/fixedcheckitem_modify.js"></script>
