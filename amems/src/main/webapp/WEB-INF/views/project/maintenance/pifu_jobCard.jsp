...
//导航
Navigation(menuCode,"批准工卡","Approved");
});
</script>
<script>
var pageParam = '${param.pageParam}';
	...
	<div class="page-content ">
		...
		<input type="hidden" id="wxfabh" name="wxfabh"value="${erayFns:escapeStr(jobCard.wxfabh) }"/>
			...
			<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0  padding-right-0" >
			        ...
			        <div class="col-lg-12 col-md-12 padding-left-0 padding-right-0" >
						...
						<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-top-8 padding-right-0">
							<textarea class="form-control" id="shyj" disabled="disabled" maxlength="150" >${erayFns:escapeStr(jobCard.shyj)}</textarea>
					</div>
					<div class="clearfix"></div>
						<label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0 padding-top-8"  >
					...
					<div class="clearfix"></div>
						...
						<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-top-8 padding-right-0">
							<textarea class="form-control" id="pfyj" maxlength="150" >${erayFns:escapeStr(jobCard.pfyj)}</textarea>
					</div>
					<div class="clearfix"></div>
						<label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0 padding-top-8"  >
						</label>
