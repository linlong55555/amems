...
<head>
	...
	$(function() {
		Navigation(menuCode,"审核定检项目","Audit");
	});
	</script>
</head>
<body>
				...
				<ul class="page-breadcrumb breadcrumb" >
					...
					<li>
						<div class="pull-left">
							...
							<div class="font-size-9 ">Maintenance Schedule</div>
						</div>
						<i class="icon-angle-right pull-left"></i>
					</li>
					<li>
						<a href="${ctx}/project/fixedcheckitem/main" class="pull-left">
							<div class="font-size-12 line-height-12">定检项目</div>
					...
					<li>
						<a href="#" class="pull-left">
							<div class="font-size-12 line-height-12">审核定检项目</div>
			...
			<div class="panel-body">
				...
				<form id="form">
					...
					<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10">
						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input type="text" id="bb" name="bb" value="${erayFns:escapeStr(fixedCheckItem.bb)}" class="form-control " readonly />
							</div>
						</div>
						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input type="text" id="zwms" name="zwms" value="${erayFns:escapeStr(fixedCheckItem.zwms)}" class="form-control " />
							</div>
						</div>
						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<input type="text" id="pxh" name="pxh" value="${fixedCheckItem.pxh}" class="form-control" value="${pxh}" placeholder='请输入数字...' onkeyup='clearNoNum(this)' />
							</div>
						</div>
						...
						<div class=" col-lg-6 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class=" col-lg-10 col-sm-8 col-xs-8 padding-left-8 padding-right-0 input-group form-group" style='margin-bottom:0px;'>
								<input type="text" maxlength="8" class="form-control " 
									id="jhgsRs" value="${fixedCheckItem.jhgsRs}" onkeyup='clearNoNumTwo(this)'>
						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
								<select class='form-control' id='shzt' name="shzt" >
				...
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10">
					...
					<div style="overflow-x: scroll;">
						<table class="table table-bordered table-striped table-hover text-center table-set" style="min-width: 2400px;">
							<thead>
						   		<tr>
						   			<th style="width:2%">
				 ...
				 <div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10">
					...
					<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0">
							<textarea class="form-control" id="shyj" name="shyj" maxlength="150">${erayFns:escapeStr(fixedCheckItem.shyj)}</textarea>
					</div>
					<div class="clearfix"></div>
				...
				<div class="text-right" style="margin-bottom:10px">
					<button class="btn btn-primary padding-top-1 padding-bottom-1" onclick="javascript:agreedAudit()">
						<div class="font-size-12">审核通过</div>
						<div class="font-size-9">Approved</div>
					</button>
                    <button class="btn btn-primary padding-top-1 padding-bottom-1" onclick="javascript:rejectedAudit()">
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project/maintenance/fixedcheckitem_view.js"></script>
</body>
</html>