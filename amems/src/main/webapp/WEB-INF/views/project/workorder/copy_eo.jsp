						...
						<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0" id="demo3">
							...
							<div class="col-lg-8 col-sm-8 col-xs-8  padding-left-8 padding-right-0 form-group">
								<select class="form-control " id="fjjx" name="fjjx" onchange="changeJx()">
									<c:forEach items="${plansList}" var="plansList">
										<option value="${erayFns:escapeStr(plansList.fjjx)}">${erayFns:escapeStr(plansList.fjjx)}</option>
									</c:forEach>
								</select>									
							</div>
						 </div>
							...
							<div class=" col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0 input-group ">
								<div class='input-group'>
									...
									<span class='input-group-btn'>
									 <a  onclick="openGczl()"  data-toggle="modal"  class="btn btn-primary  " >
					      ...
					      <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0">
								...
								<div class=" col-xs-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0 input-group form-group">
									<div class='input-group'>
										...
										<span class='input-group-btn'>
										 <a href="#" onclick="openChapterWin()"  data-toggle="modal"  class="btn btn-primary  " >
											<i class="icon-search cursor-pointer" ></i>
									     </a>
										</span>
								    </div>
							    ...
							    <td id="zxfl_demo2"></td>
			         		    ...
			         		    <td width="10%">
			         		         <select  id="bjh" name="bjh" class="form-control">
						                <option value="${erayFns:escapeStr(wOActionObj.bjh)}" style="display: none;">${erayFns:escapeStr(wOActionObj.bjh)}</option>
						             </select>
					...
					<div class="col-lg-12  padding-left-2 padding-right-0" style="overflow-x: auto;">
					   <table class="table table-thin table-bordered table-striped table-hover text-center" style="min-width:900px">
						  <thead> <tr>
							 ...
							 <th class="colwidth-13"><div class="font-size-12 line-height-18">文件大小</div>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project/workorder/copy_eo.js"></script>
