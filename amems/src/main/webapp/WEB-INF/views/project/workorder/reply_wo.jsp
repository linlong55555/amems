			...
			<div class="panel panel-default">
				 ...
				 <div class="panel-body">	 	
							...
							<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0 form-group" style="overflow-x: auto;">
								...
								<c:forEach items="${orderSource}" var="orderSource">
									<tr>
							          ...
							          <td class='text-left' title="${orderSource.shzltgh}"><c:out value="${orderSource.shzltgh}" /></td>
				  ...
				  <div class="panel panel-default">
					...
					<div class="panel-body">	 	
					<div class="col-lg-12  padding-left-0 padding-right-0" style="margin-top: 10px;overflow-x:scroll ;">
				        <table class="table table-thin table-bordered table-striped table-hover text-center"style=" min-width: 1700px !important;" >
							...
							<th  colspan="3" width="300" style=" vertical-align:middle">
							...
							<c:forEach items="${woAirMaterial}" var="woAirMaterial" varStatus="status">
								<tr>
							          ...
							          <td class='text-right'><c:out value="${woAirMaterial.sl}" /></td>
							           <td class='text-left'>
									      <c:if test="${woAirMaterial.lx == '4'}"><c:out value="危险品" /></c:if> 
								          <c:if test="${woAirMaterial.lx =='3'}"><c:out value="工具" /></c:if>
								          <c:if test="${woAirMaterial.lx =='1'}"><c:out value="航材" /></c:if> 
								          <c:if test="${woAirMaterial.lx == '2'}"><c:out value="设备" /></c:if>
		       ...
		       <div class="col-lg-12 text-right padding-left-0 padding-right-0" style="margin-bottom: 10px">
                    <button type="button" class="btn btn-primary padding-top-1 padding-bottom-1" onclick="javascript:agreedApprove()">
						<div class="font-size-12">批准通过</div>
						<div class="font-size-9">Approved</div>
					</button>
					<button type="button" class="btn btn-primary padding-top-1 padding-bottom-1" onclick="javascript:overdApprove()">
					    <div class="font-size-12">中止(关闭)</div>
					    <div class="font-size-9">Close</div>
				    </button>
					<button type="button" class="btn btn-primary padding-top-1 padding-bottom-1" onclick="javascript:rejectedApprove()">
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project/workorder/reply_wo.js"></script>
