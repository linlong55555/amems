...
<div class="page-content ">
	...
	<div class="panel panel-primary">
		<div class="panel-heading" id="NavigationBar"></div>
			<div id="nonEditBody"  class="panel-body">
				...
				<div class="panel panel-default">
				 ...
				 <div class="panel-body">	 	
						...
						<div class="col-lg-3 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						 ...
						 <div class="col-lg-3 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group" id="demo5">
							<label class="col-xs-4 text-right padding-left-0 padding-right-0">
						...
						<div class="col-lg-3 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							...
							<div class="col-xs-8 padding-left-8 padding-right-0">
								 ...
								 <option value="" <c:if test="${woResult.zy == ''}">select="select"</c:if>>请选择</option>
								 </select>
						 ...
						 <div class="clearfix"></div>
					      ...
					      <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0" id="non_bc">
								<label class="col-xs-4 text-right padding-left-0 padding-right-0">
								...
								<div class=" col-xs-8 padding-left-8 padding-right-0 input-group form-group">
										<div class='input-group'>
												...
												<span class='input-group-btn'>
												 <a href="#" onclick="openChapterWin()"  data-toggle="modal"  class="btn btn-primary padding-top-4 padding-bottom-4" style="float: left; margin-left: 5px;">
					     ...
					     <div class="col-lg-3 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group" id="non_tj">
							<label class="col-xs-4 text-right padding-left-0 padding-right-0">
								<div class="font-size-12 line-height-18">ATA章节号</div>
								<div class="font-size-9 line-height-18">ATA</div>
							</label>
							<div class=" col-xs-8 padding-left-8 padding-right-0">
								<input type="text"  class="form-control"  value="${erayFns:escapeStr(woResult.zjh)}  ${erayFns:escapeStr(woResult.zwms)}" disabled="disabled"/>
							</div>
						</div>
						 ...
						 <div class="clearfix"></div>
							  ...
							  <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0" id="demo3">
								...
								<div class="col-xs-8  padding-left-8 padding-right-0 form-group">
									...
									<input type="hidden" name="pgjx" id="pgjx" class="form-control " readonly/>									
								</div>
							  </div>
							 ...
							 <div class="clearfix"></div>
							  ...
							  <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0">
								...
								<div class="col-xs-8  padding-left-8 padding-right-0 form-group">
									<label style="margin-right: 20px;font-weight: normal"><input name="isXyjszy" type="radio" value="1"/>是</label> 
					   ...
					   <div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0" id="demo2">
							...
							<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0 form-group" style="overflow-x: auto;">
								...
								<thead>
									<tr>
									    <td width="6%">
											<a href="javascript:openPgd();"  class="dis-able">
					...
					<div class="panel-body">	 	
					<div class="col-lg-12  padding-left-0 padding-right-0" id="zxdxDiv" style="margin-top: 10px;overflow-x:scroll ;">
						...
						<table class="table-set table table-thin table-bordered table-striped table-hover text-center" id="airMaterialTools" style="min-width:1100px">
									...
									<c:forEach items="${woAirMaterial}" var="woAirMaterial">
										<tr>
								          ...
								          <td class='text-center' style='vertical-align:middle'>
								          <input type="text"  name="bz_1" class="form-control"  maxlength="300" placeholder='最大长度不超过300' value="${erayFns:escapeStr(woAirMaterial.bz)}"></td>
										</tr>
									</c:forEach>
									</tbody>	
								</table>
			    ...
			    <div class="panel panel-default">
					...
					<div class="col-lg-12 col-md-12 padding-left-2 padding-right-0">
					   <table class="table table-thin table-bordered table-striped table-hover text-center" >
						  <thead> <tr>
						     <th class="colwidth-3 dis-play"><div class="font-size-12 line-height-18 " >操作</div>
							...
							<c:forEach items="${woJobEnclosure}" var="woJobEnclosure">
								<tr>
								     <td class="dis-play">
							          ...
							          <a href='javascript:void(0);' class='dis-able' onclick="downloadfile('${woJobEnclosure.id}')">
		...
		<div class="modal-dialog" style="width:65%">
			<div class="modal-content">
				<div class="modal-body padding-bottom-0" id="alertModalUserBody">
						...
						<div class="panel-body padding-top-0 padding-bottom-0">
                           <div class="col-lg-12 pull-right padding-right-0">
						      
						          <div class="col-lg-4 padding-left-0 padding-top-10">
						          ...
						          <div class="col-lg-4 padding-left-0 padding-top-10">
					            	    <label class="col-xs-2 text-right padding-left-0 padding-right-2">
											<div class="font-size-12 line-height-18">专业</div>
											<div class="font-size-9 line-height-18">Skill</div>
										</label>
				            	...
				            	<div class="col-lg-4 padding-right-0 padding-left-0   padding-top-10 pull-right">
								    <div class="col-lg-9 pull-left padding-right-0 padding-left-0 ">
									  <input type="text" placeholder="编号/主题" id="keyword_search2" class="form-control ">
								    </div>
			                      <div class="col-lg-3 pull-right padding-right-0">   
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project/workorder/edit_non.js"></script>
