		...
		<div class="panel-heading" id="NavigationBar"></div>
			<div class="panel-body">
					 ...
					 <div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">
						 ...
						 <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0">
							 <label class="col-xs-4 text-right padding-left-0 padding-right-0">
							   ...
							   <div class="col-xs-8  padding-left-8 padding-right-0 form-group" id="chonse">
			 		     ...
			 		     <div class="col-lg-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 ">
							...
							<div class="col-lg-3 col-sm-6 col-xs-12 padding-left-0 padding-right-0 ">
							 ...
							 <div id="div_css2"></div>
							  ...
							  <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 text-right">
								<label class="col-xs-4 text-right padding-left-0 padding-right-0">
							...
							<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0 form-group" style="overflow-x: auto;">
								...
								<c:forEach items="${orderSource}" var="orderSource">
									<tr>
							          ...
							          <td class='text-center'><c:out value="${fn:substring(orderSource.sxrq, 0, 10)}" /></td>
					...
					<div class="col-lg-12  padding-left-0 padding-right-0" style="margin-top: 10px;overflow-x: auto ;">
				        <table class="table table-thin table-bordered table-striped table-hover text-center" style=" min-width: 1700px !important;" >
							...
							<tr   id="zxdxtr">
			         		    ...
			         		    <td id="th_8">
			         		       <input type="text" class="form-control" name="jssj" id="jssj" >
			         		    </td>
			         		    <td id="th_7">
			         		       <input type="text" class="form-control" name="qlxh" id="qlxh">
			         		    </td>
			         		    <td id="th_3">
			         		       <input type="text" class="form-control" name="jcsj" id="jcsj">
			         		    </td>
			         		    <td id="th_4">
			         		       <input type="text" class="form-control" name="jcxh" id="jcxh">
			         		    </td>
			         		 </tr>
				   			</table>
					      ...
					      <table class="table table-thin table-bordered table-striped table-hover text-center" style="min-width:900px">
							...
							<c:forEach items="${wOJobContent}" var="wOJobContent" varStatus="status">
								<tr> 
							          ...
							          <td class='text-left' style='vertical-align:middle'><c:out value="${erayFns:escapeStr(wOJobContent.gzz)}" /></td>
							...
							<table class="table-set table table-thin table-bordered table-striped table-hover text-center" style="min-width:900px" >
								...
								<c:forEach items="${nonWOCardd}" var="nonWOCardd" varStatus="status">
									<tr>
							          ...
							          <td class='text-left' title='${nonWOCardd.zhut}'><c:out value="${nonWOCardd.zhut}" /></td> 
									</tr>
								</c:forEach>
								</tbody>	
							</table>
					  ...
					  <div class="col-lg-12  padding-left-2 padding-right-0" style="overflow-x: auto;">
						 <table class="table-set table table-thin table-bordered table-striped table-hover text-center" style="min-width:900px">
							...
							<c:forEach items="${woAirMaterial}" var="woAirMaterial" varStatus="status">
								<tr>
									  <td class='text-center'><c:out value="${status.index+1}" /></td>
							          <td class='text-left' title='${erayFns:escapeStr(woAirMaterial.refJhly)}'><c:out value="${erayFns:escapeStr(woAirMaterial.refJhly)}" /></td>
							          <td class='text-left' title='${erayFns:escapeStr(woAirMaterial.ywmc)}'><c:out value="${erayFns:escapeStr(woAirMaterial.ywmc)}" /></td>
							          <td class='text-left' title='${erayFns:escapeStr(woAirMaterial.zwmc)}'><c:out value="${erayFns:escapeStr(woAirMaterial.zwmc)}" /></td>
							          <td class='text-left' title='${erayFns:escapeStr(woAirMaterial.jh)}'><c:out value="${erayFns:escapeStr(woAirMaterial.jh)}" /></td>
							          <td class='text-right'>
							          ...
							          <td class='text-left' title='${erayFns:escapeStr(woAirMaterial.bz)}'><c:out value="${erayFns:escapeStr(woAirMaterial.bz)}" /></td>
								</tr>
							</c:forEach>
							</tbody>	
						</table>
						  ...
						  <tbody>
							<c:forEach items="${woJobEnclosure}" var="woJobEnclosure">
								<tr>
							     ...
							     <td class='text-left'><c:out value="${erayFns:escapeStr(woJobEnclosure.czr_user.displayName)}" /></td>
							      <td class='text-center'>
					...
					<div class="panel-body">	
					  <div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10">
						 <label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0 padding-top-8" >
						  ...
						  <div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-top-8 margin-bottom-10 form-group padding-right-0">
							 <textarea class="form-control" id="shyj" name="shyj" maxlength="150" >${woResult.shyj}</textarea>
					  ...
					  <div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10">
						 <label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0 padding-top-8" >
						  ...
						  <div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-top-8 margin-bottom-10 padding-right-0">
							 <textarea class="form-control" id="pfyj" name="pfyj" maxlength="150" disabled="disabled"></textarea>
						      <div class="pull-left padding-right-10">
		       ...
		       <div class="col-lg-12 text-right padding-left-0 padding-right-0" style="margin-bottom: 10px">
                   <button type="button" class="btn btn-primary padding-top-1 padding-bottom-1" onclick="javascript:agreedAudit()">
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project/workorder/audit_wo.js"></script>
