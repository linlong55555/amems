...
<input type="hidden" id="tzslx" value=2 />
	<!-- BEGIN HEADER -->
               ...
               <!-- 搜索框start -->
				<div class=" pull-right padding-left-0 padding-right-0">
					<div class=" pull-left padding-left-0 padding-right-0" style="width: 250px;">
						<input title="修订MEL编号/修订主题/修订内容/评估单号/修订人/制单人" placeholder="修订MEL编号/修订主题/修订内容/评估单号/修订人/制单人" id="keyword_search" class="form-control " type="text">
					</div>
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/project/revisionNoticeBook/revisionNoticeBook_mel_main.js"></script>
</body>
</html>