...
<head>
	...
	<input type="hidden" id="gdzt"  name="gdzt" value="${revisionNoticeBook.zt }" />
		<!-------导航Start--->
		<!-- BEGIN CONTENT -->
			...
			<div class="panel-body">
					...
					<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input type="text" id="bb"  name="bb" class="form-control datepicker " style="width: 100%" disabled="disabled" maxlength="5" value="${erayFns:escapeStr(revisionNoticeBook.bb) }" />
						</div>
					</div>
					...
					<div class=" col-lg-12 col-sm-12 col-xs-12 padding-right-0 padding-left-0 margin-bottom-10 form-group ">
						...
						<label class="col-lg-1 col-sm-2 col-xs-4 text-right  padding-right-0"><div class="font-size-12 line-height-18"><span style="color: red">*</span>修订主题</div>
						 ...
						 <div class="col-lg-11 col-sm-10 col-xs-8 padding-left-20 padding-left-8 padding-right-0">
							<input maxlength="100" placeholder="长度最大为100" name="xdzt" id="xdzt" class="form-control date-picker" data-bv-field="xdzt" type="text" value="${revisionNoticeBook.xdzt}" disabled="disabled">
				...
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">	
					...
					<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 form-group padding-right-0">
							<textarea class="form-control" id="bz" name="bz" maxlength="300" disabled="disabled" >${erayFns:escapeStr(revisionNoticeBook.bz)}</textarea>
					</div>
				</div>	
				<div class="col-lg-12 col-sm-12 col-xs-12  padding-left-0 padding-right-0">
								<label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0 form-group">
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project/revisionNoticeBook/edit_revisionNoticeBook.js"></script>
