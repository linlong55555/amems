			...
			<div class="panel-body">
				...
				<div class="col-lg-12 col-sm-12 col-xs-12  padding-left-0 padding-right-0">
					...
					<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-right-0">
							<textarea class="form-control" id="shyj" disabled="disabled" maxlength="150" >${erayFns:escapeStr(revisionNoticeBook.shyj)}</textarea>
					</div>
					...
					<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-top-8 padding-right-0">
							<textarea class="form-control" id="pfyj" maxlength="150">${erayFns:escapeStr(revisionNoticeBook.pfyj)}</textarea>
					</div>
...
<script type="text/javascript">
Navigation(menuCode,"批准修订通知书","Approval");
</script>	
