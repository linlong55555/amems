		...
		<div class="page-content">
			...
			<div class="panel-body">
					...
					<input type="hidden" id="tzslx" value="${revisionNoticeBook.tzslx}" />
					 <input id="jg" type="hidden" value="0" />
				    ...
				    <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
						    <input type="text" id="jx"  name="jx"  maxlength="30" class="form-control" disabled="disabled" value="${revisionNoticeBook.jx}" >
						</div>
					</div>
			...
			<form id="form" >
				...
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">
					...
					<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 form-group padding-right-0">
							<textarea class="form-control" id="xdnr" name="xdnr"  disabled="disabled"   maxlength="300">${erayFns:escapeStr(revisionNoticeBook.xdnr)}</textarea>
					</div>
				</div>
				...
				<div class="col-lg-12 col-sm-12 col-xs-12  padding-left-0 padding-right-0">
					...
					<textarea class="form-control" id="shyj" maxlength="150" >${erayFns:escapeStr(revisionNoticeBook.shyj)}</textarea>
					</div>
					...
					<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 padding-top-8 padding-right-0">
							<textarea class="form-control" id="pfyj" disabled="disabled" maxlength="150" >${erayFns:escapeStr(revisionNoticeBook.pfyj)}</textarea>
					</div>
...
<script type="text/javascript">
Navigation(menuCode,"审核修订通知书","Review");
</script>
