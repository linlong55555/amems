...
<input type="hidden" id="tzslx" value=1 />
	<!-- BEGIN HEADER -->
	...
	<!-- BEGIN CONTAINER -->
		...
		<div class="page-content">
			<div class="panel panel-primary">
				...
				<a permissioncode='project:revisionnoticebook:add,project:revisionnoticebook:card_add,project:revisionnoticebook:mel_add' href="#" onclick="add()" data-toggle="modal"
               ...
               <!-- 搜索框start -->
				<div class=" pull-right padding-left-0 padding-right-0">
					<div class=" pull-left padding-left-0 padding-right-0" style="width: 250px;">
						<input title="修订维修方案编号/修订主题/修订内容/评估单号/修订人/制单人" placeholder="修订维修方案编号/修订主题/修订内容/评估单号/修订人/制单人" id="keyword_search" class="form-control " type="text">
					</div>
							...
							<tr>
									...
									<a href="#" class="margin-left-5" onclick="performSelectClear('list')" ><img src="${ctx}/static/assets/img/d2.png" title="不全选" /></a>
										...
										<th class="sorting fixed-column colwidth-10" onclick="orderBy('jszlh')"
											...
											<div class="important">
											<div
												class="font-size-12 line-height-18">修订维修方案编号</div>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body padding-top-0 padding-bottom-0" >
			            	...
			            	<div class="col-xs-12 col-sm-12  padding-left-0 margin-top-10 padding-right-0 ">
								...
								<div class="font-size-12">修订维修方案编号</div>
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/project/revisionNoticeBook/revisionNoticeBook.js"></script>
</body>
</html>