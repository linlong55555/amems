...
<body>
	...
	<div class="page-content">
		...
		<ul class="page-breadcrumb breadcrumb"
			...
			<li >
				<i class="icon-home pull-left" style="margin-top: 7px; font-size: 16px;"></i>
			...
			<li >
				<a href="${ctx}/project/revisionNoticeBook/main" class="pull-left">
					<div class="font-size-12 line-height-18">修订通知书</div>
					<div class="font-size-9 ">Amendment Notice</div>
				</a> 
				<i class="fa fa-angle-right pull-left" style="margin-top: 7px; font-size: 16px;"></i>
			</li>
			<li >
				<a href="javascript:void(0)" class="pull-left">
					<div class="font-size-12 line-height-18">指定结束修订通知书</div>
		...
		<div class="panel panel-primary">
			<div class="panel-heading  padding-top-3 padding-bottom-1">
				<div class="font-size-16 line-height-18">指定结束修订通知书</div>
				<div class="font-size-9 ">Assign end</div>
			</div>
			<div class="panel-body">
				<label class="col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0 ">
					<div class="font-size-12 line-height-18">修订结束原因</div>
					<div class="font-size-9 line-height-18">Cause</div>
				</label>
				<div class="col-lg-10 col-sm-9 col-xs-8 padding-left-8">
					<textarea class="form-control" id="zdjsyy">${erayFns:escapeStr(revisionNoticeBook.zdjsyy)}</textarea>
				</div>
				 <input type="hidden" id="id" value="${revisionNoticeBook.id}"/>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project/revisionNoticeBook/end_revisionNoticeBook.js"></script>
</body>
</html>