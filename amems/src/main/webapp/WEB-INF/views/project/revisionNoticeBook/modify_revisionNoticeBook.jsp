	...
	<body class="page-header-fixed">
		...
		<div class="page-content">
			...
			<div class="panel-body">
					...
					<input type="hidden" name="revisionNoticeBookJx" id=revisionNoticeBookJx value="${erayFns:escapeStr(revisionNoticeBook.jx)}" />
					<input type="hidden" name="revisionNoticeBookXdrid" id=revisionNoticeBookXdrid value="${revisionNoticeBook.xdrid}" />
				    <form id="form" >
				    
				    <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
								class="font-size-12 line-height-18">修订通知书编号</div>
				   ...
				   <%--  <div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
								class="font-size-12 line-height-18"><span style="color: red">*</span>通知书类型</div>
							<div class="font-size-9 line-height-18">Notice Type</div></label>
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<select class='form-control' id='tzslx' name="tzslx" >
									<option value=''>please choose</option>
									<c:forEach items="${revisionNoticeBookTypeEnum}" var="item">
									  <option value="${item.id}" <c:if test="${revisionNoticeBook.tzslx == item.id }">selected="true"</c:if>
									  >${item.name}</option>
									</c:forEach>
						    </select>
						</div>
					...
					<div class=" col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group" >
						<label  class="col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0"><div
							...
							<div class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input type="text" id="bb"  name="bb" class="form-control datepicker " style="width: 100%" maxlength="5" value="${erayFns:escapeStr(revisionNoticeBook.bb) }" />
						</div>
					</div>
					...
					<div class=" col-lg-12 col-sm-12 col-xs-12 padding-right-0 padding-left-0 margin-bottom-10 form-group ">
						...
						<label class="col-lg-1 col-sm-2 col-xs-4 text-right  padding-right-0"><div class="font-size-12 line-height-18"><span style="color: red">*</span>修订主题</div>
						 ...
						 <div class="col-lg-11 col-sm-10 col-xs-8 padding-left-20 padding-left-8 padding-right-0">
							<input maxlength="100" placeholder="长度最大为100" name="xdzt" id="xdzt" class="form-control date-picker" data-bv-field="xdzt" type="text" value="${erayFns:escapeStr(revisionNoticeBook.xdzt)}">
				...
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">
					...
					<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 form-group padding-right-0">
						<textarea class="form-control" id="xdnr" name="xdnr" placeholder='长度最大为300'   maxlength="300">${erayFns:escapeStr(revisionNoticeBook.xdnr)}</textarea>
					</div>
				</div>
				...
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">	
					...
					<div class="col-lg-11 col-sm-10 col-xs-8 padding-left-8 form-group padding-right-0">
							<textarea class="form-control" id="bz" name="bz" placeholder='长度最大为300'   maxlength="300">${erayFns:escapeStr(revisionNoticeBook.bz)}</textarea>
					</div>
				</div>
