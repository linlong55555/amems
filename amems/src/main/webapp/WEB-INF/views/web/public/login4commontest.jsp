...
<link href="${ctx}/static/login/common/css/login.css" rel="stylesheet"
	type="text/css" />
...
<script>
	var basePath = '${ctx}';
	var customer = "common";//用户，用于layout页面展示logo
	var forTest = 'test';
</script>
</head>
<body>
		...
		<div class="loginbox box-shadow-1">
			<form action="">
				<ul>
					...
					<li>
						<input id="loginbtn" name="loginbtn" type="button" class="loginbtn login-input-field" value="登录 Login" style="background: #3e65bc;"/>
	...
	<div class="clear"></div> 
	<div class="loginbm">©航空维修工程管理系统 2018</div> 
