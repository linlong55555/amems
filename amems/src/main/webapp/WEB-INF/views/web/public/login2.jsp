...
<title>欢迎登录易瑞航空维修工程管理系统</title>
</head>
<body
	style="background-color:#00489d!important; background:url(${ctx}/static/images/bg.png)no-repeat center -160px;">
	<div id="mainBody">
