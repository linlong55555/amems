...
<body>
	...
	<input type="hidden" id="wc_type" value="2" />
			...
			<div class="panel-body padding-bottom-0">
				<!-- <div class="col-xs-2 padding-left-5">
					<button class="btn btn-primary padding-top-1 padding-bottom-1 row-height checkPermission"
						permissioncode='project:shapestructurerepair:main1:01'
				...
				<!-- <div class=" col-lg-9 col-md-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0 form-group  ">
					<a href="javascript:add();" permissioncode='project:shapestructurerepair:main1:01'  class="btn btn-primary padding-top-1 padding-bottom-1 pull-left  checkPermission">
						<div class="font-size-12">新增</div>
						<div class="font-size-9">Add</div>
					</a> 
					<a href="javascript:add();" permissioncode='project:shapestructurerepair:main1:01'  class="btn btn-primary padding-top-1 padding-bottom-1 pull-left  checkPermission">
				...
				<div class=" col-lg-7 col-md-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0 form-group  ">
					...
					<a href="javascript:exportExcel();" type="button" class="btn btn-primary padding-top-1 margin-left-10 padding-bottom-1 pull-left checkPermission"  permissioncode='project:shapestructurerepair:main1:03'>
				...
				<!-- <div class=" pull-right padding-left-0 padding-right-0">
					...
					<div class="col-sm-5 col-lg-5 pull-left padding-left-0 padding-right-0"
						style="margin-left: 20px; width: 200px">
						<input type="text" class="form-control " id="keyword_search"
							placeholder="飞机注册号/章节号" />
					</div>
				...
				<div
					...
					style="overflow-x: auto" id="structrucRepair_table">
	...
	<input type="hidden" id="sjlx" value="2"/>
	...
	<%@ include file="/WEB-INF/views/open_win/planePosition_search.jsp"%>
	...
	<script type="text/javascript" src="${ctx }/static/js/thjw/project2/shapeStructureRepair/repairMain.js"></script>
