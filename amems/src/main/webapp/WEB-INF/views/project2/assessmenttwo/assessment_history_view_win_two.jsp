...
<div id="assessment_history_alert_Modal" style='display: none;padding:0px;'>
	<!-- 表格 -->
				...
				<thead>
					<tr>
						<th class="colwidth-15">
						   <div class="font-size-12 line-height-12">技术评估单编号</div>
				           <div class="font-size-9 line-height-12">Evaluation No.</div>
					   	</th>
					   	<th class="colwidth-5">
...
<!--  弹出框结束-->
<script type="text/javascript" src="${ctx}/static/js/thjw/project2/assessmenttwo/assessment_history_view_win_two.js"></script>