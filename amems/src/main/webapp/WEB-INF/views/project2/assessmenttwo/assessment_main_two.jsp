...
<!--日志END  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/project2/assessmenttwo/assessment_main_two.js"></script><!--当前界面js  -->
<%@ include file="/WEB-INF/views/project2/assessmenttwo/assessment_open_two.jsp" %> <!--新增编辑评估单界面  -->
<%@ include file="/WEB-INF/views/project2/assessmenttwo/assessment_history_view_win_two.jsp"%><!------历史版本对话框 -------->
