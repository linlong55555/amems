											...
											<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
												...
												<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 label-input-div">
													<label class='margin-top-8 ' style='width:100%;'>
														<a href='javascript:void(0);'  onclick="Assessment_Open_Modal.onclikfile()" id="ywjurl" style="word-wrap:break-word" ></a>
													</label>
												</div>
											</div>
											<div class="clearfix"></div>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project2/assessmenttwo/assessment_open_find_two.js"></script><!--当前页面JS  -->
