...
<!-- 											<input type="text" id="jjcd" class="noteditable form-control padding-left-3 padding-right-3" maxlength="15"/> -->
	     					...
	     					<!-- 参考文件列表 -->  
   							...
   							<%@ include file="/WEB-INF/views/project2/assessment/reference_list_view.jsp"%>
     						<!-- 参考文件 -->
			     			<div class="clearfix"></div>
			     			<div class="col-xs-12 col-sm-12  padding-left-0 padding-right-0 form-group">
								<label class="col-lg-1 col-md-1 col-sm-2 col-xs-3 text-right padding-left-0 padding-right-0">
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project2/assessment/assessment_add.js"></script><!--新增评估单弹窗的js  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/project2/assessment/assessment_update.js"></script><!--新增评估单弹窗的js  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/project2/assessment/assessment_revision.js"></script><!--改版评估单弹窗的js  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/project2/assessment/assessment_update_assessor.js"></script><!--修改评估人弹窗的js  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/project2/assessment/audit/assessment_audit.js"></script><!--审核评估单弹窗的js  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/project2/assessment/approval/assessment_approval.js"></script><!--批准评估单弹窗的js  -->
<%@ include file="/WEB-INF/views/project2/assessment/selectAssociatedEvaluation.jsp"%><!-- -选择评估单列表 -->
