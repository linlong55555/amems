	...
	<input type="hidden" id="djzt"  />
		<div class="panel panel-primary">
			...
			<div class="panel-body">
			  <div  class='searchContent' >
				...
				<div class=" col-lg-3 col-md-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0  form-group">
					<a  href="javascript:batchApproveWin(true);"  class="btn btn-primary padding-top-1 padding-bottom-1 pull-left row-height checkPermission" permissioncode='project2:assessment:approval:main:02'>
			...
			<div class="col-lg-12 col-md-12 padding-left-0 padding-right-0 margin-top-0 table-height" c-height="55%" id="tableId" style="overflow-x: auto;">
						<table  id="approvalTable" class="table table-thin table-bordered table-striped table-hover table-set">
							<thead>
								<tr>
								
									<th class="viewCol fixed-column colwidth-7 selectAllImg">
										<a href="#" onclick="performSelectAll('JobCardlistlist')" ><img src="${ctx}/static/assets/img/d1.png" alt="全选" /></a>
										<a href="#" class="margin-left-5" onclick="performSelectClear('JobCardlistlist')" ><img src="${ctx}/static/assets/img/d2.png" alt="不全选" /></a>
									</th>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project2/assessment/approval/assessment_approval_main.js"></script><!--当前界面js  -->
