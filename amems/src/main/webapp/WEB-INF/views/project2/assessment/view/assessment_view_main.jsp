		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
			  <div  class='searchContent' >
				...
				<div class=" col-lg-3 col-md-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0  form-group">
					<a href="#" onclick="exportExcel()"  class="btn btn-primary padding-top-1 margin-left-0 padding-bottom-1 pull-left checkPermission" permissioncode='project2:assessment:view:main:02' >
			...
			<div class='table_pagination'>
				...
				<div class="col-lg-12 col-md-12 padding-left-0 padding-right-0 margin-top-0 table-height" c-height="55%" id="tableId" style="overflow-x: auto;">
						<table  id="viewTable" class="table table-thin table-bordered table-striped table-hover table-set">
							<thead>
								<tr>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/project2/assessment/view/assessment_view_main.js"></script><!--当前界面js  -->
