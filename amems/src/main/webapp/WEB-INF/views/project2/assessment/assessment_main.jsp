		...
		<div class="panel panel-primary">
			  ...
			  <div  class='searchContent row-height' >
				<div class='margin-top-0'>
					<div class=" col-lg-3 col-md-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0  form-group">
						<a href="javascript:Assessment_Open_Modal.show(1);"  class="btn btn-primary padding-top-1 padding-bottom-1 pull-left  checkPermission" permissioncode='project2:assessment:main:01'>
				...
				<div class="col-lg-12 col-sm-12 col-xs-12 triangle  padding-top-10 margin-bottom-10 display-none border-cccccc margin-top-0" id="divSearch">
					...
					<div class="col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-8 ">
						...
						<div id="pgridDiv" class="col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0">
							<input class='form-control' id="pgrids" type="text" value="${user.username}">
						
							<!-- <select class='form-control' id="pgrid">
						    </select> -->
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-8 ">
			...
			<div class='table_pagination'>
				<div class="col-lg-12 col-md-12 padding-left-0 padding-right-0 margin-top-0 table-height" c-height="55%" id="tableId" style="overflow-x: auto;">
						<table  id="assessmentTable" class="table table-thin table-bordered table-striped table-hover table-set">
							<thead>
								<tr>
									...
									<th class="downward cursor-pointer colwidth-13"   onclick="vieworhideWorkContentAll()" name="th_return">
...
<!--日志END  -->
<script type="text/javascript" src="${ctx}/static/js/thjw/project2/assessment/assessment_main.js"></script><!--当前界面js  -->
<%@ include file="/WEB-INF/views/project2/assessment/assessment_open.jsp" %> <!--新增编辑评估单界面  -->
...
<%-- <%@ include file="/WEB-INF/views/open_win/search_technicalfile.jsp"%><!--适航性资料弹窗--> --%>
