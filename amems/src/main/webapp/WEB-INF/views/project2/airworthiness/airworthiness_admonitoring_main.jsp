...
<body class="page-header-fixed">
			...
			<!-- 搜索框 -->
			    ...
			    <!-- 上传按钮  -->
				   <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<a href="javascript:exportExcel();" type="button" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission" permissioncode='project2:airworthiness:monitoring:main:02'>
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/project2/airworthiness/airworthiness_admonitoring_main.js"></script>
	<%@ include file="/WEB-INF/views/project2/airworthiness/airworthiness_admonitoring_close.jsp"%>
