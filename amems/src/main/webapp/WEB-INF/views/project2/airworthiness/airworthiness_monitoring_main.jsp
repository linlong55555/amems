...
<body class="page-header-fixed">
	...
	<div class="page-content">
		<div class="panel panel-primary">
			...
			<!-- 搜索框 -->
			    ...
			    <!-- 上传按钮  -->
				   <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						<span class="col-lg-4 col-md-4 col-sm-4 col-xs-2 text-right padding-left-0 padding-right-0">
						<a href="javascript:exportExcel();" type="button" class="btn btn-primary padding-top-1 margin-left-10 padding-bottom-1 pull-left ">
				...
				<div class="col-xs-12 col-sm-6 col-lg-2 col-md-3 padding-left-0 padding-right-0 margin-bottom-10 ">
						<span class="pull-left col-xs-4 col-sm-4 text-right padding-left-0 padding-right-0">
							<div class="font-size-12">飞机注册号</div>
							<div class="font-size-9">A/C REG</div>
						</span>
						<div class="col-xs-8 col-sm-8 padding-left-8 padding-right-0">
							<select class="form-control" id="fjzch">
								<option value="">显示全部 All</option>
									<c:forEach items="${fjList }" var="type">
										<option value="${type.fjzch}">${type.fjzch}</option>
									</c:forEach>
							</select>
						</div>
					</div>	 
						...
						<table  class="table table-thin table-bordered table-striped table-hover table-set" id="airworthiness_list_table">
							<thead>
								<tr>	
									...
									<th class="colwidth-7 sorting" onclick="orderBy('SXRQ')" id="SXRQ_order">
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/project2/airworthiness/airworthiness_monitoring_main.js"></script>
