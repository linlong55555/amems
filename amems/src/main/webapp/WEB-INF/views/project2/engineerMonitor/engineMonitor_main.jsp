		...
		$(this).keydown(function(event) {
			...
			if(e.keyCode==13){
				...
				if(formatUndefine(winId) != ""){
					...
					$('#engineHealthMonitorSearch').trigger('click');//调用主列表页查询
				}
			}
		});
	});
...
<body class="page-header-fixed">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body padding-bottom-0">
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">
					<div class="pull-right">
				        ...
				        <div class="padding-left-0 padding-right-0 margin-bottom-10 form-group pull-right">   
				          	<button id="engineHealthMonitorSearch" type="button" class="btn btn-primary padding-top-1 padding-bottom-1" onclick="engine_health_monitor.load();">
				...
				<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">
					...
					<div class="col-lg-6 col-sm-12 col-xs-12 padding-left-8 padding-right-8">
						<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0" style="height:400px" id="engine_health_monitor_chartSecond">
						</div>
						<!-- chart区  end -->						
					</div>
					<div class="col-lg-6 col-sm-12 col-xs-12 padding-left-8 padding-right-8">
						<!-- chart区 start -->
						<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0" style="height:400px" id="engine_health_monitor_chartThree">
						</div>
						<!-- chart区  end -->
					</div>
					<div class="col-lg-6 col-sm-12 col-xs-12 padding-left-8 padding-right-8">
						<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0" style="height:400px" id="engine_health_monitor_chartFour">
						</div>
						<!-- chart区  end -->						
					</div>
				</div>
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/project2/engineerMonitor/engineMonitor_main.js"></script>
</body>
</html>