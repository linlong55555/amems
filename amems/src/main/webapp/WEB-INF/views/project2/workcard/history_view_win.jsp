...
<div id="work_card_history_alert_Modal" style='display: none;padding:0px;'>
	<!-- 表格 -->
...
<!--  弹出框结束-->
<script type="text/javascript" src="${ctx}/static/js/thjw/project2/workcard/history_view_win.js"></script>