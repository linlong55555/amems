...
<body class="page-header-fixed">
    ...
    <div class="panel panel-primary left_first_content" style="height:50%">
			...
			<div class="panel-heading">
				<div class="font-size-12 line-height-12">维修方案批准</div>
				<div class="font-size-9 line-height-9">Maintenance Program Approval</div>
			</div>
    ...
    <div class='col-sm-9 col-xs-12 padding-right-0 padding-left-0' id="right_div">
    	<div style="position:absolute;left:-8px;" id="maintenance_toggle_div">
			<i id="maintenance_toggle_btn" class="icon-caret-left cursor-pointer" style="font-size: 22px;" onclick="maintenancePlanApproval.toggleMaintenance(this)"></i>
		</div>
	...
	<!-- 维修方案批准模态框Start -->
	<div class="modal fade in modal-new" id="approvalModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop='static' data-keyboard= false>
			...
			<div class="modal-content">
				...
				<div class="modal-header modal-header-new" >
	         		<h4 class="modal-title" >
	             		<div id="batchReviewHead" class='pull-left'>
	                 		<div class="font-size-14 ">维修方案批准</div>
							<div class="font-size-12">Maintenance Program Approval</div>
						</div>
						...
						<div class="input-group-border">
			            	<div class="col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">
				            	...
				            	<div class="col-lg-6 col-xs-12 col-sm-12  padding-left-0 padding-right-0 form-group">
									...
									<div class="col-lg-10 col-md-11 col-sm-10 col-xs-9 padding-leftright-8">
										<input class="form-control" id="maintenance_schedule_modal_bb" type="text" disabled="disabled">
									</div>
								</div>
				            	<div class="clearfix"></div>
				...
				<div class="modal-footer">
					...
					<span class="input-group-addon modalfooterbtn">
				    	<button type="button" onclick="maintenancePlanApproval.agree()" class="btn btn-primary padding-top-1 padding-bottom-1">
							<div class="font-size-12">批准通过</div>
							<div class="font-size-9">Approved</div>
						</button>
				    	<button type="button" onclick="maintenancePlanApproval.reject()" class="btn btn-primary padding-top-1 padding-bottom-1">
	...
	<!-- 维修方案批准模态框End -->
<script type="text/javascript" src="${ctx}/static/js/thjw/project2/maintenance/maintenance_plan_approval.js"></script>
</body>
</html>
