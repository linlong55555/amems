...
<div class="modal fade" id="myModalTwo" tabindex="-1" role="dialog"  aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static"
>
              	...
              	<div class="input-group-border">
                    <div class="col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group" >
							...
							<div class="col-sm-8 col-xs-9 padding-leftright-8 label-input-div" >
								<label class='margin-right-5 label-input' ><input type='radio' name='radio3' checked/>&nbsp;A</label>
								<label class='label-input'><input type='radio' name='radio3'/>&nbsp;B</label>
							</div>
						</div>
						 <div class="col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							<label class="col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
						...
						<div class="col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							...
							<div class="col-sm-8 col-xs-9 padding-leftright-8" id='multipleselect-div' style='height:34px;'>
								<select id="searchstatustwo" class='form-control'  multiple="multiple" >
							    <option>1</option>
								<option>2</option>
								<option>3</option>
								<option>4</option>
