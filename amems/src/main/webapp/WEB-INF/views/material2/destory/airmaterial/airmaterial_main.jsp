...
<body class="page-header-fixed">
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/material2/destory/airmaterial/airmaterial_main.js"></script>
	<script type="text/javascript" src="${ctx}/static/js/thjw/material2/destory/airmaterial/destroy_main.js"></script>
</body>
</html>