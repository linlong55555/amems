...
<div class="page-content">
	<div class="panel panel-primary">
		...
		<div class=" panel-body padding-bottom-0" id="approveId">
			<div class='searchContent margin-top-0 row-height' >
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" >
						...
						<div id="fjzchDiv" class="col-lg-9 col-md-9 col-sm-9 col-xs-11 padding-left-8 padding-right-0 label-input-div" >
					...
					<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" style='padding-left:15px;'>
						<div class="col-xs-12 input-group input-group-search">
		                    ...
		                    <div class="input-group-addon btn-searchnew" >
		                    	<button id="aircraftinfoMainSearch" type="button" class=" btn btn-primary padding-top-1 padding-bottom-1" onclick="tracking.search();" style='margin-right:0px !important;'>
		   ...
		   <div class="col-lg-12 col-md-12 col-xs-12 padding-left-0 padding-right-0 margin-top-0" id="" >
			   ...
			   <div class="panel-heading">
			     <div class="font-size-12 line-height-12">需求信息</div>
			     <div class="font-size-9 ">Demand Info</div>
               </div>
...
<%@ include file="/WEB-INF/views/material2/demand/approve/approve_open.jsp"%>
<script type="text/javascript" src="${ctx }/static/js/thjw/material2/demand/tracking/tracking_main.js"></script>
<script type="text/javascript" src="${ctx }/static/js/thjw/material2/demand/approve/approve_main.js"></script>
</body>
</html>