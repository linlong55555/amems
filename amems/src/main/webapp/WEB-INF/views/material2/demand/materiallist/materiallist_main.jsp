			...
			$(this).keydown(function(event) {
				...
				if(e.keyCode==13){
					...
					if(formatUndefine(winId) != ""){
						...
						$('#materiallistMainSearch').trigger('click'); //调用主列表页查询
					}
				}
			});
		});
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" >
						<div class="btn-group">
						    ...
						    <ul class="dropdown-menu text-left dropdown-toggle-menu-new" style=''>
								...
								<li ><a href="javaScript:editContract()" style=''>编制合同</a></li>
					...
					<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group pull-right" style='padding-left:15px;'>
						<div class="col-xs-12 input-group input-group-search">
		                    ...
		                    <div class="input-group-addon btn-searchnew" >
		                    	<button id="materiallistMainSearch" type="button" class=" btn btn-primary padding-top-1 padding-bottom-1" onclick="materiallistMain.reload();" style='margin-right:0px !important;'>
...
<script type="text/javascript" src="${ctx }/static/js/thjw/material2/demand/materiallist/materiallist_main.js"></script>
</body>
</html>