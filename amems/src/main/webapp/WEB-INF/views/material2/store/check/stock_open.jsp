	           	...
	           	<div class="col-xs-12 padding-leftright-8" >
					<div class="input-group">
	                    ...
	                    <span class="input-group-addon modalfooterbtn">
							...
							<button onclick="stock_open_alert.clear();" type="button" class="btn btn-primary padding-top-1 padding-bottom-1">
...
<!--  弹出框结束-->
	<script type="text/javascript" src="${ctx}/static/js/thjw/material2/store/check/stock_open.js"></script>
