...
<div class="page-content">
		...
		<div class=" panel-body padding-bottom-0" id="stock_detail">
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							...
							<input id="bjh_view" class="form-control" maxlength="16"  type="text" readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						<span class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
							...
							<div class="font-size-9 ">Parts Name</div>
						</span>
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="ckmc_view" class="form-control" maxlength="16"  type="text" readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="pch_view" class="form-control" maxlength="16"  type="text" readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="sn_view" class="form-control" maxlength="16"   type="text" readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<select id="ck_view" class="form-control" maxlength="16" placeholder=""  disabled="disabled"></select>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							...
							<input id="kw_view" class="form-control" maxlength="16"  type="text" readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<div id="" class="input-group" style="width: 100%;">
							    <input id="kcsldw_view"  class="form-control" type="text" readonly>
				     ...
				     <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group" style='height:34px;'>
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<div id="djno" class="input-group" style="width: 100%;">
							     <a href="javascript:showFrozenHistory()" id="djsl_link"></a>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<div id="" class="input-group" style="width: 100%;">
							    <input id="cb_view" ondblclick="" class="form-control" type="text" readonly>
								<span class="input-group-btn">
									<select class='form-control' id="cbbz_view" style='width:50px;border-left:0px;' disabled="disabled">
									</select>
								</span>
						   </div>
						</div>
				  ...
				  <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<div id="" class="input-group" style="width: 100%;">
							    <input id="jz_view" ondblclick="" class="form-control" type="text" readonly>
								<span class="input-group-btn">
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							...
							<input id="cqid_view" class="form-control"  ondblclick="" type="hidden">
							<input id="cqbh_view" class="form-control"  ondblclick="" type="text" readonly>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="hjsm_view" class="form-control" data-date-format="yyyy-mm-dd"  maxlength="16" placeholder="" type="text" name='date-picker' readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0" >
							<select class='form-control' id="hcly_view" disabled="disabled">
								<option></option>
							</select>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="grn_view" class="form-control" maxlength="16" placeholder="" type="text" readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="tsn_view" class="form-control" maxlength="16" placeholder="" type="text" readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="tso_view" class="form-control" maxlength="16" placeholder="" type="text" readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="csn_view" class="form-control" maxlength="16" placeholder="" type="text" readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="cso_view" class="form-control" maxlength="16" placeholder="" type="text"  readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="scrq_view" class="form-control" maxlength="16" data-date-format="yyyy-mm-dd" type="text" name='date-picker' readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="zt_view" class="form-control" maxlength="16" type="text" readonly>
						</div>
				    </div>
				    ...
				    <div class="col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-md-11 col-sm-10 col-xs-9 padding-left-8 padding-right-0">
							<textarea class='form-control' style='height:55px;' id='cfyq_view' readonly></textarea>
						</div>
				    </div>
				    ...
				    <div class="col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-md-11 col-sm-10 col-xs-9 padding-left-8 padding-right-0">
							<textarea class='form-control' style='height:55px;' id='bz_view' readonly></textarea>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<select id="wllb_view" class="form-control" maxlength="16" disabled="disabled">
							</select>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="cjjh_view" class="form-control" maxlength="16" placeholder="" type="text" readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="gg_view" class="form-control" maxlength="16" placeholder="" type="text" readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="xh_view" class="form-control" maxlength="16"  type="text"  readonly>
						</div>
				    </div>				    
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						<span class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<select id="gljb_view" class="form-control" maxlength="16" placeholder=""  disabled="disabled"></select>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="zzcs_view" class="form-control" maxlength="16" placeholder="" type="text"  readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="maxkcs_view" class="form-control" maxlength="16" placeholder="" type="text"  readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="minkcs_view" class="form-control" maxlength="16" type="text"  readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="sjsj_view" class="form-control" maxlength="16" data-date-format="yyyy-mm-dd"  type="text"  readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="sjr_view" class="form-control" maxlength="16"  type="text" readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="update_view" class="form-control" maxlength="16" data-date-format="yyyy-mm-dd"  type="text" readonly>
						</div>
				    </div>
				    ...
				    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
						...
						<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-left-8 padding-right-0">
							<input id="update_person_view" class="form-control" maxlength="16"  type="text" readonly>
						</div>
				    </div>
				    <div class='clearfix'></div>
			</div>
			...
			<!-- 附加信息 -->
					...
					<!--借用归还履历  -->
					  <div class="panel panel-primary" id="borrowInfo">
						<div class="panel-heading bg-panel-heading padding-top-3 padding-bottom-1 collapse-style" style="position:relative;">
							<a data-toggle="collapse" id='' data-parent="" href="#borrow_history" class="collapsed" >
								...
								<div style="position:absolute;right:28px;top:8px;">
									<a onclick="more(event)" class="font-size-12">&nbsp;&nbsp;更多</a>
								 </div>
							</a>
						</div>
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/material2/stockmaterial/detail/kc_detail.js"></script>
    ...
    <%@ include file="/WEB-INF/views/material2/stockmaterial/inside/tool_use_history.jsp"%>  <!--工具借还履历查看弹框  -->	
