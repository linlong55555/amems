...
<div class="modal fade modal-new" id="stock_certificate_modal" tabindex="-1" role="dialog" aria-labelledby="installation_certificate_modal" aria-hidden="true" data-backdrop='static' data-keyboard= false>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/material2/stockmaterial/inside/inside_certificate.js"></script>