...
<div class="modal fade in modal-new" id="transfer_open_alert" tabindex="-1" role="dialog"  aria-labelledby="transfer_open_alert" aria-hidden="true" data-backdrop='static' data-keyboard= false>
