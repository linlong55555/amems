            ...
            <div class="modal-content">
				<div class="modal-header modal-header-new" >
					<h4 class="modal-title" >
                       	<div class='pull-left'>
                      		<div class="font-size-14" id="modalHeadCN">航材上架</div>
							<div class="font-size-12" id="modalHeadENG">Aerial material</div>
				  		</div>
						...
						<div id="additionalInfo" class="panel-collapse collapse" >
							<div class="panel-body padding-left-0 padding-right-0" style='padding-bottom:0px;'>
							    ...
							    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
									...
									<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8">
										<select id="qczt" class="form-control"></select>
									</div>
							    </div>
...
<script type="text/javascript" src="${ctx}/static/js/thjw/material2/outin/materialstockin/materialstockin_shelves.js"></script>