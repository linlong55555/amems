 				...
 				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
					...
					<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8">
						<div class="input-group col-xs-12">
							...
							<input id="shdh" placeholder='不填写则自动生成'  class="form-control"  type="text"  readonly="readonly">
						</div>
				...
				<div id="lyidDiv" class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
					...
					<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8">
						<div class="input-group col-xs-12">
							...
							<input id="lybh" class="form-control"  readonly="readonly" ondblclick="" type="text">
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
...
<script type="text/javascript" src="${ctx}/static/js/thjw/material2/outin/stockout/stockout_find.js"></script><!--当前js  -->
