...
<script type="text/javascript" src="${ctx}/static/js/thjw/material2/outin/stockout/select_demand.js"></script>
<div class="modal fade in modal-new" id="demandModal" tabindex="-1" role="dialog"  aria-labelledby="demandModal" aria-hidden="true" data-keyboard="false" data-backdrop="static">
           	...
           	<div class="modal-body" style='padding-top:0px;'>
             	<div class="input-group-border" style='margin-top:8px;padding-top:5px;'>
                   	<div class=" pull-right padding-left-0 padding-right-8 margin-top-0 modalSearch">	
						...
						<div class=" pull-right padding-left-0 padding-right-0">
							<div class=" pull-left padding-left-0 padding-right-0" style="width: 250px;">
								<input type="text" placeholder='编号' id="keyword_demand" class="form-control" />
							</div>
		                   	<div class=" pull-right padding-left-5 padding-right-0 ">   
							<button name="keyCodeSearch" type="button" class=" btn btn-primary padding-top-1 padding-bottom-1 " onclick="demandModal.search()">
					...
					<div class="margin-left-8 margin-right-8" style='margin-top:5px;margin-bottom:5px;'>
							...
							<table id="open_win_chapter_basic_table2" class="table table-thin table-bordered table-striped table-hover table-set" >
								<thead>
							   		<tr>
										...
										<th class="colwidth-8">
											<div class="font-size-12 line-height-18">上级件号</div>
										...
										<th class="colwidth-8">
											<div class="font-size-12 line-height-18">需求原因</div>
						...
						<div class="col-xs-12 text-center page-height padding-right-0 padding-left-0" id="demandPagination">
						</div>
						<div class="clearfix"></div>  
					</div>
				</div>
					...
					<div class="input-group">
						<span class="input-group-addon modalfootertip" >
	                   	...
	                   	<span class="input-group-addon modalfooterbtn">
	                     	<button type="button" onclick="demandModal.setData()" class="btn btn-primary padding-top-1 padding-bottom-1" >
								<div class="font-size-12">确定</div>
								<div class="font-size-9">Confirm</div>
							</button>
							<button id="zjh_btn_clear" type="button" onclick="demandModal.clearZjh()" class="btn btn-primary padding-top-1 padding-bottom-1" >
								<div class="font-size-12">清空</div>
								<div class="font-size-9">Clear</div>
							</button>
	                    	<button type="button" onclick="demandModal.close()" class="btn btn-primary padding-top-1 padding-bottom-1" >
