		...
		$(this).keydown(function(event) {
			...
			if(e.keyCode==13){
				...
				if(formatUndefine(winId) != ""){
					...
					$('#outsideStockMainSearch').trigger('click');
				}
			}
		});
	});
...
<!-- 隐藏域 -->
<input type="hidden" value="2" id="hclxType">
<!-- 隐藏域end -->
				...
				<ul class="nav nav-tabs tabNew-style" role="tablist" id="tablist">
				  	<li class="active">
				  		<a id='aircraftMaintenanceTab' href="#aircraftMaintenance"  data-toggle="tab">
			                ...
			                <div class="font-size-9 line-height-9">Outfield Parts Listing</div>
				  		</a>
				  	</li>
				  	<li >
				  		<a id='EOmonitoringTab' href="#EOMonitoring"  data-toggle="tab">
				  			<div class="font-size-12 line-height-12">在途部件清单：采购合同但未入库的部件清单</div>
			                <div class="font-size-9 line-height-9">transit Parts Listing</div>
				  		</a>
				  	</li>
				</ul>
				<!-----标签内容start---->
