		...
		<div class=" panel-body padding-bottom-0" >
			<div class='searchContent margin-top-0 row-height' >
			         <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group" >
						<div class="input-group col-xs-12" style="padding-top:0px;padding-bottom:0px;">
							
							<div id="" class="input-group-addon" style="background:none;border:0px;padding-top:0px;padding-bottom:0px;">
							 	<div class="btn-group" style="width:85px;">
								    <button type="button" class="btn btn-primary padding-top-1 padding-bottom-1 pull-left" style="height:34px;" onclick='mgnt_main.openWinAdd(10)'>
								    	<div class="font-size-12" style=''>状态</div>
										<div class="font-size-9 " style='margin-top:0px;'>Status</div>
		                            </button>
								    ...
								    <ul class="dropdown-menu text-left dropdown-toggle-menu-new" >
										<li ><a href="JavaScript:updateStatus(1)" >收货</a></li>
										<li ><a href="JavaScript:updateStatus(2)" >正常</a></li>
										<li ><a href="JavaScript:updateStatus(11)" >长期封存</a></li>
										<li ><a href="JavaScript:updateStatus(12)" >校验中</a></li>
										<li ><a href="JavaScript:updateStatus(13)" >修理中</a></li>
										<li ><a href="JavaScript:updateStatus(14)" >外借中</a></li>
									</ul>
								</div> 
							</div>
							<div id="" class="input-group-addon" style="border:0px;background:none;padding-left:4px;padding-top:0px;padding-bottom:0px;">
							 	<button type="button" class="btn btn-primary padding-top-1 padding-bottom-1" onclick="exportExcel();">
									<div class="font-size-12">导出</div>
									<div class="font-size-9">Export</div>
								</button>
							 	<button type="button" class="btn btn-primary padding-top-1 padding-bottom-1 checkPermission" permissioncode='material:stock:tool:insideut:02'onclick="importExcel();">
									<div class="font-size-12">导入</div>
									<div class="font-size-9">Import</div>
								</button>
							</div>
							<div id="" class="input-group-addon" style="border:0px;background:none;padding-left:5px;color:#333;padding-right:8px;padding-top:0px;padding-bottom:0px;">
							<div class="font-size-12">状态</div>
							<div class="font-size-9" style="margin-top:3px;">Status</div>
							</div>
						    <select id="zt_search" class="form-control" multiple='multiple' >
							</select>
						</div>
					 </div>
...
<!-- 					</div> -->
		   ...
		   <div id="" class="modal-body col-lg-12 col-md-12 padding-left-0 margin-top-0 padding-right-0 table-height table-set" style="overflow-x: auto;">
					<table id="insideut_list_table" class="table table-thin table-bordered table-striped table-hover table-set" style="">
						<thead>                              
							<tr>
							   <th class="selectAllImg" style='width:46px;padding-left:0px;padding-right:0px;'>
								<a href="#" onclick="SelectUtil.performSelectAll('insideut_list_table')" ><img src="${ctx}/static/assets/img/d1.png" alt="全选" /></a>
								<a href="#" class="" onclick="SelectUtil.performSelectClear('insideut_list_table')" ><img src="${ctx}/static/assets/img/d2.png" alt="不全选" /></a>
							   </th>
								<th  class='colwidth-4'>
...
<!-- 							   </th> -->
						...
						<tbody id="insideutList">
						
						</tbody>
					</table>
				</div>
				<div class="col-xs-12 text-center page-height padding-right-0 padding-left-0" id="insideut_search_pagination"></div>
				</div>
		   </div>
		</div>
	</div>
	...
	<script type="text/javascript" src="${ctx}/static/js/thjw/material2/stocktool/insideut/insideut_main.js"></script>
