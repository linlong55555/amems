...
<script type="text/javascript" src="${ctx}/static/js/thjw/open_win/work_card.js"></script>
<!-- 飞机注册号选择 -->
<div class="modal fade in double-pop-up" id="open_win_work_card" tabindex="-1" role="dialog" aria-labelledby="open_win_work_card" aria-hidden="true">
	<div class="modal-dialog" style="width:60%;">
		<div class="modal-content">	
			<div class="modal-header modal-header-new" >
               	<h4 class="modal-title" >
           			<div class='pull-left'>
               			<div class="font-size-12 ">工卡</div>
            	...
            	<div class="input-group-border" style='margin-top:8px;padding-top:5px;'>
	         		...
	         		<div class=" pull-right padding-left-0 padding-right-8 margin-top-0 modalSearch">	
						...
						<div class=" pull-right padding-left-0 padding-right-0">
							<div class=" pull-left padding-left-0 padding-right-0" style="width: 250px;">
								<input type="text" placeholder='工卡编号/工作主题' id="open_win_work_card_keyword_search" class="form-control" />
							</div>
		                   	<div class=" pull-right padding-left-5 padding-right-0 ">   
							<button type="button" class=" btn btn-primary padding-top-1 padding-bottom-1 " onclick="open_win_work_card.search()">
					...
					<div class="margin-left-8 margin-right-8" style='margin-top:5px;margin-bottom:5px;'>
						<div class='col-xs-12 padding-left-0 padding-right-0' id="searchTable">
								...
								<thead>
							   		<tr>
										...
										<th class="colwidth-30">
											<div class="important">
												<div class="font-size-12 line-height-18" >工作标题</div>
							...
							<div class="col-xs-12 text-center page-height padding-right-0 padding-left-0" id="open_win_work_card_pagination"></div>
						</div>
					</div>
					<!-- end:table -->
		     		<div class="clearfix"></div>
					...
					<div class="input-group">
						<span class="input-group-addon modalfootertip" >
	                   	...
	                   	<span class="input-group-addon modalfooterbtn">
	                     	<button type="button" class="btn btn-primary padding-top-1 padding-bottom-1" onclick="open_win_work_card.save();" data-dismiss="modal">
