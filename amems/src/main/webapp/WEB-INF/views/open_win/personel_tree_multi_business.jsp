...
<script type="text/javascript" src="${ctx}/static/js/thjw/open_win/personel_tree_multi_business.js"></script>
<style type="text/css">
.bootstrap-tagsinput {
  	width: 100% !important;
  	border-radius:0px;
...
<div class="modal fade modal-new" id="Personel_Tree_Multi_Modal" tabindex="3"  role="dialog" aria-labelledby="Personel_Tree_Multi_Modal" aria-hidden="true" data-backdrop='static' data-keyboard= false>
              		...
              		<div class="col-lg-12 col-xs-12 padding-bottom-10 margin-top-8 padding-left-0 padding-right-0">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							...
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8">
								<select class="form-control" id="fjjx" name="fjjx" type="text" >
								</select>
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							...
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8">
								<input class="form-control" id="lb" name="lb" type="text" maxlength="16" >
							</div>
						</div>
						
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							<label class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
								<div class="font-size-12 margin-topnew-2">开始有效期</div>
								<div class="font-size-9">Start Validity</div>
							</label>
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8">
								<input class="form-control date-picker" id="ksrq" name="ksrq" type="text" data-date-format="yyyy-mm-dd" >
							</div>
						</div>
						
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group">
							<label class="col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0">
								<div class="font-size-12 margin-topnew-2">截止有效期</div>
								<div class="font-size-9">End Validity</div>
							</label>
							<div class="col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8">
								<input class="form-control date-picker" id="jzrq" name="jzrq" type="text" data-date-format="yyyy-mm-dd" >
							</div>
						</div>
