...
<script type="text/javascript" src="${ctx}/static/js/thjw/open_win/installationlist_removed.js"></script>
<!-- 飞机注册号选择 -->
<div class="modal fade modal-new" id="open_win_installationlist_removed" tabindex="-1" role="dialog" aria-labelledby="open_win_installationlist_removed" aria-hidden="true" data-backdrop="static">
	<div class="modal-dialog" style="width:60%;">
		<div class="modal-content">	
	                <div class="modal-header modal-header-new">
                       <h4 class="modal-title">
                          <div class="pull-left">
	                       <div class="font-size-12 ">拆下件查询</div>
		            	...
		            	<div class="input-group-border" style="margin-top:8px;padding-top:5px;">
			         		...
			         		<div class="pull-right padding-left-0 padding-right-8 margin-top-0 modalSearch">	
								...
								<div class=" pull-right padding-left-0 padding-right-0">
									<div class=" pull-left padding-left-0 padding-right-0" style="width: 250px;">
										<input type="text" placeholder='件号/名称/序列号/型号/厂家件号' id="open_win_installationlist_removed_keyword_search" class="form-control" />
									</div>
				                    <div class=" pull-right padding-left-5 padding-right-0 ">   
										<button name="keyCodeSearch" type="button" class=" btn btn-primary padding-top-1 padding-bottom-1 " onclick="open_win_installationlist_removed.search()">
							...
							<div style="overflow: auto;" id="searchTable" class="table-content">
								<table id="open_win_regist_basic_table" class="table table-bordered table-striped table-hover table-thin table-set" >
									...
									<tbody id="open_win_installationlist_removed_list">
									
									</tbody>
								</table>
							</div>
							<div class="col-xs-12 text-center page-height padding-right-0 padding-left-0" id="open_win_installationlist_removed_pagination"></div>
							</div>
				     		<div class="clearfix"></div>
					 	 </div>
					 </div> 
			           	...
			           	<div class="col-xs-12 padding-leftright-8">
							...
							<span class="input-group-addon modalfootertip">
			                    ...
			                    <span class="input-group-addon modalfooterbtn">
			                        <button type="button" class="btn btn-primary padding-top-1 padding-bottom-1" onclick="open_win_installationlist_removed.save();" data-dismiss="modal">
										<div class="font-size-12">确定</div>
										<div class="font-size-9">Confirm</div>
									</button>
									<button id="project_btn_clear" type="button" onclick="open_win_installationlist_removed.clearProject()" class="btn btn-primary padding-top-1 padding-bottom-1" data-dismiss="modal">
