...
<body class="page-header-fixed">
			...
			<div class="panel-body padding-bottom-0" >
				 <div class='searchContent row-height' >
					 <div class=" col-lg-3 col-md-6 col-sm-12 col-xs-12   padding-left-0 padding-right-0  form-group ">
						...
						permissioncode='baseinfo:customer:main:add' type="button" onclick="add();">
							<div class="font-size-12">新增</div>
							<div class="font-size-9">Add</div>
						</button>
						<button class="btn btn-primary padding-top-1 padding-bottom-1 row-height checkPermission"
						permissioncode='baseinfo:customer:main:export' type="button" onclick="exportExcel();">
	...
	<%@ include file="/WEB-INF/views/baseinfo/customer/customer_open.jsp" %> 

	<script type="text/javascript" src="${ctx}/static/js/thjw/baseinfo/customer/customer_main.js"></script>
</body>
</html>
