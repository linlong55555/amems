	...
	<div class="modal fade" id="applyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria- hidden="true" >
					<div class="modal-dialog" style="width: 500px;">
							<div class="modal-content" >
								<div class="modal-body padding-bottom-0" id="applyModalBody" >
									<div class="panel panel-primary" >
										<div class="panel-heading  padding-top-3 padding-bottom-1 ">
											<div class="font-size-16 line-height-18">借用申请</div>
											<div class="font-size-9 ">Borrow Apply</div>
										</div>
										<div class="panel-body padding-top-0 padding-bottom-0" >
											 <form id="applyform">
											    <input type="hidden" id="kcid" />
												<div class=" col-lg-12 col-sm-12 col-xs-12  padding-left-0 padding-right-0 margin-top-10 margin-bottom-10 form-group" >
														...
														<div class="col-lg-7 col-sm-7 col-xs-7 padding-left-8 padding-right-0">
															<input type="text" class="form-control" name="jyZrrmc" id="jyZrrmc"  readonly />
															<input type="hidden" id="jyZrrid" />
															 
														</div>
														<div class="col-lg-1 col-sm-1 col-xs-1 padding-left-2 padding-right-0">
															<a href="javascript:toolUseApply.selectUser1();" class="btn btn-primary" >
									...
									<!-- <div class="text-right margin-top-10 margin-bottom-10">
										<button type="button" onclick="doApply()"
											class="btn btn-primary padding-top-1 padding-bottom-1"
											data-dismiss="modal">
											<div class="font-size-12">确定</div>
											<div class="font-size-9">Confirm</div>
...
toolUseApply = {
		selectUser1:function (){
			...
			userModal.show({
				...
				selected:$("#applyform #"+"jyZrrid").val(),//原值，在弹窗中默认勾选
				callback: function(data){//回调函数
					$("#applyform #"+"jyZrrid").val(formatUndefine(data.id));
					$("#applyform #"+"jyZrrmc").val(formatUndefine(data.displayName));
					$('#applyform').data('bootstrapValidator')
...
$('#applyform #jyZrrmc').on('change',function(){
	$('#jyZrrid').val('')
});
</script>					