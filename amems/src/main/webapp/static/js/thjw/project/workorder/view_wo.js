$(function() {
	Navigation(menuCode,"查看工单","View W/O");
	...
	//初始化日志功能
	logModal.init({code:'WorkOrder',id:$('#id').val()});
	
	$("#disableDiv select").attr("disabled",true);
	$("#disableDiv input").attr("disabled",true);
	if($("#gddlx").val()==1){
		$("#dj_Div1").css("display", "");  
		$("#dj_Div2").css("display", "");  
	}
