...
function AjaxGetDatasWithSearch(pageNumber,sortType,sequence){
	...
	obj.isJszl=1;	//技术指令复选为1
	obj.jx=$('#jx').val();//机型
	obj.dprtcode=$('#jgdm').val();//组织机构
...
function getinstructionContent(){
	...
	$("#GznrList").find("tr textarea[name='gznr']").each(function(){
		var instructionContent={};
		instructionContent.gznr=$(this).val();
...
function saveMainInstruction(obj){
	...
	// 提交数据
	AjaxUtil.ajax({
		url:basePath+"/project/instruction/saveMainInstruction",
		type: "post",
		contentType:"application/json;charset=utf-8",
		data:JSON.stringify(obj),
		dataType:"json",
...
function appendGznr(){
	...
	htmlContent =htmlContent +"<td><textarea class='col-lg-12 col-sm-12 col-xs-12' style='height:40px' name='gznr' maxlength='300' ></textarea></td>"
