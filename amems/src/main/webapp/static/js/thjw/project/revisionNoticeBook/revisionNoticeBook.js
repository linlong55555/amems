	...
	$(document).ready(function(){
			 ...
			 */
			 $('#add').on('click',function(){
				 window.location.href =  basePath+"/project/revisionNoticeBook/intoAddRevisionNoticeBook?pageParam="+encodePageParam();
...
/*	function end(id,zlbh,zt) {
	...
	/*		function clickRow(index,this_){
			...
			function add(){
				window.location = basePath+"/project/revisionNoticeBook/intoAddRevisionNoticeBook?pageParam="+encodePageParam();
			}
			/**
			 * 打印
			 * @param id
