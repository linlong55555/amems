...
$(function(){
		 refreshPermission();
		 Navigation(menuCode,"修改飞机故障监控","Edit AircraftFault");
...
function update(){
	...
	AjaxUtil.ajax({
		url : basePath
				+ "/productionplan/planefaultmonitoring/update",
		type : "post",
		data : JSON.stringify(param),
		contentType : "application/json;charset=utf-8",
		dataType : "json",
...
function back(){
	window.location =basePath+"/productionplan/planefaultmonitoring/main?id="+$("#djid").val()+"&pageParam="+pageParam;
}