 ...
 annual_plan_approval_main = {
			...
			audit: function (){
				 ...
				 if(id == null || id==""){
					 AlertUtil.showMessage("当前没有可审核的数据!");
					 return false;
				 }
				 var this_ = this;
				 var str = "是否确定审核?";
				 AlertUtil.showConfirmMessage(str, {callback: function(){
					 	var message = "审核成功!";
						var url = basePath+"/quality/annualplan/audit";
						var obj ={};
						obj.id = id;
						obj.shyj = $("#shyj").val();
			...
			auditBh: function (){
				 var id =$("input:radio[name='ndshId']:checked").val();
				 if(id == null  || id==""){
					 AlertUtil.showMessage("当前没有可审核驳回的数据!");
					 return false;
				 }
				 var this_ = this;
				 var str = "是否确定审核驳回?";
				 AlertUtil.showConfirmMessage(str, {callback: function(){
					 	var message = "审核驳回成功!";
						var url = basePath+"/quality/annualplan/auditBh";
						var obj = {};
						obj.id = id;
						obj.shyj = $("#shyj").val();
						this_.performAction(url, obj, message);
