	...
	var rectify_measures_assessment = {
		
		id : "rectify_measures_assessment_alert_Modal",
		...
		initWebuiPopover : function(){
			var this_ = this;
			WebuiPopoverUtil.initWebuiPopover('attachment-view4',"#"+this_.id,function(obj){
		...
		getData : function(){
			...
			obj.pgjg = measures_assessment.getData();
			return obj;
		},
