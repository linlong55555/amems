...
engine_health_monitor = {
	...
	load: function(){
		...
		var this_ = this;
		AjaxUtil.ajax({
			url:basePath+"/project2/oil/consumption/monitor/queryApuList",
			type: "post",
		...
		obj.setOption({
			...
			tooltip:{
				formatter: function(params){
					...
					value += "<br/>"+"APU滑油消耗:"+ StringUtil.escapeStr(_this.dataMap[params[0].value]);
