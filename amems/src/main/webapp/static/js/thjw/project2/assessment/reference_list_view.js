...
ReferenceUtilView = {
	id:'ReferenceUtilView',
	tbodyId:'reference_list_view',
	colOptionheadClass : "colOptionheadview",
	rowCount : 0,
	param: {
		djid:null,//关联单据id
	...
	initDic : function(){
		$("#wjlxSelectview", $("#"+this.id)).empty();
		DicAndEnumUtil.registerDic('16','wjlxSelectview',this.param.dprtcode);
		$("#wjlySelectview", $("#"+this.id)).empty();
		DicAndEnumUtil.registerDic('8','wjlySelectview',this.param.dprtcode);
	},
	...
	addRow : function(obj){
		var this_ = this;
		$("#wjlxSelectview", $("#"+this_.id)).find("option").removeAttr("selected");
		$("#wjlxSelectview", $("#"+this_.id)).find("option[value='"+obj.wjlx+"']").attr("selected",true);
		var wjlxOption = $("#wjlxSelectview", $("#"+this_.id)).html();
		$("#wjlySelectview", $("#"+this_.id)).find("option").removeAttr("selected");
		$("#wjlySelectview", $("#"+this_.id)).find("option[value='"+obj.wjly+"']").attr("selected",true);
		var wjlyOption = $("#wjlySelectview", $("#"+this_.id)).html();
		var tr = "";
		tr += "<tr>";
