...
$(function() {
	Navigation(menuCode,"新增退货","Add Borrow Apply");
	datepicker();
...
//保存
function save(){
	var url = basePath+"/aerialmaterial/returnedpurchase/save";
	var message = "保存成功!";
...
//提交
function submit(){
	var url = basePath+"/aerialmaterial/returnedpurchase/submit";
	var message = "提交成功!";
	performAction(url,message);
}
