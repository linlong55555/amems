 ...
 * 装上件弹窗
 */
open_win_installationlist_installed = {
	id:'open_win_installationlist_installed',
	paginationId:'open_win_installationlist_installed_pagination',
	loaded: false,//是否已加载
	data:[],
	param: {
	...
	appendContentHtml: function(list){
		...
		$.each(list,function(index,row){
			...
			htmlContent += "<td style='text-align:left;vertical-align:middle;'>"+StringUtil.escapeStr((row.ywms||"") + " " + (row.zwms||""))+"</td>";  
			htmlContent += "<td style='text-align:left;vertical-align:middle;'>"+StringUtil.escapeStr(row.hcMainData ? row.hcMainData.xingh : "")+"</td>";   
			htmlContent += "<td style='text-align:left;vertical-align:middle;'>"+StringUtil.escapeStr(row.hcMainData ? (row.hcMainData.fixChapter ? row.hcMainData.fixChapter.displayName : "") : "")+"</td>";  
