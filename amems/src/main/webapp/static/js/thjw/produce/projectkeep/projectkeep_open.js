Project_Open_Modal = {
	...
	//初始化器材清单
	Equipment_list_edit1: function(id,colOptionhead,ywlx){
		Equipment_list_edit.init({
			djid:id,//关联单据id
			parentWinId : id,//父窗口id
			ywlx:ywlx,//业务类型：1技术通告、2技术指令、3维修方案、4非例行工单、6工程指令EO、7MEL、8工卡、9技术评估单、21工单、31故障保留、32项目保留、33缺陷保留
			colOptionhead : colOptionhead,//true:编辑,false:查看
			dprtcode:$("#dprtcode").val()//默认登录人当前机构代码
		});
	},
	//初始化工具设备
	Tools_list_edit1: function(id,colOptionhead,ywlx){
...
//	      .validateField("gd"); 
	...
	initSourceData: function(obj){
		/*var obj="";
		var code135="produce:reservation:item:main:09";
		var code145="produce:reservation:item:main:091";
