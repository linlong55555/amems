...
function AjaxGetDatasWithSearch(pageNumber,sortType,sequence){
	...
	AjaxUtil.ajax({
	   url:basePath+"/produce/reservation/defect/queryMonitorAllPageList",
	   type: "post",
	   ...
	   success:function(data){
 			...
 			// 标记关键字
			signByKeyword($("#keyword_search").val(), [2,5]);
 			}else{
	 			$("#defrctkeep_list").empty();
				$("#pagination").empty();
				$("#defrctkeep_list").append("<tr><td class='text-center' colspan=\"22\">暂无数据 No data.</td></tr>");
 			}
...
function filseDown(id){
	FilesDownModal.show({
		 djid:id,//单据id
		 code:"produce:reservation:defect:main:100",
