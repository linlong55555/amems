...
function setData(data){
	...
	$("#msn").val(data.aircrafInfo==null?"":data.aircrafInfo.xlh);
	$("#jx").val(data.aircrafInfo==null?"":data.aircrafInfo.fjjx);
	$("#gbbh").val(data.gbbh);
	$("#ms").val(data.gbmc);
	...
	$("#wxlx").val(data.wxlx);
	$("#yjzxdw").val(data.jhZxdw);
	$("#xfdw").val(StringUtil.escapeStr(data.xfdwDepartment==null?"":data.xfdwDepartment.dprtname));
	$("#gzyq").val(data.gzyq);
