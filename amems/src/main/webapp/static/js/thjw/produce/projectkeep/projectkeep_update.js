Project_Update_Modal = {
	...
	open: function(param){
		var this_ = this;
		 ...
		 $("#modalName").html("修改项目保留单");
		 $("#modalEname").html("Update Work Items Delay");
	...
	initInfo : function(param){
		...
		Project_Open_Modal.Equipment_list_edit(param,true); 	//初始化器材清单
		Project_Open_Modal.Tools_list_edit(param,true); 		//初始化工具设备
		Project_Open_Modal.getAttachments(param,true,true); 	//加载附件
