...
var purchaseAddData={
		...
		initInfo : function(){
			...
			if(this.param.changeCss){
				$("#purchase_table_div", $("#"+this.id)).removeClass("padding-right-8").addClass("padding-right-0");
			}
			this.initModelHead();
			this.initViewOrHide();
			this.initDic();
		...
		initModelHead : function(){
			...
			if(this.param.htlx == 50){
				cn = "出售";
				eng = "Sell";
			}
			$("#cgmodalHeadCN", $("#"+this.id)).html(cn);
			$("#cgmodalHeadENG", $("#"+this.id)).html(eng);
			$("#cgcolHeadCN", $("#"+this.id)).html(cn);
			$("#cgcolHeadENG", $("#"+this.id)).html(eng);
		},
		...
		addRow : function(obj){
			...
			if(this_.param.colOptionhead){
				...
				tr += "<td title='"+StringUtil.escapeStr(obj.sl)+StringUtil.escapeStr(obj.dw)+"' style='text-align:right;vertical-align:middle;'>"+StringUtil.escapeStr(obj.sl)+StringUtil.escapeStr(obj.dw)+"</td>";
			}
