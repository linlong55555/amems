	...
	appendContentdemandinfoHtml: function(list){
		var this_=this;
		 ...
		 $.each(list,function(index,row){
				...
				htmlContent += "<td class='text-center fixed-column' ><input type='checkbox' index='"+index+"' name='checkrow' index='"+index+"' dprtcode='"+row.dprtcode+"'  checkid='"+row.id+"' index='"+index+"' onclick=\"SelectUtil.checkRow(this,'selectAllId')\" /></td>";
...
//		 });
	...
	exportExcel: function(){
		...
		window.open(basePath+"/material/return/backRegister.xls?paramjson="+JSON.stringify(param));
	},
	/**
	 * 收货
	 */
