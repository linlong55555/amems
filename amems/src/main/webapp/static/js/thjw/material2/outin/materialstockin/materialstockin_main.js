...
var materialStockIn = {
	...
	initEvent : function(){
		...
		//收缩效果
		$('#certificate_info').on('shown.bs.collapse', function (e) {
	...
	appendContentHtml: function(list){
		...
		$.each(list,function(index,row){
			...
			htmlContent += "<td class='text-center' title='"+DicAndEnumUtil.getEnumName('materialTypeEnum', row.hCMainData ? row.hCMainData.hclx : "")+"'>"+DicAndEnumUtil.getEnumName('materialTypeEnum', row.hCMainData ? row.hCMainData.hclx : "")+"</td>";  
