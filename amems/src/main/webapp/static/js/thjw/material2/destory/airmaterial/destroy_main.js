$(document).ready(function(){
	...
	var destroy_main = {
			...
			searchreset:function(){
				...
				$("#xhrq_search").val("");
				$("#destroy_bfrq_search").val("");
				$("#destroy_hcly").val("");
				$("#destroy_zzjg").val(userJgdm);
			...
			exportExcel:function(){
				...
				window.open(basePath+"/material/destroy/airmaterial/export/2/AirMaterailDestroyed.xls?paramjson="+JSON.stringify(param));
			}
	}