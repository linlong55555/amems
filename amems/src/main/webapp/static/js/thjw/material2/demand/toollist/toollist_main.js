...
var materiallistMain={
		...
		appendContentHtml:function(list){
			...
			$.each(list,function(index,row){
				htmlContent = htmlContent + "<tr onclick=showHiddenContent("+index+",this) mainid='"+row.mainid+"' id='"+row.id+"' >";
...
function exportExcel(){
	...
	if(!searchParam.paramsMap.xpgbsList){
		...
		window.open(basePath+"/material/demand/toollist.xls?paramsMap[dprtcode]="
