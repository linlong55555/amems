...
!function ($, moment) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button class="applyBtn padding-top-1 padding-bottom-1" disabled="disabled"></button>&nbsp;' +
                    '<button class="cancelBtn padding-top-1 padding-bottom-1"></button>' +
                  '</div>' +
                '</div>' +
              '</div>';
        ...
        this.container.find('.applyBtn').html('<div class="font-size-12">确定</div><div class="font-size-9">Confirm</div>');
        this.container.find('.cancelBtn').html('<div class="font-size-12">取消</div><div class="font-size-9">Cancel</div>');
