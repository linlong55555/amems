...
//			en: {
//				days: ["周日/Sunday", "周一/Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
...
//			},
		cn: {
			days: ["周日/Sunday", "周一/Monday", "周二/Tuesday", "周三/Wednesday", "周四/Thursday", "周五/Friday", "周六/Saturday", "周日/Sunday"],
			daysShort: ["日/Sun", "一/Mon", "二/Tue", "三/Wed", "四/Thu", "五/Fri", "六/Sat", "七/Sun"],
			daysMin: ["日/Su", "一/Mo", "二/Tu", "三/We", "四/Th", "五/Fr", "六/Sa", "七/Su"],
			...
			monthsShort: ["一月/Jan", "二月/Feb", "三月/Mar", "四月/Apr", "五月/May", "六月/Jun", "七月/Jul", "八月/Aug", "九月/Sep", "十月/Oct", "十一月/Nov", "十二月/Dec"],
			today: "今天/Today",
			clear: "清除/Clear"
		},
		en: {
	...
	var DPGlobal = {
		...
		parseDate: function(date, format, language) {
			 ...
			 *  @author xu.yong
			 *  @fixdate 2017/4/24
			 *  @addcode 适应日期控件手动输入不带分割符的情况自动识别及转换
			 *  start
			 */
