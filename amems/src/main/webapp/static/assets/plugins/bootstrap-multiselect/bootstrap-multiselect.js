    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    return "<div class='pull-left' style='width:100%;margin-right:-8px; overflow: hidden; text-overflow: ellipsis;'>"+this.nonSelectedText + '</div><b class="caret pull-right" style="margin-top:8px"></b>';
                }
                else {
                    if (options.length > this.numberDisplayed) {
                        return "<div class='pull-left' style='width:100%;margin-right:-8px; overflow: hidden; text-overflow: ellipsis;'>"+options.length + ' ' + this.nSelectedText + '</div><b class="caret pull-right" style="margin-top:8px;"></b>';
                    }
                    else {
                        var selected = '';
                        ...
                        return "<div class='pull-left' style='width:100%;margin-right:-8px; overflow: hidden; text-overflow: ellipsis;'>"+selected.substr(0, selected.length - 2) + '</div><b class="caret pull-right" style="margin-top:8px;"></b>';
                    }
                }
            },
            /**
        ...
        templates: {
            button: '<button type="button" class="multiselect dropdown-toggle" style="text-align:left; background:none !important;" data-toggle="dropdown"></button>',
