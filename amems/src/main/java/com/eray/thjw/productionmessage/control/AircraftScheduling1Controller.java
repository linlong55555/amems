 ...
 */
@Controller
@RequestMapping("/productionmessage/aircraftscheduling")
public class AircraftScheduling1Controller extends BaseController {
	 ...
	 * @throws Exception 
	 */
	@Privilege(code="productionmessage:aircraftscheduling:main")
	@RequestMapping(value = "/main", method = RequestMethod.GET)
	public ModelAndView main() throws BusinessException {
		Map<String, Object> model = new HashMap<String, Object>();
		return new ModelAndView("/productionmessage/aircraftscheduling/aircraftscheduling_main", model);
	}
