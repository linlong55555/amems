 ...
 */
@Controller
@RequestMapping("/customerproject/maintenanceplan145")
public class MaintenancePlan145sController {
	 ...
	 * @UpdateBy 林龙
	 */
	@Privilege(code="customerproject:maintenanceplan145:main")
	...
	public ModelAndView main(HttpServletRequest request)throws BusinessException {
		...
		try {
			...
			return new ModelAndView("/customerproject/maintenanceplan/145/maintenanceplan_main", model);
		} catch (Exception e) {
