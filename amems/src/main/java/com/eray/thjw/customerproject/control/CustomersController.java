 ...
 */
@Controller
@RequestMapping("/customerproject/customer")
public class CustomersController extends BaseController {
     ...
     * @return view
     */
	@Privilege(code = "customerproject:customer:main")
	@RequestMapping(value = "main", method = RequestMethod.GET)
	public ModelAndView CommonalityPage() {
		return new ModelAndView("customerproject/customer/customer_main");
	}
	 ...
	 */
	@Privilege(code = "customerproject:customer:main:add")
	@ResponseBody
	 ...
	 * @throws BusinessException
	 */
	@Privilege(code = "customerproject:customer:main:del")
	@ResponseBody
	 ...
	 * @throws BusinessException
	 */
	@Privilege(code = "customerproject:customer:main:edit")
	@ResponseBody
