package com.eray.thjw.customerproject.control;
 ...
 */
@Controller
@RequestMapping("/customerproject/project")
public class ProjectsController extends BaseController{
	 ...
	 * @return
	 */
	@Privilege(code = "customerproject:project:main")
	@RequestMapping(value = "main", method = RequestMethod.GET)
	public ModelAndView CommonalityPage() {
		return new ModelAndView("customerproject/project/project_main");
	}
	 ...
	 */
	@Privilege(code = "customerproject:project:main:add")
	@ResponseBody
	 ...
	 * @throws BusinessException
	 */
	@Privilege(code = "customerproject:project:main:edit")
	@ResponseBody
	...
	public String showProject(Model model, HttpServletRequest request) {
		...
		return "customerproject/project/project_detail";
	 ...
	 * @throws BusinessException
	 */
	@Privilege(code = "customerproject:project:main:del")
	@ResponseBody
