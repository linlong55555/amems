...
/**
 * @author liub
 * @description 外委供应商控制层
 */
@Controller
@RequestMapping("/aerialmaterial/outsourcingfirm")
public class OutsourcingFirmController extends BaseController {
	 ...
	 *
	 */
	@Privilege(code="aerialmaterial:outsourcingfirm:main")
	@RequestMapping(value = "main", method = RequestMethod.GET)
	public String main(Model model) throws BusinessException {
		model.addAttribute("gyslb", FirmTypeEnum.OUTSOURCING_FIRM.getId());
		return "material/firm/outsourcing_firm_main";
	}
	 ...
	 */
	@Privilege(code="aerialmaterial:outsourcingfirm:main:01")
	@ResponseBody
	 ...
	 * @throws BusinessException 
	 */
	@Privilege(code="aerialmaterial:outsourcingfirm:main:02")
	@ResponseBody
	 ...
	 * @throws BusinessException
	 */
	@Privilege(code="aerialmaterial:outsourcingfirm:main:03")
	@ResponseBody
	...
	/**
	 * 
	 * @Description 分页查询外委供应商-弹窗
	 * @CreateTime 2017年11月10日 下午12:32:13
	 * @CreateBy 朱超
	 * @param firm
	 * @return
	 * @throws BusinessException
	 */
	@ResponseBody
	@RequestMapping(value = "queryList4Pop", method = RequestMethod.POST)
	public Map<String, Object> queryList4Pop(@RequestBody Firm firm)throws BusinessException {
		try {
			List<Firm> list = firmService.queryPageListPop(firm);
			return PageUtil.pack4PageHelper(list, firm.getPagination());
	 ...
	 * @throws BusinessException 
	 */
	@Privilege(code="aerialmaterial:outsourcingfirm:main:04")
	@ResponseBody
	...
	public Map<String, Object> excelImport(MultipartHttpServletRequest multipartRequest,  
		...
		try {
			...
			result.put(MESSAGE, "外委供应商导入成功！");
		} catch (ExcelImportException e) {
			result.put(SUCCESS, Boolean.FALSE);
			result.put(MESSAGE, e.getMessage());
		} catch (Exception e) {
			result.put(SUCCESS, Boolean.FALSE);
			result.put(MESSAGE, "外委供应商导入失败！");
			e.printStackTrace();
		}
		return result;
	}
	...
	@RequestMapping(value = "OutsourcingSupplier.xls")
	public String export(Firm firm, String sqksrqBegin, String sqksrqEnd,String sqjsrqBegin,String whrqBegin,String sqjsrqEnd,String whrqEnd,HttpServletRequest request,
		...
		try {
			...
			return outReport("xls", "common", "wwgys", model);
		} catch (Exception e) {
