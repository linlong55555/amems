 ...
 */
@Controller
@RequestMapping("/produce/flb")
public class FlightLogBookController extends BaseController {
	 ...
	 * @CreateTime 2017年9月15日 下午4:17:20
	 * @CreateBy 韩武
	 * @param request
	 * @param model
	 * @return
	 */
	@Privilege(code = "produce:flb:main")
	...
	public ModelAndView main(HttpServletRequest request, Model model) {
		...
		return new ModelAndView("produce/flb/flightlogbook_main", responseParamMap);
	}
	...
	public ModelAndView view(HttpServletRequest request, Model model) {
		Map<String, Object> responseParamMap = new HashMap<String, Object>();
		return new ModelAndView("produce/flb/flightlogbook_view", responseParamMap);
	}
	 ...
	 * @throws BusinessException
	 */
	@Privilege(code = "produce:flb:main:01,produce:flb:main:02")
	@ResponseBody
	 ...
	 * @throws BusinessException
	 */
	@Privilege(code = "produce:flb:main:03")
	@ResponseBody
	 ...
	 * @throws BusinessException
	 */
	@Privilege(code = "produce:flb:main:05")
	@ResponseBody
	 ...
	 * @throws BusinessException
	 */
	@Privilege(code = "produce:flb:main:04")
	@ResponseBody
