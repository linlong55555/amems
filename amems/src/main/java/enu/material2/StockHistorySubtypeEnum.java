 ...
 * @CreateBy 韩武
 */
public enum StockHistorySubtypeEnum {
    ...
    private StockHistorySubtypeEnum(Integer id, String name) {
    	this.id = id;
        this.name = name;
    }
    
    public static String getName(Integer id) {
        for (StockHistorySubtypeEnum c : StockHistorySubtypeEnum.values()) {
    ...
    public static List<Map<String, Object>> enumToListMap() {
    	...
    	StockHistorySubtypeEnum[] enums = StockHistorySubtypeEnum.values();
    	
    	for (StockHistorySubtypeEnum enumItem : enums) {
