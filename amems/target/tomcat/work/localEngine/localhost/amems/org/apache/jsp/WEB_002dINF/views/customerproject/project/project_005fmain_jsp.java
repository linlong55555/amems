package org.apache.jsp.WEB_002dINF.views.customerproject.project;
...
public final class project_005fmain_jsp extends org.apache.jasper.runtime.HttpJspBase
...
static {
  ...
  static {
    ...
    _jspx_dependants.add("/WEB-INF/views/customerproject/project/project_open.jsp");
    _jspx_dependants.add("/WEB-INF/views/customerproject/project/customer_choose.jsp");
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\r\n");
      out.write("\t<input type=\"hidden\" id=\"adjustHeight\" value=\"0\" />\r\n");
      out.write("\t<div class=\"clearfix\"></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<button class=\"btn btn-primary padding-top-1 padding-bottom-1  checkPermission\"\r\n");
      out.write("\t\t\t\t\t\tpermissioncode='customerproject:project:main:add' type=\"button\" onclick=\"add();\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12\">新增</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9\">Add</div>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<button class=\"btn btn-primary padding-top-1 padding-bottom-1  checkPermission\"\r\n");
      out.write("\t\t\t\t\t\tpermissioncode='customerproject:project:main:export' type=\"button\" onclick=\"exportExcel();\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12\">项目种类</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<select id=\"proiect_zl\" class=\"form-control \" onchange=\"changeList()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-9 col-md-9 col-sm-8 col-xs-10 padding-left-8 padding-right-0 label-input-div\" >\r\n");
      out.write("\t\t\t\t\t\t\t<select id=\"dprtcode\" class=\"form-control \"  name=\"dprtcode\" onchange=\"changedrpt_List()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t  \r\n");
      out.write("\t\t\t\t\t <!-- 关键字搜索 -->\r\n");
      out.write("\t\t\t\t  <div class=\"col-lg-3 col-md-6 col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group \" style='padding-left:15px;'>\r\n");
      out.write("\t\t\t\t\t<div class=\"col-xs-12 input-group input-group-search\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" placeholder='项目编号/项目名称/客户编号/飞机注册号' id=\"keyword_search\" class=\"form-control \">\r\n");
      out.write("                    <div class=\"input-group-addon btn-search-nomore\" >\r\n");
      out.write("                    \t<button type=\"button\" class=\" btn btn-primary padding-top-1 padding-bottom-1 row-height\" onclick=\"sreload();\" style='margin-right:0px !important;'>\r\n");
      ...
      out.write("\t\t\t\t<!-- 搜索框end -->\r\n");
      out.write("\t\t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t<div class='table_pagination' id=\"searchTable\">\r\n");
      out.write("\t\t\t\t<!-- 表格 -->\r\n");
      out.write("\t\t\t\t\t<div id=\"project_main_table_top_div\" class=\"col-lg-12 col-md-12 padding-left-0 padding-right-0 margin-top-0 table-height\" style=\"overflow-x: auto;\">\r\n");
      out.write("\t\t\t\t\t\t<table  class=\"table table-thin table-bordered table-striped table-hover table-set\" id=\"project_list_table\">\r\n");
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10 sorting\" onclick=\"orderBy('xmbm')\" id=\"xmbm_order\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10 sorting\" onclick=\"orderBy('xmmc')\" id=\"xmmc_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">项目名称</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Name</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10 sorting\" onclick=\"orderBy('khid')\" id=\"khid_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  <div class=\"important\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10 sorting\" onclick=\"orderBy('fjjsh')\" id=\"fjjsh_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">MSN</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">MSN</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10 sorting\" onclick=\"orderBy('fjbzm')\" id=\"fjbzm_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">飞机描述</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Desc</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10 sorting\" onclick=\"orderBy('xmzl')\" id=\"xmzl_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">项目种类</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Category</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10 sorting\" onclick=\"orderBy('jh_ksrq')\" id=\"jh_ksrq_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">计划进场时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">E.T.A.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10 sorting\" onclick=\"orderBy('jh_jsrq')\" id=\"jh_jsrq_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">计划出场时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">E.T.D.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10 sorting\" onclick=\"orderBy('sj_ksrq')\" id=\"sj_ksrq_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">实际进场时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Actual In</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10 sorting\" onclick=\"orderBy('sj_jsrq')\" id=\"sj_jsrq_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">实际出场时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Actual Out</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13 sorting\" onclick=\"orderBy('xsddh')\" id=\"xsddh_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">销售订单号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Sale Order</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13 sorting\" onclick=\"orderBy('fstk')\" id=\"fstk_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">主要条款</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Main Terms</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</th> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13 sorting\" onclick=\"orderBy('whrid')\" id=\"whrid_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">维护人</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Maintenance</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13 sorting\" onclick=\"orderBy('dprtcode')\" id=\"dprtcode_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">组织机构</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Organization</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t<tbody id=\"project_list\">\r\n");
      out.write("\t\t\t\t\t\t\t     <tr><td colspan=\"19\" align=\"center\">数据加载中……</td></tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t<div class='clearfix'></div>\r\n");
      out.write("\t\t\t</div>\t\r\n");
      out.write("\t\t\t<div class=\" col-xs-12  text-center page-height padding-right-0 padding-left-0\" style=\"margin-top: 0px; margin-bottom: 0px;\" id=\"pagination\"></div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      out.write("\t");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("<div class=\"modal fade in modal-new\" id=\"AddEditAlertModal\" tabindex=\"-1\" role=\"dialog\"  \r\n");
      out.write("       aria-labelledby=\"AddEditAlertModal\" aria-hidden=\"true\" data-keyboard=\"false\" data-backdrop=\"static\">\r\n");
      out.write("\t<div class=\"modal-dialog\" style=\"width:85%;\">\r\n");
      out.write("\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t    <div class=\"modal-header modal-header-new\" >\r\n");
      out.write("\t               \t<h4 class=\"modal-title\" >\r\n");
      out.write("\t           \t\t\t<div class='pull-left'>\r\n");
      out.write("\t               \t\t\t<div class=\"font-size-12\" id=\"materialHeadChina\" ></div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-9 \" id=\"materialHeadEnglish\"></div>\r\n");
      out.write("\t\t\t\t\t \t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class='pull-right' >\r\n");
      ...
      out.write("\t\t\t        <form id=\"form_project\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">项目编号</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t    <input type=\"hidden\" id=\"project_id\" value=''>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control \" id=\"xmbm\" name=\"xmbm\" maxlength=\"50\" placeholder=\"不填写则自动生成\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\"><span class=\"identifying\" style=\"color: red\">*</span>项目名称</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">P.Name</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control \" id=\"xmmc\" name=\"xmmc\" maxlength=\"50\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">项目种类</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Category</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<select class='form-control' id='xmzl' name=\"xmzl\" >\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">客户种类</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Category</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8\" style='height:34px;'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"0\" name='pro_fl'  onclick=\"changeWbbs(this);\"> 内部\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"1\" checked=\"checked\" name='pro_fl' onclick=\"changeWbbs(this);\"> 外部 &nbsp; &nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class='clearfix'></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- 客户 start -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" id=\"customer_No_1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\"><span class=\"identifying\" style=\"color: red\">*</span>客户编号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Customer No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \" id=\"cust_add_20180115\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class='input-group' style='width:100%;'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"cust_no\" name=\"cust_no\" class=\"form-control readonly-style\" readonly\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t  ondblclick=\"openCustomerWin(1)\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" class=\"form-control\" id=\"cust_id\" name=\"cust_id\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span class=\"input-group-btn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default form-control\" \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t     data-toggle=\"modal\" onclick=\"openCustomerWin(1)\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"icon-search cursor-pointer\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \" id=\"cust_edit_20180115\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t    <input type=\"text\" class=\"form-control \" id=\"cust_edit_no\" name=\"cust_edit_no\" maxlength=\"50\" readonly=\"readonly\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t    <div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" id=\"customer_Name_1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">客户名称</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">C.Name</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control \" id=\"cust_name\" name=\"cust_name\" maxlength=\"50\" readonly=\"readonly\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- 客户 end -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- 部门编号 start -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" id=\"departmentModalInput\" style=\"display: none\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\"><span class=\"identifying\" style=\"color: red\">*</span>部门编号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Dept No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \" id=\"dept_add_20180115\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class='input-group' style='width:100%;'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"dept_no\" name=\"dept_no\" class=\"form-control readonly-style\" readonly onclick=\"openzrdw(this);\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" class=\"form-control\" id=\"dept_id\" name=\"dept_id\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span class=\"input-group-btn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\"  class=\"btn btn-default form-control\" id=\"openDeptWin_20171011\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t     data-toggle=\"modal\" onclick=\"openzrdw(this);\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"icon-search cursor-pointer\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \" id=\"dept_edit_20180115\" style=\"display: none\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control \" id=\"dept_edit_no\" name=\"dept_edit_no\" maxlength=\"50\" readonly=\"readonly\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t    <div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" id=\"deptment_Name_1\" style=\"display: none\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">部门名称</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">D.Name</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control \" id=\"dept_name\" name=\"dept_name\" maxlength=\"50\" readonly=\"readonly\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- 部门名称 end -->\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<select class='form-control' id='fjjx' name=\"fjjx\" onchange=\"changeFjjx()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    </select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control \" id=\"fjzch\" name=\"fjzch\" maxlength=\"100\"  onblur=\"getProjectAircraftInfo();\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class='clearfix'></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"fjxlh\" name=\"fjxlh\" maxlength=\"100\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">飞机描述</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Desc</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"fjbzm\" name=\"fjbzm\" maxlength=\"100\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- <div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">飞机序列号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Serial NO.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"fjxlh\" name=\"fjxlh\" maxlength=\"100\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">航班号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Flight NO.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"hbh\" name=\"hbh\" maxlength=\"100\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- <div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control \" id=\"fjjx\" name=\"fjjx\" maxlength=\"16\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- <div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input class=\"form-control\" id=\"gg\" name=\"gg\" maxlength=\"16\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">计划进场时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">E.T.A.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control date-picker\" maxlength=\"10\" id=\"jh_ksrq\" name=\"jh_ksrq\"  data-date-format=\"yyyy-mm-dd\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class='clearfix'></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">计划出场时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">E.T.D.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control date-picker\" maxlength=\"10\" id=\"jh_jsrq\" name=\"jh_jsrq\" data-date-format=\"yyyy-mm-dd\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">实际进场时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Actual In</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control date-picker\" maxlength=\"10\" id='sj_ksrq' name=\"sj_ksrq\" data-date-format=\"yyyy-mm-dd\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">实际出场时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Actual Out</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control date-picker\" maxlength=\"10\" id='sj_jsrq' name=\"sj_jsrq\" data-date-format=\"yyyy-mm-dd\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class='clearfix'></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 飞机其他信息 -->\r\n");
      out.write("\t\t\t\t\t\t\t<div  class=\"panel panel-default padding-right-0 \" id=\"fjInfo_div\">\r\n");
      out.write("\t\t\t\t\t\t        <div class=\"panel-heading bg-panel-heading\">\r\n");
      out.write("\t\t\t\t\t        \t\t<div class=\"font-size-12\">飞机其他信息</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t     <div class=\"font-size-9 \">Aircraft Other Info</div>\r\n");
      out.write("\t\t\t\t\t\t\t    </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label  class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">飞机飞行小时</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">A/C FH</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" maxlength=\"10\" id=\"fxsj\" name=\"fxsj\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label  class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">飞机飞行循环</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">A/C FC</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" maxlength=\"10\" name=\"fxxh\" id=\"fxxh\" onkeyup=\"clearNoNumber(this)\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label  class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">IPC有效性号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">IPC Effectivity</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" maxlength=\"50\" id=\"ipcyxxh\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label  class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">滑油牌号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Oil P/N</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" maxlength=\"100\" id=\"rhyzph\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class='clearfix'></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">HYD Fluid P/N</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" maxlength=\"100\" id=\"yyyph\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label  class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">飞机状态</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Aircraft Status</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<select class='form-control' id='fjzt'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"\" ></option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class='col-xs-12 padding-leftright-8 margin-top-8 margin-bottom-8'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-xs-12 padding-left-0 padding-right-0\" style='overflow:auto;'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<table class=\"table table-thin table-bordered table-striped table-hover table-set\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     <th class=\"colwidth-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t       <div class=\"font-size-12 line-height-18\">装机位置</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t       <div class=\"font-size-12 line-height-18\">Location</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     </th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     <th class=\"colwidth-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t        <div class=\"font-size-12 line-height-18\">件号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t        <div class=\"font-size-12 line-height-18\">P/N</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t        </th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     <th class=\"colwidth-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t        <div class=\"font-size-12 line-height-18\">型号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t        <div class=\"font-size-12 line-height-18\">Model No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t      </th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     <th class=\"colwidth-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t        <div class=\"font-size-12 line-height-18\">序号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t        <div class=\"font-size-12 line-height-18\">S/N</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     </th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     <th class=\"colwidth-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t        <div class=\"font-size-12 line-height-18\">时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t        <div class=\"font-size-12 line-height-18\">HRS</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     </th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     <th class=\"colwidth-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t         <div class=\"font-size-12 line-height-18\">循环</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t         <div class=\"font-size-12 line-height-18\">Cycle</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     </th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  </thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  <tbody id=\"engine_list_info\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td class='text-center'>APU\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"apu_id_h\" id=\"apu_id_h\" value=\"\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"wz\" value=\"31\"/>  <!-- 位置代码 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"apu_id_c\" id=\"apu_id_c\" value=\"\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        </td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"apu_jh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"apu_xh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"apu_xlh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"apu_hv\" class=\"form-control \" name='init_time_apuh' maxlength=\"10\" \r\n");
      out.write("\t\t\t\t\t\t\t\t\t              style=\"width: 130px ;float: left\">APUH\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"jklbh\" value=\"2_20_AH\">  <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"jkflbh\" value=\"2T\"> <!-- 监控分类编号 --> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        </td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" class=\"form-control\" maxlength=\"16\" id=\"apu_cv\" name='apu_cv_k' onkeyup=\"clearNoNumber(this)\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t              style=\"width: 130px ;float: left\"/>APUC\r\n");
      out.write("\t\t\t\t\t\t\t\t\t              <input type=\"hidden\" name=\"jklbh\" value=\"3_20_AC\">  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t              <input type=\"hidden\" name=\"jkflbh\" value=\"3C\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        </td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td class='text-center'>1#发\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"e1_id_h\" id=\"e1_id_h\" value=\"\"/> <!-- 数据库主键 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"wz\" value=\"21\"/>  <!-- 位置代码 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"e1_id_c\" id=\"e1_id_c\" value=\"\"/> <!-- 数据库主键 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        </td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"e1_jh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"e1_xh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"e1_xlh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"e1_hv\" class=\"form-control\" maxlength=\"16\" name='init_time_1eh'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t             style=\"width: 130px ;float: left\"/>EH\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"jklbh\" value=\"2_30_EH\">  <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"jklbh\" value=\"2T\">  <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        </td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" class=\"form-control\" maxlength=\"16\" id=\"e1_hc\" name='e1_hc_k' onkeyup=\"clearNoNumber(this)\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t             style=\"width: 130px ;float: left\"/>EC\r\n");
      out.write("\t\t\t\t\t\t\t\t\t             <input type=\"hidden\" name=\"jklbh\" value=\"3_30_EC\">  <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t             <input type=\"hidden\" name=\"jklbh\" value=\"3C\">        <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        </td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td class='text-center'>2#发\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"e2_id_h\" id=\"e2_id_h\" value=\"\"/> <!-- 数据库主键 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"wz\" value=\"22\"/>  <!-- 位置代码 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"e2_id_c\" id=\"e2_id_c\" value=\"\"/> <!-- 数据库主键 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        </td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"e2_jh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"e2_xh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"e2_xlh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"e2_hv\" class=\"form-control\" maxlength=\"16\" name='init_time_2eh' \r\n");
      out.write("\t\t\t\t\t\t\t\t\t            style=\"width: 130px ;float: left\"/>EH\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"jklbh\" value=\"2_30_EH\">  <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"jklbh\" value=\"2T\">  <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        </td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" class=\"form-control\" maxlength=\"16\" id=\"e2_hc\" name='e2_hc_k' onkeyup=\"clearNoNumber(this)\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            style=\"width: 130px ;float: left\"/>EC\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"jklbh\" value=\"3_30_EC\">  <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"jklbh\" value=\"3C\">        <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        </td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td class='text-center'>3#发\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"e3_id_h\" id=\"e3_id_h\" value=\"\"/> <!-- 数据库主键 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"wz\" value=\"23\"/>  <!-- 位置代码 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"e3_id_c\" id=\"e3_id_c\" value=\"\"/> <!-- 数据库主键 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        </td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\"  id=\"e3_jh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\"  id=\"e3_xh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\"  id=\"e3_xlh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\"  id=\"e3_hv\"  class=\"form-control\" maxlength=\"16\" name='init_time_3eh' \r\n");
      out.write("\t\t\t\t\t\t\t\t\t            style=\"width: 130px ;float: left\"/>EH\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"jklbh\" value=\"2_30_EH\">  <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"jklbh\" value=\"2T\">  <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        </td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" class=\"form-control\" maxlength=\"16\" id=\"e3_hc\" name='e3_hc_k' onkeyup=\"clearNoNumber(this)\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            style=\"width: 130px ;float: left\"/>EC\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"jklbh\" value=\"3_30_EC\">  <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"jklbh\" value=\"3C\">        <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t       </td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td class='text-center'>4#发\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"e4_id_h\" id=\"e4_id_h\" value=\"\"/> <!-- 数据库主键 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"wz\" value=\"24\"/>  <!-- 位置代码 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"e4_id_c\" id=\"e4_id_c\" value=\"\"/> <!-- 数据库主键 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        </td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"e4_jh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"e4_xh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"e4_xlh\" class=\"form-control\" maxlength=\"16\" /></td> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" id=\"e4_hv\" class=\"form-control\" maxlength=\"16\"  name='init_time_4eh' \r\n");
      out.write("\t\t\t\t\t\t\t\t\t            style=\"width: 130px ;float: left\"/>EH\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"jklbh\" value=\"2_30_EH\">  <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            <input type=\"hidden\" name=\"jklbh\" value=\"2T\">  <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        </td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        <td><input type=\"text\" class=\"form-control\" maxlength=\"16\" id=\"e4_hc\" name='e4_hc_k' onkeyup=\"clearNoNumber(this)\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            style=\"width: 130px ;float: left\"/>EC\r\n");
      out.write("\t\t\t\t\t\t\t\t\t         <input type=\"hidden\" name=\"jklbh\" value=\"3_30_EC\">  <!-- 监控类编号 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t         <input type=\"hidden\" name=\"jklbh\" value=\"3C\">        <!-- 监控类编号 -->   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        </td>\r\n");
      ...
      out.write("\t\t\t\t\t\t        <div class=\"panel-heading bg-panel-heading\">\r\n");
      out.write("\t\t\t\t\t        \t\t<div class=\"font-size-12\">销售订单信息</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Sales Infos</div>\r\n");
      out.write("\t\t\t\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"panel-body padding-bottom-0 padding-left-0 padding-right-0  padding-top-0\">\t \t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-xs-12 margin-top-8 padding-left-0  padding-right-0\" >\r\n");
      out.write("\t\t\t\t\t\t\t           <div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label  class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">销售订单号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Sales Order</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"xsddh\" id=\"xsddh\" maxlength=\"16\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">主要条款</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t    <div class=\"font-size-9\">Primary Special Terms</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"col-lg-1 col-md-1 col-sm-2 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">主要条款</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Main Terms</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<textarea class=\"form-control padding-left-3 padding-right-3\"  style=\"height:55px\" maxlength=\"300\" id=\"fstk\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <!-- <div class=\"col-xs-12 col-sm-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"col-lg-1 col-md-1 col-sm-2 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">合同附件</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Attachment</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-group\" id='uploadarea'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"input-group-addon inputgroupbordernone\" style=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t    \t<label class=\"margin-left-0 label-input\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t    \t\t<input  type=\"checkbox\" onclick=\"allowFileUpload(this);\"> &nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t    \t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t    </span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t    <span  class=\"singlefile input-group-btn uploaderDiv\" id=\"uploaderDiv_t\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div  class=\"panel panel-default padding-right-0 \">\r\n");
      out.write("\t\t\t\t\t\t        <div class=\"panel-heading bg-panel-heading\">\r\n");
      out.write("\t\t\t\t\t        \t\t<div class=\"font-size-12\">项目执行信息</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Project Performance Info</div>\r\n");
      out.write("\t\t\t\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"panel-body padding-bottom-0 padding-left-0 padding-right-0  padding-top-0\">\t \t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-xs-12 margin-top-8 padding-left-0  padding-right-0\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label  class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">项目经理</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">P/M</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"xmjl\" name=\"xmjl\" maxlength=\"16\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label  class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">计划主控</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Plan Master</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"jhzk\" name=\"jhzk\" maxlength=\"jhzk\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label  class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">控制室</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Phone Number</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"kzs\" name=\"kzs\" maxlength=\"16\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label  class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">起算工时</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Cap</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"qsgs\" name=\"qsgs\" maxlength=\"16\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label  class=\"col-lg-4 col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">控制室电话</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Control Room Landline</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"kzsdh\" name=\"kzsdh\" maxlength=\"16\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- <div class=\"col-xs-12 col-sm-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"col-lg-1 col-md-1 col-sm-2 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">其他说明</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Other Instructions</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<textarea class=\"form-control padding-left-3 padding-right-3\"  style=\"height:55px\" maxlength=\"300\" id=\"qtsm\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    </div> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div  class=\"panel panel-default padding-right-0 \">\r\n");
      out.write("\t\t\t\t\t\t        <div class=\"panel-heading bg-panel-heading\">\r\n");
      out.write("\t\t\t\t\t        \t\t<div class=\"font-size-12\">合同附件</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Attachment List</div>\r\n");
      out.write("\t\t\t\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"panel-body padding-bottom-0 padding-left-0 padding-right-0  padding-top-0\">\t \t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-xs-12 margin-top-8 padding-leftright-8\" style='overflow:auto;'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  <table class=\"table table-thin table-bordered table-striped table-hover table-set\" id=\"table_procet_20171011\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\" colwidth-4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t    <div class=\"font-size-12 line-height-18 \" id='uploadarea'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t        <span  class=\"singlefile input-group-btn uploaderDiv\" id=\"uploaderDiv_t\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t    </span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t   <div class=\"font-size-12 line-height-30\" id=\"scwjWbwjm\" style=\"display: none\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t    </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">File Explanation</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\" colwidth-7\"><div class=\"font-size-12 line-height-18\">上传人</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Uploader </div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\" colwidth-7\"><div class=\"font-size-12 line-height-18\">上传时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Upload Time</div></th>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</thead>\r\n");
      ...
      out.write("\t\t                      <i class='glyphicon glyphicon-info-sign alert-info'></i>\r\n");
      out.write("\t\t                      <p class=\"alert-info-message\"></p>\r\n");
      out.write("\t\t\t\t\t        </span>\r\n");
      out.write("\t\t                   \t<span class=\"input-group-addon modalfooterbtn\">\r\n");
      out.write("\t\t                     \t<button id=\"materialSave\" class=\"btn btn-primary padding-top-1 padding-bottom-1\" onclick=\"javascript:saveProject();\">\r\n");
      ...
      out.write("<!-- 添加弹出框 -->\r\n");
      out.write("<!-- \t选择用户的模态框 -->\r\n");
      out.write("\t<div class=\"modal modal-new\" id=\"customer_choose\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\"  data-keyboard=\"false\" data-backdrop=\"static\">\r\n");
      out.write("\t<div class=\"modal-dialog\" style=\"width: 40%;height:50%;\">\r\n");
      out.write("\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t   <!-- 模态框头部 -->\r\n");
      out.write("\t\t   <div class=\"modal-header modal-header-new\" >\r\n");
      out.write("\t               \t<h4 class=\"modal-title\" >\r\n");
      out.write("\t           \t\t\t<div class='pull-left'>\r\n");
      out.write("\t               \t\t\t<div class=\"font-size-12\">选择客户</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9 \">Choice</div>\r\n");
      out.write("\t\t\t\t\t \t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class='pull-right' >\r\n");
      out.write("\t\t\t\t\t\t  \t<button type=\"button\" class=\"icon-remove modal-close\" data-dismiss=\"modal\" aria-label=\"Close\"></button>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t<div class=\"col-xs-12 margin-top-8 \">\r\n");
      out.write("\t\t\t\t\t<div class=\"input-group-border\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"text-right padding-leftright-8\">\r\n");
      out.write("\t\t\t         \t\t\t<div style=\"padding-left:0!important;\" class=\"pull-right\">   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\" btn btn-primary padding-top-1 padding-bottom-1\" onclick=\"searchCustomer()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">搜索</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Search</div>\r\n");
      out.write("\t\t\t                   \t\t</button>\r\n");
      out.write("\t\t\t                    </div> \r\n");
      out.write("\t\t\t\t\t\t\t\t<div style=\"padding-right:9px!important;\" class=\"col-xs-6 pull-right\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder='客户名/客户编号' id=\"keyword_user_search\" class=\"form-control \" />\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- start:table -->\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"margin-top-8 padding-leftright-8\" style=\"overflow-y:auto;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<table class=\"table table-bordered table-striped table-hover text-left table-set\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t   \t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">客户编号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Customer No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th style=\"width:45%\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">客户名称</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Customer Name</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t \t\t </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tbody id=\"customer_choose_list\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <td colspan=\"3\" style=\"text-align: center;\">数据加载中……</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\" col-xs-12  text-center page-height padding-right-0 padding-left-0\" style=\"margin-top: 0px; margin-bottom: 0px;\" id=\"custpagination\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- end:table -->\r\n");
      out.write("\t\t\t     \t\t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t        </span>\r\n");
      out.write("\t\t                   \t<span class=\"input-group-addon modalfooterbtn\">\r\n");
      out.write("\t\t                     \t<button type=\"button\" onclick=\"appendCustomer()\" name=\"\" id=\"appendCustomer_id\"\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/customerproject/project/project_main.js\"></script>\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/common/preview.js\"></script>\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/customerproject/project/project_main.jsp(78,9) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/customerproject/project/project_main.jsp(78,9) '${accessDepartment}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${accessDepartment}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/views/customerproject/project/project_main.jsp(78,9) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/views/customerproject/project/project_main.jsp(79,38) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
