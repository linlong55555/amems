package org.apache.jsp.WEB_002dINF.views.material.requisition;
...
public final class requisition_005fmain_jsp extends org.apache.jasper.runtime.HttpJspBase
...
static {
  ...
  static {
    ...
    _jspx_dependants.add("/WEB-INF/views/material/requisition/requisition_history.jsp");
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("';\r\n");
      out.write("\tvar tabId = '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.tabId}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("';\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("\" />\r\n");
      out.write("\t<input type=\"hidden\" id=\"adjustHeight\" value=\"70\" />\r\n");
      ...
      out.write("\t\t\t\t  <li role=\"presentation\" class=\"active\"><a id=\"tab_main\" onclick=\"loadMain();\" href=\"#requisition\" data-toggle=\"tab\">领料 Requisition</a></li>\r\n");
      out.write("\t\t\t\t  <li role=\"presentation\"><a id=\"tab_history\" onclick=\"loadHistory();\" href=\"#requisitionHistory\" data-toggle=\"tab\">领料历史 Requisition history</a></li>\r\n");
      out.write("\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t<!-----标签内容start---->\r\n");
      out.write("\t\t      \t<div class=\"tab-content margin-bottom-10\">\r\n");
      out.write("\t\t\t\t\t<div class=\"tab-pane fade in active\"  id=\"requisition\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"margin-bottom-0 col-xs-12 padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-xs-2 col-md-3 padding-left-0 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"javascript:void(0);\" onclick=\"goEdit();\" class=\"btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission\" permissioncode=\"aerialmaterial:requisition:main:01\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">领料申请单</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Requisition</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</a>\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t<span id=\"requisiton_message\" class=\"pull-left text-center\" style=\"padding-left:10px; line-height:35px;\"></span>  -->\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"alert alert-success col-xs-4 col-md-4 text-center\" style=\"padding-top: 5px;padding-bottom: 5px; margin-bottom:0px;vertical-align: middle;display:none;\" role=\"alert\" id=\"requisiton_message\"></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control row-height\" id=\"keyword_search\" placeholder=\"件号/GRN/中英文/厂家件号/序列号/批次号\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t                    <div class=\"pull-right padding-left-5 padding-right-0\">   \r\n");
      out.write("\t\t\t                   \t\t<button type=\"button\" class=\"btn btn-primary padding-top-1 padding-bottom-1\" onclick=\"search();\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">搜索</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Search</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary dropdown-toggle padding-top-1 padding-bottom-1 resizeHeight\" id=\"btn\" onclick=\"more_params();\">\r\n");
      ...
      out.write("\t\t\t                    </div>    \r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-xs-12 triangle  padding-top-10  margin-top-10 display-none border-cccccc search-height\" id=\"divSearch\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"pull-left col-xs-4 col-sm-4 col-lg-4 text-right padding-left-0 padding-right-0 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">航材类型</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Airmaterial type</div></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group col-xs-8 col-sm-8 col-lg-8 padding-left-8 padding-right-0\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-3 col-xs-3 pull-right text-right padding-right-0\" style=\"margin-bottom: 10px;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<table id=\"lingliao\" class=\"table table-thin table-bordered table-striped table-hover table-set\" style=\"min-width: 2100px !important;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"fixed-column colwidth-15 sorting\" name=\"column_bjh\" onclick=\"orderBy('bjh',this)\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"fixed-column colwidth-15 sorting\" name=\"column_grn\" onclick=\"orderBy('grn',this)\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">GRN</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">GRN</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-25 sorting\" name=\"column_ywms\" onclick=\"orderBy('ywms',this)\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">英文名称</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">F.Name</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-20 sorting\" name=\"column_zwms\" onclick=\"orderBy('zwms',this)\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">中文名称</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">CH.Name</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"sorting colwidth-15\" name=\"column_cjjh\" onclick=\"orderBy('cjjh',this)\"><div class=\"important\"><div class=\"font-size-12 line-height-18\">厂家件号</div></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">MP/N</div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"sorting colwidth-10\" name=\"column_hclx\" onclick=\"orderBy('hclx',this)\"><div class=\"font-size-12 line-height-18\">航材类型</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Airmaterial type</div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th  class=\"sorting colwidth-13\" name=\"column_gljb\" onclick=\"orderBy('gljb',this)\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">航材管理级别</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tManagement level\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-20\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"important\"><div class=\"font-size-12 line-height-18\">序列号</div></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">S/N</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-20\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"important\"><div class=\"font-size-12 line-height-18\">批次号</div></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">P/N</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th  class=\"sorting colwidth-10\" name=\"column_shzh\" onclick=\"orderBy('shzh',this)\"><div class=\"font-size-12 line-height-18\">适航证号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Certificate</div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th  class=\"sorting colwidth-7\" name=\"column_kcsl\" onclick=\"orderBy('kcsl',this)\"><div class=\"font-size-12 line-height-18\">数量</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Num</div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"sorting colwidth-7\" name=\"column_jldw\" onclick=\"orderBy('jldw',this)\"><div class=\"font-size-12 line-height-18\">单位</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Unit</div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"sorting colwidth-15\" name=\"column_ckmc\" onclick=\"orderBy('ckmc',this)\" ><div class=\"font-size-12 line-height-18\">仓库</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Store</div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th  class=\"sorting colwidth-15\" name=\"column_kwh\" onclick=\"orderBy('kwh',this)\"><div class=\"font-size-12 line-height-18\">库位</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Storage location</div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th  class=\"sorting colwidth-9\" name=\"column_hjsm\" onclick=\"orderBy('hjsm',this)\"><div class=\"font-size-12 line-height-18\">货架寿命</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Shelf-life</div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-7\" ><div class=\"font-size-12 line-height-18\">剩余天数</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Surplus</div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</thead>\r\n");
      ...
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t        <div class=\"tab-pane fade\" id=\"requisitionHistory\">\r\n");
      out.write("\t\t          \t\t");
      out.write("\r\n");
      out.write("<div class=\"margin-bottom-0 col-xs-12 padding-left-0 padding-right-0\">\r\n");
      out.write("\t<div class=\"pull-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t<div class=\"pull-left padding-left-0 padding-right-0 row-height\" style=\"width:250px;\">\r\n");
      out.write("\t\t\t<input type=\"text\" class=\"form-control \" id=\"his_keyword_search\" placeholder=\"领用申请单号\"/>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("        <div class=\"pull-right padding-left-5 padding-right-0\">   \r\n");
      out.write("       \t\t<button type=\"button\" class=\"btn btn-primary padding-top-1 padding-bottom-1\" onclick=\"historySearch();\">\r\n");
      out.write("\t\t\t\t<div class=\"font-size-12\">搜索</div>\r\n");
      out.write("\t\t\t\t<div class=\"font-size-9\">Search</div>\r\n");
      out.write("\t\t\t</button>\r\n");
      out.write("\t\t\t<button type=\"button\" class=\"btn btn-primary dropdown-toggle padding-top-1 padding-bottom-1 resizeHeight\" id=\"btn1\" onclick=\"his_more_params();\">\r\n");
      out.write("\t\t\t\t<div class=\"pull-left text-center\">\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-12\">更多</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-9\">More</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("    \t</div>    \r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div class=\"col-xs-12 triangle  padding-top-10 margin-bottom-0 margin-top-10 display-none border-cccccc search-height\" id=\"divSearch1\">\r\n");
      out.write("\t\t<div class=\"col-lg-12  padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12 padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t<div\r\n");
      out.write("\t\t\t\t\tclass=\"pull-left col-lg-4 col-xs-4 col-sm-4 text-right padding-left-0 padding-right-0 \">\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-12\">状态</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-9\">State</div></div>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"form-group col-lg-8 col-xs-8 col-sm-8 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t<select id=\"sqdzt\" class=\"form-control \"  name=\"zt\">\r\n");
      out.write("\t\t\t\t\t\t<option value=\"\">显示全部All</option>\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12 margin-bottom-10 padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t<div class=\"pull-left col-lg-4 col-xs-4 col-sm-4  text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t<div class=\"font-size-12\">飞机注册号</div>\r\n");
      out.write("\t\t\t\t<div class=\"font-size-9\">A/C REG</div></div>\r\n");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12  padding-left-0  margin-bottom-10  padding-right-0\">\r\n");
      ...
      out.write("\t\t\t\t<div class=\"col-lg-8 col-xs-8 col-sm-8 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t<select id=\"dprtcode1\" class=\"form-control \" name=\"dprtcode\" >\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12 pull-right text-right padding-right-0\" style=\"margin-bottom: 10px;\">\r\n");
      out.write("\t\t\t\t<button type=\"button\"\r\n");
      out.write("\t\t\t\t\tclass=\"btn btn-primary padding-top-1 padding-bottom-1\"\r\n");
      out.write("\t\t\t\t\tonclick=\"historySearchreset();\">\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-12\">重置</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-9\">Reset</div>\r\n");
      out.write("\t\t\t\t</button>\r\n");
      out.write("\t\t\t</div> \r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      out.write("<div class=\"col-xs-12 text-center padding-left-0 padding-right-0 padding-top-0 table-h\" >\r\n");
      out.write("\t<table id=\"llls\" class=\"table table-thin table-bordered table-set\" style=\"min-width: 1350px;\">\r\n");
      out.write("\t\t<thead>\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t<div class=\"font-size-9 line-height-18\">No.</div>\r\n");
      out.write("\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t<th class=\"colwidth-10 sorting\" name=\"column_lysqdh\" onclick=\"historyOrderBy('lysqdh', this)\">\r\n");
      out.write("\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">领用申请单号</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Requisition No.</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t<th class=\"sorting colwidth-15\" name=\"column_fjzch\" onclick=\"historyOrderBy('fjzch', this)\">\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-12 line-height-18\">飞机注册号</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-9 line-height-18\">A/C REG</div>\r\n");
      out.write("\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<th class=\"sorting colwidth-13\" name=\"column_sqrid\" onclick=\"historyOrderBy('sqrid', this)\">\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-12 line-height-18\">申请人</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Applicant</div>\r\n");
      out.write("\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t<th class=\"sorting colwidth-9\" name=\"column_sqrq\" onclick=\"historyOrderBy('sqrq', this)\">\r\n");
      ...
      out.write("\t\t\t\t\t<div class=\"font-size-12 line-height-18\">领用原因</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Cause</div>\r\n");
      out.write("\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t<th class=\"sorting colwidth-7\" name=\"column_zt\" onclick=\"historyOrderBy('zt', this)\">\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-12 line-height-18\">状态</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-9 line-height-18\">State</div>\r\n");
      out.write("\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t<th class=\"sorting colwidth-13\" name=\"column_zdrid\" onclick=\"historyOrderBy('zdrid', this)\">\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-12 line-height-18\">制单人</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Creator</div>\r\n");
      out.write("\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t<th class=\"sorting colwidth-13\" name=\"column_zdsj\" onclick=\"historyOrderBy('zdsj', this)\">\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-12 line-height-18\">制单时间</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Create Time</div>\r\n");
      out.write("\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t<th class=\"sorting colwidth-13\" name=\"column_dprtcode\" onclick=\"historyOrderBy('dprtcode', this)\">\r\n");
      ...
      out.write("\t</table>\r\n");
      out.write("</div>\r\n");
      out.write("<div class=\"col-xs-12 text-center page-height\" id=\"historyPagination\">\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<!-- start指定结束提示框 -->\r\n");
      out.write("<div class=\"modal fade\" id=\"closeModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"font-size-16 line-height-18\">指定结束</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-9 \">Assign end</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">领料申请单号</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control \" id=\"lysqdh\" name=\"lysqdh\" disabled=\"disabled\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" class=\"form-control \" id=\"lysqid\" name=\"lysqid\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div id=\"zdjsrDiv\" class=\"display-none col-lg-12 col-sm-12 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-2 col-sm-2 col-xs-2 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">指定结束人</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Operator</div>\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-10 col-sm-10 col-xs-10 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"form-control\" id=\"zdjsr\" name=\"zdjsr\" disabled=\"disabled\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div id=\"zdjssjDiv\" class=\"display-none col-lg-12 col-sm-12 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-2 col-sm-2 col-xs-2 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">结束时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Operate Time</div>\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-10 col-sm-10 col-xs-10 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"form-control\" id=\"zdjssj\" name=\"zdjssj\" disabled=\"disabled\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-12 col-sm-12 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-2 col-sm-2 col-xs-2 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\"><span style=\"color: red\" id=\"showjsyy\">*</span>结束原因</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">End Cause</div>\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-10 col-sm-10 col-xs-10 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<textarea class=\"form-control\" style=\"height:100px\" id=\"zdjsyy\" name=\"zdjsyy\" placeholder='长度最大为150' maxlength=\"150\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t     \t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t     \t<div class=\"text-right margin-top-10 padding-buttom-10 \">\r\n");
      out.write("\t\t\t\t\t\t\t<button id=\"shutdownConfirmBtn\" type=\"button\" class=\"display-none btn btn-primary padding-top-1 padding-bottom-1 margin-bottom-10\" onclick=\"sbShutDown()\">\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      out.write("<!-- end指定结束提示框 -->\r\n");
      out.write("\r\n");
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/material/requisition/requisition_history.js\"></script>\r\n");
      out.write("\r\n");
      out.write("\t\t\t        </div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/material/requisition/requisition_main.js\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/material/requisition/requisition_history.jsp(60,6) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/material/requisition/requisition_history.jsp(60,6) '${accessDepartment}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${accessDepartment}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/views/material/requisition/requisition_history.jsp(60,6) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/views/material/requisition/requisition_history.jsp(61,34) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
