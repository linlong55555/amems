package org.apache.jsp.WEB_002dINF.views.produce.airworthinessstatus;
...
public final class airworthinessstatus_005fmain_jsp extends org.apache.jasper.runtime.HttpJspBase
...
static {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<div class=\"font-size-12 line-height-12\">飞机列表</div>\r\n");
      out.write("\t                    <div class=\"font-size-9 line-height-9\">List</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-body padding-left-0 padding-right-0 padding-bottom-0\" >\r\n");
      out.write("\t\t\t\t\t<form id=\"aftersaveForm\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/production/airworthinessdirective/manage\" method=\"post\">\r\n");
      out.write("\t\t\t\t   \r\n");
      out.write("\t\t\t\t    </form>\r\n");
      out.write("\t\t\t\t    <div class=\"col-xs-12 padding-leftright-8 padding-bottom-8 row-height\">\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"pull-left col-xs-3 col-sm-3 text-right  padding-right-0 padding-left-2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-14\">组织机构</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Organization</div>\r\n");
      out.write("\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-xs-9 col-sm-9 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<select id=\"dprtcode_search\" class=\"form-control \" name=\"dprtcode_search\" onchange=\"airworthiness_manage.changeOrg();\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div  id=\"div_qh_scorll\" class=\"col-xs-12  padding-leftright-8 table-height\" style=\"overflow-y: auto; \">\r\n");
      out.write("\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t \t</div>\r\n");
      out.write("\t\t \t<div class='col-sm-9 col-xs-12' style='padding-left:0px;padding-right:0px;' id=\"right_div\">\r\n");
      out.write("\t\t \t<div id=\"airworthinessstatus_toggle_div\" style=\"position: absolute; left: -8px; top: 250px;\">\r\n");
      out.write("\t\t \t \r\n");
      out.write("\t\t\t<i class=\"cursor-pointer icon-caret-left\"   style=\"font-size: 22px;\" onclick=\"airworthiness_manage.airworthinessStatusToggle(this)\"></i>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t \t<div class=\"panel panel-primary\">\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-heading\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-12 line-height-12\">不适航状态维护</div>\r\n");
      out.write("\t                    <div class=\"font-size-9 line-height-9\">Unairworthiness Maintenance</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-body padding-left-0 padding-right-0\" id='airworthinessstatus-body'>\r\n");
      out.write("\t\t \t\t    <div class=\"col-lg-12 padding-left-0 padding-right-0\" >\r\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-12 padding-right-0 padding-left-0\" id=\"divSave\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-12  ibox-title line1 padding-right-0 padding-left-0\">\r\n");
      out.write("\t\t\t\t\t\t <div class='padding-leftright-8'>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-8 padding-right-0 padding-left-0 sh_list\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span ><em>指令流水号 :</em><i id=\"lsh\"></i></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span ><em>申请人:</em><i id=\"zdrrealname\"></i></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span ><em>申请时间 :</em><i id=\"zdsj\"></i></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\" pull-right\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button id=\"btnSave\" onclick=\"airworthiness_manage.saveForm();\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"btn btn-primary padding-top-1 padding-bottom-1 checkPermission\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tpermissioncode='aircraftinfo:airworthiness:saveorupdate'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">保存</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Save</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button id=\"btnClear\" onclick=\"airworthiness_manage.clearForm()\" class=\"btn btn-primary padding-top-1 padding-bottom-1 \">\r\n");
      ...
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-12 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t<form id=\"saveForm\">\r\n");
      out.write("\t\t\t\t\t\t       <input type=\"hidden\" id=\"id\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-4 col-sm-4 padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t <span class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">计划停场时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-leftright-8\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class='input-group' style='z-index:1;'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <input type=\"text\" class='form-control datetimepicker' id=\"bshYjrq\" name=\"bshYjrq\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <span class='input-group-btn' >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <input class='form-control datetimepicker readonly-style' type='text' style='width:60px;margin-left:2px;' id='bshYjsj' name='bshYjsj' readonly/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t   </span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-4 col-sm-4 padding-left-0 padding-right-0  form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span  class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12  \">实际停场时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9  \">Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class='input-group' style=\"z-index:1;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <input type=\"text\" class='form-control datetimepicker' id=\"bshSjrq\" name=\"bshSjrq\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <span class='input-group-btn'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t   <input class='form-control datetimepicker readonly-style' type='text' style='width:60px;margin-left:2px;' id='bshSjsj' name='bshSjsj' readonly/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t   </span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t <div class=\"col-lg-4 col-sm-4 padding-left-0 padding-right-0 form-group \" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"pull-left col-lg-4 col-sm-4 text-right padding-left-0 padding-right-0 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">不适航审批单号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Unairworthiness No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"col-lg-8 col-sm-8 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control \" id=\"bshSpdh\" maxlength=\"20\" name=\"bshSpdh\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>  \r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-4 col-sm-4 padding-left-0 padding-right-0  form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span  class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">计划适航时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-leftright-8\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class='input-group' style='margin-bottom:0px !important;z-index:1;'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <input type=\"text\" class='form-control datetimepicker' id=\"shYjrq\" name=\"shYjrq\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <span class='input-group-btn'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <input class='form-control datetimepicker readonly-style' type='text' style='width:60px;margin-left:2px;' id='shYjsj' name='shYjsj' readonly/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t   </span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-4 col-sm-4 padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span  class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 \">实际适航时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class='input-group' style='z-index:1;' >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <input type=\"text\" class='form-control datetimepicker' id=\"shSjrq\" name=\"shSjrq\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <span class='input-group-btn'> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t   <input class='form-control datetimepicker readonly-style' type='text' style='width:60px;margin-left:2px;' id='shSjsj' name='shSjsj' readonly/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  </span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-4 col-sm-4 padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"pull-left col-lg-4 col-sm-4 text-right padding-left-0 padding-right-0 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">适航审批单号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Airworthiness No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"col-lg-8 col-sm-8 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control \" maxlength=\"20\" id=\"shSpdh\" name=\"shSpdh\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\" col-lg-4 col-sm-4 col-xs-12  padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">不适航批准人</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Reviewer</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class='col-xs-8 padding-leftright-8'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\" input-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t <input type=\"text\" class=\"form-control readonly-style\" name=\"bshPzrmc\" id=\"bshPzrmc\"  readonly />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"bshPzrid\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span class=\"input-group-btn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<button id=\"bshBtn\" class=\"btn btn-default\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t  <div class=\" col-lg-4 col-sm-4 col-xs-12  padding-left-0 padding-right-0  form-group \" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">适航批准人</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Reviewer</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class='col-xs-8 padding-leftright-8'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"input-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control readonly-style\" name=\"shPzrmc\" id=\"shPzrmc\"  readonly />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"shPzrid\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span class=\"input-group-btn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<button id=\"shBtn\" class=\"btn btn-default\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"icon-search\" ></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-4 col-sm-4 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"pull-left col-lg-4 col-sm-4 text-right padding-left-0 padding-right-0 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">停场类型</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Type</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<select id=\"bshyy\" class=\"form-control \" name=\"bshyy\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t <option value=\"1\" >计划</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t <option value=\"2\" >非计划</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-4 col-sm-4 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"pull-left col-lg-4 col-sm-4 text-right padding-left-0 padding-right-0 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">停场原因</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Reason of Stop</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input id=\"tcyy\" class=\"form-control \" name=\"tcyy\" maxlength=\"100\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-12 padding-left-0 padding-right-0   form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"pull-left col-lg-2 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">备注</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Remark</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t <div class=\"col-lg-10 col-sm-10 col-xs-8 padding-leftright-8\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t <textarea class=\"form-control\" id=\"bz\" name=\"bz\" placeholder='长度最大为300'   maxlength=\"300\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-12 padding-leftright-8\" id='panelBodyHeight'>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel panel-primary\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div  class=\"panel-heading bg-panel-heading\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"pull-left\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t历史记录</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Historic Records</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"pull-right\" style='padding-right:15px;'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<a href=\"javascript:void(0);\" onclick=\"airworthiness_manage.more();\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t   <div class='padding-left-0 padding-right-0' style='overflow:auto;'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<table class=\"table table-thin table-bordered table-striped table-hover text-center table-set\" style=\"min-width:1000px;margin-bottom:10 !important;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-5\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"font-size-12 line-height-18 \">操作</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"font-size-12 line-height-18\">指令流水号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Serial No</div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13\" ><div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"font-size-12 line-height-18\">停场时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Stop Time</div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13\" ><div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"font-size-12 line-height-18\">适航时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Airworthiness Time</div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-15\"><div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"font-size-12 line-height-18\">不适航审批单号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Unairworthiness No</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10\"><div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"font-size-12 line-height-18\">适航审批单号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Airworthiness No</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</th>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10\"><div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"font-size-12 line-height-18\">停场类型</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Type</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</th>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10\"><div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"font-size-12 line-height-18\">停场原因</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Reason of Stop</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</th>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</thead>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tstyle=\"margin-top: 0px; margin-bottom: 0px;\" id=\"pagination\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<input id=\"hasResult\" type=\"hidden\" />\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<div class=\"modal fade in modal-new\" id=\"searchModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria- hidden=\"true\" style=\"z-index: 100000 ! important; \">\r\n");
      out.write("\t<div class=\"modal-dialog\" style=\"width: 1000px;\">\r\n");
      out.write("\t\t<div class=\"modal-content\" >\r\n");
      out.write("\t\t\t<div class=\"modal-header modal-header-new\" >\r\n");
      out.write("\t\t\t\t<h4 class=\"modal-title\" >\r\n");
      out.write("\t\t\t\t\t<div class='pull-left'>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-14 \" id=\"titleName\">历史记录</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-12\" id=\"titleEname\">Historic Records</div> \r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class='pull-right' >\r\n");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<div class=\"modal-body \" id=\"searchModalBody\" >\r\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-12 padding-left-0 padding-right-0 margin-top-8\" id=\"divSearch\">\r\n");
      out.write("\t\t\t\t\t    <!-- <input type=\"hidden\" id=\"fjzch\" /> -->\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<input placeholder=\"适航审批单号/不适航审批单号/不适航批准人/适航批准人\" id=\"keyword\" class=\"form-control \" type=\"text\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t                    <div class=\" pull-right padding-left-5 padding-right-0 \">   \r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" class=\" btn btn-primary padding-top-1 padding-bottom-1 \" onclick=\"popModal.search();\">\r\n");
      ...
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-12 padding-left-0 padding-right-0 margin-top-10\" style=\" overflow-y:hidden; overflow-x: scroll;\">\r\n");
      out.write("\t\t\t\t\t\t<table\r\n");
      out.write("\t\t\t\t\t\t\tclass=\"table table-thin table-bordered table-striped table-hover text-center table-set\" style=\"min-width:1700px;\" >\r\n");
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-3\"><div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tclass=\"font-size-12 line-height-18\">序号</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Serial No.</div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13\"><div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"font-size-12 line-height-18\">计划停场时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13\"><div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"font-size-12 line-height-18\">实际停场时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13\"><div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"font-size-12 line-height-18\">计划适航时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13\"><div\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"font-size-12 line-height-18\">实际适航时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">不适航审批单号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Unairworthiness No</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-15\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">适航批准人</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Reviewer</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">不适航批准人</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Reviewer</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-15\"><div class=\"font-size-12 line-height-18\">停场类型</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Type</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-15\"><div class=\"font-size-12 line-height-18\">停场原因</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Reason of Stop</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-20\"><div class=\"font-size-12 line-height-18\">备注</div>\r\n");
      ...
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"clearfix\"></div>   \r\n");
      out.write("\t\t\t\t\t<div class=\"col-xs-12 text-center padding-right-0 page-height\" id=\"air_pagination\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"clearfix\"></div>   \r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"clearfix\"></div>   \r\n");
      ...
      out.write(" <script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/produce/airworthinessstatus/airworthinessstatus_main.js\"></script>  \r\n");
      out.write("  \r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("</body>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/produce/airworthinessstatus/airworthinessstatus_main.jsp(57,9) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/produce/airworthinessstatus/airworthinessstatus_main.jsp(57,9) '${accessDepartment}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${accessDepartment}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/views/produce/airworthinessstatus/airworthinessstatus_main.jsp(57,9) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/views/produce/airworthinessstatus/airworthinessstatus_main.jsp(58,37) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ (user.jgdm eq type.id and  empty dprtcode) or dprtcode eq type.id  }", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
