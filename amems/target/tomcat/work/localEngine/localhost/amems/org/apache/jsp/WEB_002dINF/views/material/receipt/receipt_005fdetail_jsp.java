package org.apache.jsp.WEB_002dINF.views.material.receipt;
...
public final class receipt_005fdetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/WEB-INF/views/material/receipt/contract.jsp");
    _jspx_dependants.add("/WEB-INF/views/material/receipt/borrowApply.jsp");
    _jspx_dependants.add("/WEB-INF/views/material/receipt/lendReturn.jsp");
    _jspx_dependants.add("/WEB-INF/views/material/receipt/receipt_component.jsp");
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<form id=\"receiptForm\">\r\n");
      out.write("\t\t<div class=\"panel panel-primary\">\r\n");
      out.write("\t\t\t<div class=\"panel-heading\" id=\"NavigationBar\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t<div class=\"panel-body\">\r\n");
      out.write("\t\t\t\t<div class=\"col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0\" style=\"margin-bottom:10px;\">\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" id=\"receiptId\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${receipt.id}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" id=\"dprtcode\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${receipt.dprtcode==null?user.jgdm:receipt.dprtcode}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("\">\r\n");
      ...
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-heading margin-left-16 padding-top-1 margin-bottom-10 \" style=\"border-bottom: 1px solid #ccc; margin-top: 0px;cursor:pointer\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-16 line-height-18\">收货单信息</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-9 \">ReceiptSheet Infomation</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t   </div>\r\n");
      out.write("\t\t\t\t   <div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-12 padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12 padding-right-0 form-group\" >\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Receipt Type</div>\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<select class='form-control' id='shlx' name='shlx' onchange=\"switchType()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"1\">采购</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"2\">送修</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"3\">借入</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"4\">借出归还</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"99\">其它</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12 padding-right-0 form-group\" id=\"contract_div\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">合同</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">contract</div>\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\" id=\"ht_div\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"form-control\" id=\"hth\" disabled=\"disabled\" type=\"text\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"form-control\" id=\"htid\" name=\"htid\" type=\"hidden\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-btn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-primary form-control\" type=\"button\" onclick=\"chooseContract()\">\r\n");
      ...
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div id=\"jddx_div\" style=\"display: none;\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">借调对象类型</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">S/O Type</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select id=\"jddxlx\" name=\"jddxlx\" class=\"form-control\" onchange=\"changeJddxlx()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"1\">飞行队 Flying team</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"2\">航空公司 Airline.com</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"0\">其它 Other</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t   </select> \r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">借调对象</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Seconded Obj</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select id=\"jddx\" name=\"jddx\" class=\"form-control\" onchange=\"changeJddx()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t   \t\t<option value=\"\">显示所有 All</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t   </select> \r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">借调负责人</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Seconded Obj</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"jdfzr\" maxlength=\"10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12 padding-right-0 form-group\" id=\"borrowApply_div\" style=\"display: none;\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">借入申请单</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Apply No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\" id=\"jrsq_div\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"form-control\" id=\"jrsqbh\" disabled=\"disabled\" type=\"text\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"form-control\" id=\"jrsqid\" name=\"jrsqid\" type=\"hidden\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-btn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-primary form-control\" type=\"button\" onclick=\"chooseBorrowApply()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<i class=\"icon-search\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12  padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">收货人</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Receiver</div>\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t <div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\" id=\"shr_div\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"form-control\" id=\"shr\" disabled=\"disabled\" type=\"text\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"form-control\" id=\"shrid\" name=\"shrid\" value=\"\" type=\"hidden\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"form-control\" id=\"shbmid\" value=\"\" type=\"hidden\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-btn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-primary form-control\" type=\"button\" onclick=\"chooseShr()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<i class=\"icon-search\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Receipt Date</div> \r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control date-picker\" name=\"shrq\" id=\"shrq\" data-date-format=\"yyyy-mm-dd\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12  padding-right-0 form-group\" id=\"fhdw_div\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">发货单位</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Delivery</div> \r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"  maxlength=\"160\" name=\"fhdw\" id=\"fhdw\" disabled=\"disabled\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-12 padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-12 col-xs-12 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-xs-1 text-right padding-left-0 padding-right-0\" style=\"width: 8%\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">备注</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Remark</div>\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-xs-11 padding-left-8 padding-right-0\" style=\"width: 92%\">\r\n");
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-12 padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12  padding-right-0 form-group\" id=\"shdh_div\" style=\"display: none;\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">收货单号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Receipt No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t <div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"shdh\" disabled=\"disabled\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12  padding-right-0 form-group\" id=\"zt_div\" style=\"display: none;\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">状态</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">State</div>\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t <div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"zt\" disabled=\"disabled\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12  padding-right-0 form-group\" id=\"zdr_div\" style=\"display: none;\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">制单人</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Creator</div>\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t <div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"zdr\" disabled=\"disabled\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12  padding-right-0 form-group\" id=\"zdsj_div\" style=\"display: none;\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">制单时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Create Time</div>\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t <div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"zdsj\" disabled=\"disabled\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-heading margin-left-16 padding-top-1 margin-bottom-10 \" style=\"border-bottom: 1px solid #ccc; margin-top: 10px;cursor:pointer\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-4 padding-left-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-4  padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-16 line-height-18\">收货单详细</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">ReceiptSheet Detail</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-8 padding-bottom-5 padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" id=\"onekey_btn\" style=\"display: none;\" class=\"btn btn-primary pull-left padding-top-1 padding-bottom-1 notView\" onclick=\"showAutoFillStoreModal()\">\r\n");
      out.write("\t\t                     \t\t<div class=\"font-size-12\">一键填写仓库</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Onekey Fill</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t   </div>\r\n");
      out.write("\t\t\t\t   <div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t\t<small class=\"text-muted notView\">多个序列号请以“,”分割</small>\r\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-12 col-md-12 padding-left-0 padding-right-0\" style=\"overflow-x:auto ;\">\r\n");
      out.write("\t\t\t\t\t\t<table id=\"receipt_detail_table\" class=\"table table-thin table-bordered table-striped table-hover table-set\">\r\n");
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-5 notView\" style=\"vertical-align: middle;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button class=\"line6\" onclick=\"chooseComponent()\" style=\"padding:0px 6px;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-15\" style=\"display: none\" id=\"shjh_th\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">收货件号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Receipt P/N</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-15\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">序列号/批次号</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">是否质检</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Inspection</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t<tbody id=\"list\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr class=\"non-choice\"><td class=\"text-center\" colspan=\"10\">暂无数据 No data.</td></tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"text-right\">\r\n");
      out.write("\t\t\t\t\t\t<button id=\"saveBtn\" type=\"button\" class=\"btn btn-primary padding-top-1 padding-bottom-1\" onclick=\"save()\">\r\n");
      out.write("                     \t\t<div class=\"font-size-12\">保存</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9\">Save</div>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("                     \t<button id=\"submitBtn\" type=\"button\" class=\"btn btn-primary padding-top-1 padding-bottom-1\" onclick=\"takeEffect()\">\r\n");
      out.write("                     \t\t<div class=\"font-size-12\">提交</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9\">Submit</div>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("                     \t<button type=\"button\" class=\"btn btn-primary padding-top-1 padding-bottom-1\" onclick=\"javascript:goToMainPage()\">\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      out.write("\t<div class=\"modal fade\" id=\"oneKeyModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-16 line-height-18\">仓库</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9 \">Store</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"panel-body padding-top-0 padding-bottom-0\">\r\n");
      out.write("\t\t\t            \t<div class=\"col-lg-12 col-xs-12 padding-left-0 padding-right-0 margin-top-10\">\r\n");
      out.write("\t\t\t\t         \t\t<div class=\"col-lg-12 padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t         \t\t\t<div class=\"col-lg-11 col-sm-11 col-xs-11 padding-right-0\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<select class=\"form-control\" id=\"ck\" onchange=\"changeStoreByOnekey()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t         \t\t</div>\r\n");
      out.write("\t\t\t\t         \t\t\r\n");
      out.write("\t\t\t\t         \t\t<div class=\"col-lg-12 padding-left-0 padding-right-0 padding-top-10\">\r\n");
      out.write("\t\t\t\t         \t\t\t<div class=\"col-lg-11 col-sm-11 col-xs-11 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label class=\"col-lg-2 col-sm-2 col-xs-2 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">库位</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-10 col-sm-10 col-xs-10 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<select class=\"form-control\" id=\"kw\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t         \t\t</div>\r\n");
      out.write("\t\t\t\t         \t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- end:table -->\r\n");
      out.write("\t\t\t                \t<div class=\"text-right margin-top-10 margin-bottom-10 padding-right-0 col-lg-11\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" onclick=\"autoFillStore()\"\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/material/receipt/contract.js\"></script>\r\n");
      out.write("<div class=\"modal fade\" id=\"contractModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\r\n");
      out.write("\t<div class=\"modal-dialog modal-lg\">\r\n");
      out.write("\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t<div class=\"modal-body padding-bottom-0\">\r\n");
      out.write("\t\t\t  \t<div class=\"panel panel-primary\">\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-heading  padding-top-3 padding-bottom-1\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-16 line-height-18\">合同列表</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-9 \">Contract List</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-body padding-top-0 padding-bottom-0\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\" pull-right padding-left-0 padding-right-0 margin-top-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\" pull-left padding-left-0 padding-right-0\" style=\"width: 250px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder='合同号/合同编号/供应商编号/供应商名称' id=\"contract_keyword_search\" class=\"form-control \">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t                <div class=\" pull-right padding-left-5 padding-right-0 \">   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button name=\"keyCodeSearch\" type=\"button\" class=\" btn btn-primary padding-top-1 padding-bottom-1 \" onclick=\"contractModal.search()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">搜索</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Search</div>\r\n");
      out.write("\t\t\t                  \t\t</button>\r\n");
      out.write("\t\t\t\t                </div> \r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"overflow-auto\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<table class=\"table table-bordered table-striped table-hover text-center\" style=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t   \t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th width=\"50px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">选择</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">合同编号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Order No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">紧急程度</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Emergency</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">供应商编号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Supplier No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">供应商名称</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Supplier name</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">合同签订日期</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Date of signing</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">合同到货状态</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Arrival state</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t \t\t </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tbody id=\"contractlist\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-xs-12 text-center page-height padding-right-0 padding-left-0\" id=\"contract_pagination\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- end:table -->\r\n");
      out.write("\t\t                \t<div class=\"text-right margin-top-10 margin-bottom-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" onclick=\"contractModal.setContract()\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"btn btn-primary padding-top-1 padding-bottom-1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdata-dismiss=\"modal\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">确定</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Confirm</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" onclick=\"contractModal.clearUser()\" id=\"contractModal_btn_clear\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"btn btn-primary padding-top-1 padding-bottom-1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">清空</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Clear</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</button>\r\n");
      ...
      out.write("<script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/material/receipt/borrowApply.js\"></script>\r\n");
      out.write("<div class=\"modal fade\" id=\"borrowApplyModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\r\n");
      out.write("\t<div class=\"modal-dialog modal-lg\">\r\n");
      out.write("\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t<div class=\"modal-body padding-bottom-0\">\r\n");
      out.write("\t\t\t  \t<div class=\"panel panel-primary\">\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-heading  padding-top-3 padding-bottom-1\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-16 line-height-18\">借入申请列表</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-9 \">BorrowApply List</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-body padding-top-0 padding-bottom-0\">\r\n");
      out.write("\t\t            \t<div class=\"col-lg-12 col-xs-12 margin-top-10  padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t            \t\t<div class=\" pull-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t            \t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"pull-left padding-left-0 padding-right-0\" style=\"width: 250px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder='申请单号' id=\"borrowApply_keyword_search\" class=\"form-control \">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t                <div class=\"pull-right padding-left-5 padding-right-0 \">   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\" btn btn-primary padding-top-1 padding-bottom-1 \" onclick=\"borrowApplyModal.search()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">搜索</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Search</div>\r\n");
      out.write("\t\t\t                  \t\t</button>\r\n");
      out.write("\t\t\t\t                </div> \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">申请单号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Apply No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">申请人</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Applicant</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">申请日期</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Application Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">飞机注册号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">A/C REG</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">借调对象</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Seconded Obj</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t \t\t </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tbody id=\"borrowApplyList\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-xs-12 text-center page-height padding-right-0 padding-left-0\" id=\"borrowApply_pagination\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- end:table -->\r\n");
      out.write("\t\t                \t<div class=\"text-right margin-top-10 margin-bottom-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" onclick=\"borrowApplyModal.setContract()\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"btn btn-primary padding-top-1 padding-bottom-1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdata-dismiss=\"modal\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">确定</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Confirm</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" onclick=\"borrowApplyModal.clearUser()\" id=\"borrowApplyModal_btn_clear\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"btn btn-primary padding-top-1 padding-bottom-1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">清空</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Clear</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</button>\r\n");
      ...
      out.write("<script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/material/receipt/lendReturn.js\"></script>\r\n");
      out.write("<div class=\"modal fade\" id=\"lendReturnModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\r\n");
      out.write("\t<div class=\"modal-dialog modal-lg\">\r\n");
      out.write("\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t<div class=\"modal-body padding-bottom-0\">\r\n");
      out.write("\t\t\t  \t<div class=\"panel panel-primary\">\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-heading  padding-top-3 padding-bottom-1\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-16 line-height-18\">未归还统计数据列表</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-9 \">LendingReturn List</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-body padding-top-0 padding-bottom-0\">\r\n");
      out.write("\t\t            \t<div class=\"col-lg-12 col-xs-12 margin-top-10 padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t            \t\t<div class=\" pull-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t            \t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"pull-left padding-left-0 padding-right-0\" style=\"width: 250px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder='件号/中英文' id=\"lendReturn_keyword_search\" class=\"form-control \">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t                <div class=\"pull-right padding-left-5 padding-right-0 \">   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\" btn btn-primary padding-top-1 padding-bottom-1 \" onclick=\"lendReturnModal.search()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">搜索</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Search</div>\r\n");
      out.write("\t\t\t                  \t\t</button>\r\n");
      out.write("\t\t\t\t                </div> \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Airmaterial type</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">管理级别</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Management level</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">待还数量</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">To be return</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t \t\t </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tbody id=\"lendReturnList\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-xs-12 text-center page-height padding-right-0 padding-left-0\" id=\"lendReturn_pagination\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- end:table -->\r\n");
      out.write("\t\t                \t<div class=\"text-right margin-top-10 margin-bottom-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" onclick=\"lendReturnModal.setContract()\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"btn btn-primary padding-top-1 padding-bottom-1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdata-dismiss=\"modal\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">确定</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Confirm</div>\r\n");
      ...
      out.write("<script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/material/receipt/receipt_component.js\"></script>\r\n");
      out.write("<div class=\"modal fade\" id=\"componentModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\r\n");
      out.write("\t<div class=\"modal-dialog modal-lg\">\r\n");
      out.write("\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t<div class=\"modal-body padding-bottom-0\">\r\n");
      out.write("\t\t\t  \t<div class=\"panel panel-primary\">\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-heading  padding-top-3 padding-bottom-1\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-16 line-height-18\">部件列表</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-9 \">Component List</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"panel-body padding-top-0 padding-bottom-0\">\r\n");
      out.write("\t\t            \t<div class=\"col-lg-12 col-xs-12 margin-top-10 padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t            \t\t<div class=\" pull-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t            \t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"pull-left padding-left-0 padding-right-0\" style=\"width: 250px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder='件号' id=\"component_keyword_search\" class=\"form-control \">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t                <div class=\"pull-right padding-left-5 padding-right-0 \">   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\" btn btn-primary padding-top-1 padding-bottom-1 \" onclick=\"componentModal.search()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">搜索</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Search</div>\r\n");
      out.write("\t\t\t                  \t\t</button>\r\n");
      out.write("\t\t\t\t                </div> \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">类型</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Type</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">数量</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Number</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">计量单位</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Unit</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t \t\t </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tbody id=\"componentList\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-xs-12 text-center page-height padding-right-0 padding-left-0\" id=\"component_pagination\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- end:table -->\r\n");
      out.write("\t\t                \t<div class=\"text-right margin-top-10 margin-bottom-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" onclick=\"componentModal.setContract()\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"btn btn-primary padding-top-1 padding-bottom-1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdata-dismiss=\"modal\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">确定</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Confirm</div>\r\n");
      ...
      out.write("\t<script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/material/receipt/receipt_detail.js\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
