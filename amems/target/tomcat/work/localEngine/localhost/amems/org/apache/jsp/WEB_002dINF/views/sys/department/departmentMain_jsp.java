...
public final class departmentMain_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<a href=\"#\" data-toggle=\"modal\" class=\"btn btn-primary padding-top-1 padding-bottom-1 pull-left checkPermission\" permissioncode='sys:department:main:01'  onclick=\"add()\">\r\n");
      ...
      out.write("\t\t\t\t    <div class=\" pull-left padding-left-5 padding-right-0 row-height\" style=\"width: 250px;\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" placeholder='组织机构代码/组织机构名称' id=\"keyword_search\" class=\"form-control \">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("                    <div class=\" pull-right padding-left-5 padding-right-0 \">   \r\n");
      out.write("\t\t\t\t\t\t<button id=\"departmentMainSearch\" type=\"button\" class=\" btn btn-primary padding-top-1 padding-bottom-1\" onclick=\"searchRevision();\">\r\n");
      ...
      out.write("               <div class=\"clearfix\"></div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-12 col-md-12 padding-left-0 padding-right-0 table-h\" style=\"margin-top: 10px;\">\r\n");
      out.write("\t\t\t\t\t\t<table\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10 sorting\" style=\"vertical-align: middle;\"  onclick=\"orderBy('dprtcode')\" id=\"dprtcode_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   <div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t     \t <div class=\"font-size-12 line-height-18\">组织机构代码</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t <div class=\"font-size-9 line-height-18\">Organization Code</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t \t</div> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10 sorting\" style=\"vertical-align: middle;\"  onclick=\"orderBy('dprtname')\" id=\"dprtname_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   <div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">组织机构名称</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Organization Name</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-7 sorting\" style=\"vertical-align: middle;\" onclick=\"orderBy('zczh_max')\" id=\"zczh_max_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <div class=\"font-size-12 line-height-18\">最大用户注册数量</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t <div class=\"font-size-9 line-height-18\">Max Users Reg</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-7 sorting\" style=\"vertical-align: middle;\"  onclick=\"orderBy('zcfj_max')\" id=\"zcfj_max_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <div class=\"font-size-12 line-height-18\">最大飞机注册数量</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t <div class=\"font-size-9 line-height-18\">Max Plane Reg</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-7 sorting\" style=\"vertical-align: middle;\"  onclick=\"orderBy('yxqks')\" id=\"yxqks_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <div class=\"font-size-12 line-height-18\">开始日期</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t <div class=\"font-size-9 line-height-18\">Start Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-7 sorting\" style=\"vertical-align: middle;\"  onclick=\"orderBy('yxqjs')\" id=\"yxqjs_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <div class=\"font-size-12 line-height-18\">结束日期</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t <div class=\"font-size-9 line-height-18\">End Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-15 sorting\" style=\"vertical-align: middle;\"  onclick=\"orderBy('remark')\" id=\"remark_order\">\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/sys/department/department.js\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>\r\n");
    } catch (Throwable t) {
