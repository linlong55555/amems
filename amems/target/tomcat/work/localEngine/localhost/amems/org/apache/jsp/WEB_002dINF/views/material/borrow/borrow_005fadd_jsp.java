package org.apache.jsp.WEB_002dINF.views.material.borrow;
...
public final class borrow_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
...
static {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\" readonly />\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"form-control\" type=\"hidden\"  id=\"sqrid\" value=\"");
      ...
      out.write("\" readonly />\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"form-control\" type=\"hidden\"  id=\"sqdwid\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"date-picker form-control\" id=\"sqsj\" name=\"sqsj\" data-date-format=\"yyyy-mm-dd\" type=\"text\" readonly/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\"><span style=\"color: red\">*</span>借调对象类型</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">S/O Type</div>\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<select class='form-control' id='jddxlx'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tname=\"jddxlx\" onchange=\"changeSelected(this)\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"\">请选择 Choice</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t<div class=\"col-lg-3 col-sm-6 col-xs-12  padding-left-0 padding-right-0 margin-bottom-10 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-4 col-sm-4 col-xs-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\"><span style=\"color: red\">*</span>借调对象</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Seconded Obj</div>\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<select class='form-control' id='jddx' name=\"jddx\" onchange=\"changesel()\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"\">请选择 Choice</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-1 col-sm-2 col-xs-4 text-right padding-left-0 padding-right-0  form-group\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<textarea class=\"form-control\" id=\"bz\" name=\"bz\" maxlength=\"300\" placeholder=\"长度最大为300\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      ...
      out.write("\t\t\t\t\t \t\t<button id=\"btnGoAdd\"  class=\"btn btn-xs btn-primary margin-left-10 float_an2\" onclick=\"javascript:openMaterialWinAdd()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<i class=\" cursor-pointer\">选择航材</i>\r\n");
      out.write("\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t   \t\t    <button  style=\"display: none;\" id=\"btnGoAdd1\"  class=\"btn btn-xs btn-primary margin-left-10 float_an3\" onclick=\"javascript:openotherStockAdd()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<i class=\" cursor-pointer\">选择库存</i>\r\n");
      out.write("\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<div class=\" pull-left margin-right-10\" >\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-16 line-height-18\">借入航材</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9 \">Borrowed Aircraft</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t            \t<div class=\"col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 margin-bottom-10\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<table class=\"table table-bordered table-striped table-hover table-set\" style=\"min-width:1500px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t   \t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">序列号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">S/N</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">批次号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">P/N</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">借入数量</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Borrowed Num</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-5\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">用途</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Use</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t \t\t </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</thead>\r\n");
      ...
      out.write("\t\t<!-- 基本信息 End -->\r\n");
      out.write("        \r\n");
      out.write("    <!-------其他飞行队对话框 Start-------->\r\n");
      out.write("\t<div class=\"modal fade\" id=\"alertModalotherStockAdd\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-16 line-height-18\" id=\"otherStockModel\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9 \">Aircraft List</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\" pull-left padding-left-5 padding-right-0\" style=\"width: 260px;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\" col-xs-8 col-sm-8 padding-left-8 padding-right-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<select class='form-control' id='other_hclx_search' onchange=\"searchotherStockAdd()\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder='件号/中英文/厂家件号' id=\"keyword_otherStock_search\" class=\"form-control \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t                    <div class=\" pull-right padding-left-5 padding-right-0 \">   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button name=\"keyCodeSearch\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t type=\"button\" class=\" btn btn-primary padding-top-1 padding-bottom-1 \" onclick=\"searchotherStockAdd()\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<!-- start:table -->\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"margin-top-10 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-12 col-md-12 padding-left-0 padding-right-0\" style=\"overflow:auto;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<table id=\"otherStockAddTable\" class=\"table table-bordered table-striped table-hover table-set\"  style=\"min-width:1500px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   \t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-5 fixed-column\" style=\"vertical-align: middle;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"javascript:checkAll();\" class=\"pull-left margin-left-10 margin-bottom-10\" id='CancelAll' ><img src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">P/N</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-8\">\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">件号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">P/N</div></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-20\">\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">中文名称</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">CH.Name</div></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-20\">\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">英文名称</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">F.Name</div></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-8\">\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">厂家件号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">MP/N</div></div>\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">航材类型</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Airmaterial type</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">航材管理级别</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Aircraft Level</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">序列号/批次号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Aircraft Type</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">库存数量</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Stock Num</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">货架寿命</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 notwrap\">Stock Num</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 notwrap\">单位</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t \t\t </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tbody id=\"otherStockAdd\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-xs-12 text-center\" id=\"otherStockAddPagination\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- end:table -->\r\n");
      out.write("\t\t\t                \t<div class=\"text-right margin-top-10 margin-bottom-10\">\r\n");
      out.write("\t\t                \t\t\t<button type=\"button\" onclick=\"setData()\"\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/material/borrow/borrow_add.js\"></script>\r\n");
      out.write("\t");
      out.write("\r\n");
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      ...
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/common/openotherStockAdd.js\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/material/borrow/borrow_add.jsp(61,12) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/material/borrow/borrow_add.jsp(61,12) '${secondmenttype}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${secondmenttype}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/views/material/borrow/borrow_add.jsp(61,12) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("plans");
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${plans.id}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write('"');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${erayFns:escapeStr(plans.name)}", java.lang.String.class, (PageContext)_jspx_page_context, _jspx_fnmap_0, false));
          out.write("</option>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/material/borrow/borrow_add.jsp(237,12) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/material/borrow/borrow_add.jsp(237,12) '${materialTypeEnum}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${materialTypeEnum}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/views/material/borrow/borrow_add.jsp(237,12) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write(' ');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${erayFns:escapeStr(item.name)}", java.lang.String.class, (PageContext)_jspx_page_context, _jspx_fnmap_0, false));
          out.write("</option>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /WEB-INF/views/material/borrow/borrow_add.jsp(238,40) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${100 == item.id }", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
