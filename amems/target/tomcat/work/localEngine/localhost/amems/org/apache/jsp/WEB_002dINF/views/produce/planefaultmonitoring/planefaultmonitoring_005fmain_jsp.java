package org.apache.jsp.WEB_002dINF.views.produce.planefaultmonitoring;
...
public final class planefaultmonitoring_005fmain_jsp extends org.apache.jasper.runtime.HttpJspBase
...
static {
  ...
  static {
    ...
    _jspx_dependants.add("/WEB-INF/views/produce/planefaultmonitoring/planefaultmonitoring_mainone.jsp");
    _jspx_dependants.add("/WEB-INF/views/produce/planefaultmonitoring/planefaultmonitoring_mainone_open.jsp");
    _jspx_dependants.add("/WEB-INF/views/common/attachments/attachments_list_edit_common.jsp");
    _jspx_dependants.add("/WEB-INF/views/produce/planefaultmonitoring/hbh.jsp");
    _jspx_dependants.add("/WEB-INF/views/produce/planefaultmonitoring/zlh.jsp");
    _jspx_dependants.add("/WEB-INF/views/open_win/log.jsp");
    _jspx_dependants.add("/WEB-INF/views/open_win/logDiff.jsp");
    _jspx_dependants.add("/WEB-INF/views/produce/planefaultmonitoring/planefaultmonitoring_open.jsp");
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<a href=\"javascript:Planefaultmonitoring_Add_Modal.open();\"  class=\"btn btn-primary padding-top-1 padding-bottom-1 pull-left  checkPermission\" permissioncode='produce:fault:monitoring:main:01'>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12\">新增</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9\">Add</div>\r\n");
      out.write("\t\t\t\t\t\t</a>\r\n");
      out.write("<!-- \t\t\t\t\t\t<a href=\"javascript:exportExcel();\"  class=\"btn btn-primary padding-top-1 margin-left-10  padding-bottom-1 pull-left row-height \" > -->\r\n");
      ...
      out.write("\t\t\t\t\t\t\t <select class='form-control' id='fjzch' name=\"fjzch\" onchange=\"searchFjgzRecord();\">\r\n");
      out.write("\t\t\t\t\t\t\t </select>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<!-- 搜索框start -->\r\n");
      ...
      out.write("\t\t\t\t\t\t<!-- 搜索框start -->\r\n");
      out.write("\t\t\t\t\t\t<div class=\" col-xs-12 input-group input-group-search row-height\">\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t     <input type=\"text\" placeholder='飞机注册号/故障信息'  id=\"keyword\" class=\"form-control \">\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<select id=\"dprtcode\" class=\"form-control \" name=\"dprtcode\" onchange=\"changeDpr();\">\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t<!-- 表格 -->\r\n");
      out.write("\t\t\t\t<div class=\"col-lg-12 col-md-12 padding-left-0 padding-right-0 margin-top-0 table-height\" c-height=\"35%\" id=\"tableId\" style=\"overflow-x: auto;\">\r\n");
      out.write("\t\t\t\t\t<table  id=\"fjgz_record_sheet_table\" class=\"table table-thin table-bordered table-striped table-hover table-set\">\r\n");
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-20 sorting\" onclick=\"orderBy('zjh')\" id=\"zjh_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">章节号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">ATA</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-20 sorting\" onclick=\"orderBy('gzxx')\" id=\"gzxx_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">故障信息</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Fault info</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10  sorting\" onclick=\"orderBy('gzcs')\" id=\"gzcs_order\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">故障次数</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Failure times</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-9 sorting\" onclick=\"orderBy('zjfsrq')\" id=\"zjfsrq_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">最近发生日期</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Latest date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-5 sorting\" onclick=\"orderBy('gbzt')\" id=\"gbzt_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">状态</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Status</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13 cursor-pointer\" onclick=\"vieworhideZjqkContent()\" name=\"fj\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">附件</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Attachment</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-20 sorting\" onclick=\"orderBy('bz')\" id=\"bz_order\">\r\n");
      ...
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t<div class=\"col-xs-12 text-center page-height padding-right-0 padding-left-0\" id=\"fjgzjk_pagination\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class='clearfix'></div>\r\n");
      out.write("\t\t\t</div>\t\r\n");
      out.write("\t\t\t");
      ...
      out.write("\t\t\t <div class=\"font-size-12 line-height-12\">故障处理记录</div>\r\n");
      out.write("\t\t\t <div class=\"font-size-9 line-height-9\">Fault handling record</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!--标题EDG  -->\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<div class=\"panel-body  padding-bottom-0\" >\r\n");
      out.write("\t\t\t<div class=\" col-lg-3 col-md-12 col-sm-12 col-xs-12   padding-left-0 padding-right-0  form-group \" id=\"addBtn\">\r\n");
      out.write("\t\t\t\t<a href=\"javascript:Fault_Handling_Record_Open_Modal.show(1);\"  class=\"btn btn-primary padding-top-1 padding-bottom-1 pull-left row-height checkPermission\" permissioncode='produce:fault:monitoring:main:04'>\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-12\">新增</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-9\">Add</div>\r\n");
      out.write("\t\t\t\t</a>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th class=\"colwidth-7 \" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">航班号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Flight No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th class=\"colwidth-9 \">\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">排故思路</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Troubleshooting</div>\r\n");
      out.write("\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th class=\"colwidth-11 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">处理结果</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Result</div>\r\n");
      out.write("\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th class=\"colwidth-11 \" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">指令号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Instruction No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th class=\"colwidth-11 \" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">拆下</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Remove</div>\r\n");
      out.write("\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th class=\"colwidth-11 \" >\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">装上</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Mount</div>\r\n");
      out.write("\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th class=\"colwidth-11 \" >\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">备注</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Remark</div>\r\n");
      ...
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/produce/planefaultmonitoring/planefaultmonitoring_mainone.js\"></script>\r\n");
      out.write("\r\n");
      out.write("<div class=\"modal fade in modal-new\" id=\"Fault_Handling_Record_Modal\" tabindex=\"-1\" role=\"dialog\" aria-hidden=\"true\" data-keyboard=\"false\" aria-labelledby=\"Assessment_Open_Modal\" data-backdrop=\"static\" >\r\n");
      out.write("\t<div class=\"modal-dialog\" style='width:85%;'>\r\n");
      out.write("\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t<div class=\"modal-header modal-header-new\" >\r\n");
      out.write("\t\t\t\t<h4 class=\"modal-title\" >\r\n");
      out.write("                \t<div class='pull-left'>\r\n");
      out.write("                    \t<div class=\"font-size-12 \" id=\"modalNameFault\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-9 \" id=\"modalEnameFault\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t  \t<div class='pull-right' >\r\n");
      ...
      out.write("\t\t\t\t\t<input type=\"hidden\" id=\"dprtId\" />\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" id=\"fjzchid\" />\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<form id=\"monitoringForm_bottom\" >\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"required\" style=\"color: red\">*</label>航班号\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Flight No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"input-group\" style=\"width: 100%\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\"  name=\"fxjldid\"  id=\"fxjldid\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\"  name=\"hbh\" class=\"form-control noteditable\" id=\"hbh\" ondblclick='Fault_Handling_Record_Open_Modal.openHb();'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span class=\"required input-group-btn\" id=\"wxrybtn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<button id=\"hbbtn\" type=\"button\" class=\"btn btn-default form-control\"  style='height:34px;' data-toggle=\"modal\" onclick=\"Fault_Handling_Record_Open_Modal.openHb()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"icon-search cursor-pointer\" ></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t                \t</div>\r\n");
      ...
      out.write("\t\t           \t\t\t\t<div class=\"col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">航班日期</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Flight Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\"  id=\"hbrq\" name=\"hbrq\" class=\"noteditable form-control padding-left-3 padding-right-3 date-picker\" data-date-format=\"yyyy-mm-dd\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("           \t\t\t\t\t\t<div class=\"col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-md-3 col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Instruction No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-md-9 col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"input-group\" style=\"width: 100%\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\"  name=\"zlhid\"  id=\"zlhid\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\"  name=\"zlh\" id=\"zlh\" class=\"form-control noteditable \"   ondblclick='Fault_Handling_Record_Open_Modal.openZlh();'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span class=\"required input-group-btn\" id=\"wxrybtn\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default form-control\"  style='height:34px;' data-toggle=\"modal\" onclick=\"Fault_Handling_Record_Open_Modal.openZlh()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"icon-search cursor-pointer\" ></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t                \t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class='clearfix'></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-xs-12 col-sm-12  padding-left-0 padding-right-0\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-1 col-md-1 col-sm-2 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">拆下</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Remove</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<textarea style=\"height:55px\" class=\"noteditable form-control padding-left-3 padding-right-3\" id=\"cxjxx\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t           \t\t\t\t<div class=\"col-xs-12 col-sm-12  padding-left-0 padding-right-0 margin-top-8\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-1 col-md-1 col-sm-2 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 margin-topnew-2\">装上</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Mount</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<textarea style=\"height:55px\" class=\"noteditable form-control padding-left-3 padding-right-3\" id=\"zsjxx\" ></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t \t\t<div class=\"col-xs-12 col-sm-12  padding-left-0 padding-right-0 margin-top-8\" >\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t排故思路\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Troubleshooting Thinking</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<textarea  style=\"height:55px\" class=\"noteditable form-control padding-left-3 padding-right-3\" id=\"pgsl\" name=\"pgsl\"   maxlength=\"300\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t \t \t\t <div class=\"col-xs-12 col-sm-12  padding-left-0 padding-right-0 margin-top-8\" >\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<textarea  style=\"height:55px\" class=\"noteditable form-control padding-left-3 padding-right-3\" id=\"cljg\" name=\"cljg\"   maxlength=\"300\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t </div>\r\n");
      out.write("\t\t\t\t\t \t \t\t <div class=\"col-xs-12 col-sm-12  padding-left-0 padding-right-0 margin-top-8 margin-bottom-8\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-1 col-md-1 col-sm-2 col-xs-3 text-right padding-left-0 padding-right-0 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t备注\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<textarea  style=\"height:55px\" class=\"noteditable form-control padding-left-3 padding-right-3\" id=\"bz\" name=\"bz\"   maxlength=\"300\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class='clearfix'></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t\t\t<!--参考文件END  -->\t\t\r\n");
      out.write("\t\t\t\t\t\t<div id=\"attachments_list_edit_handing\" style=\"display:none\">\r\n");
      out.write("\t\t\t\t\t\t\t");
      out.write("\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t\t\t</span>\r\n");
      out.write("\t                    <span class=\"input-group-addon modalfooterbtn\">\r\n");
      out.write("\t\t\t\t\t\t   \t<button id=\"baocuns\" type=\"button\" onclick=\"Fault_Handling_Record_Add_Modal.save();\" class=\"btn btn-primary padding-top-1 padding-bottom-1\">\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<div class=\"modal modal-new active in\" id=\"alertModalHb\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"alertModalHb\" aria-hidden=\"true\">\r\n");
      out.write("\t<div class=\"modal-dialog\" >\r\n");
      out.write("\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t<div class=\"modal-header modal-header-new\">\r\n");
      out.write("\t\t\t\t<h4 class=\"modal-title\">\r\n");
      out.write("\t               \t<div class=\"pull-left\">\r\n");
      out.write("\t                   \t<div class=\"font-size-12 \">航班信息</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-9 \">Flight Info</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t  \t<div class=\"pull-right\">\r\n");
      out.write("\t\t  \t\t  \t\t<button type=\"button\" class=\"icon-remove modal-close\" data-dismiss=\"modal\" aria-label=\"Close\"></button>\r\n");
      out.write("\t\t  \t\t  \t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t   <input type=\"text\" placeholder=\"航班号\" id=\"keyword_search\" class=\"form-control \">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t                     \t<div class=\" pull-right padding-left-5 padding-right-0 \">   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button name=\"keyCodeSearch\" type=\"button\" class=\" btn btn-primary padding-top-1 padding-bottom-1\" onclick=\"hbModal.search();\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">搜索</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Search</div>\r\n");
      out.write("\t\t\t                   \t\t</button>\r\n");
      out.write("\t\t\t               \t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Flight Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">航班号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Flight No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">任务类型</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Flight No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">起飞站</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Flight No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">着陆站</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Flight No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">开车</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Flight No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">起飞</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Flight No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">落地</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Flight No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">停车</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Flight No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">飞行记录号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Flight No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"colwidth-10\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</tr> \r\n");
      out.write("\t\t\t\t         \t\t </thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t <tbody id=\"Hblist\">\r\n");
      out.write("\t\t\t\t\t\t\t\t </tbody>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-xs-12 text-center\" id=\"hbpagination\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<!-- end:table -->\r\n");
      out.write("\t\t\t     \t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t \t </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t</span>\r\n");
      out.write("\t                    <span class=\"input-group-addon modalfooterbtn\">\r\n");
      out.write("\t\t                   \t\t<button type=\"button\" onclick=\"hbModal.setUser()\" class=\"btn btn-primary padding-top-1 padding-bottom-1\" data-dismiss=\"modal\">\r\n");
      ...
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/produce/planefaultmonitoring/hbh.js\"></script><!--  -->");
      out.write("  <!--航班号jsp  -->\t\t\r\n");
      out.write("\r\n");
      out.write("<div class=\"modal fade modal-new in active\" id=\"alertModalZl\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\r\n");
      out.write("<div class=\"modal-dialog\" >\r\n");
      out.write("\t<div class=\"modal-content\">\r\n");
      out.write("\t\t<div class=\"modal-header modal-header-new\">\r\n");
      out.write("\t\t\t<h4 class=\"modal-title\">\r\n");
      out.write("\t            <div class=\"pull-left\">\r\n");
      out.write("\t                <div class=\"font-size-12\">工单信息</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"font-size-9\">Instruction info</div>\r\n");
      out.write("\t\t  \t\t</div>\r\n");
      out.write("\t\t  \t\t<div class=\"pull-right\">\r\n");
      out.write("\t\t\t\t  \t<button type=\"button\" class=\"icon-remove modal-close\" data-dismiss=\"modal\" aria-label=\"Close\"></button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("            </h4>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"modal-body padding-bottom-0 margin-top-10\" >\r\n");
      out.write("\t\t\t<div class=\"panel panel-primary\">\r\n");
      out.write("\t\t\t\t<div class=\"panel-body padding-top-0 padding-bottom-0\">\r\n");
      out.write("\t\t\t\t\t   <div  class=\"col-xs-12 margin-top-0  padding-right-0\" >\r\n");
      out.write("\t\t\t\t\t\t   <div class=\" pull-right padding-left-0 padding-right-0 margin-top-10 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t     <div class=\" pull-left padding-left-0 padding-right-0 \" style=\"width:250px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t   <input type=\"text\" placeholder=\"工单编号\" id=\"keyword_search1\" class=\"form-control \">\r\n");
      out.write("\t\t\t\t\t\t\t\t   <input type=\"hidden\" id=\"gdid\">\r\n");
      out.write("\t\t\t                       </div>\r\n");
      out.write("\t\t\t                       \r\n");
      out.write("\t\t\t                      <div class=\" pull-right padding-left-5 padding-right-0 \">   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button name=\"keyCodeSearch\" type=\"button\" class=\" btn btn-primary padding-top-1 padding-bottom-1\" onclick=\"alertModalZl.search()();\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">搜索</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Search</div>\r\n");
      out.write("\t\t\t                   \t\t</button>\r\n");
      out.write("\t\t\t                     </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<table class=\"table-set table table-thin table-bordered table-striped table-hover \" style='margin-bottom:0px !important;'>\r\n");
      out.write("\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-3\"><div class=\"font-size-12 line-height-18\" >序号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\" >No.</div></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">工单编号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Instruction No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13\">\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">来源分类</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Type</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13\">\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">工单主题</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Title</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13\">\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">任务号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-15\">\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">制单日期</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-15\">\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">计划结束日期</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">End Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"colwidth-13\">\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">状态</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-16\">Status</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr> \r\n");
      out.write("\t\t\t\t         \t\t </thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tbody id=\"zlhlist\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-xs-12 text-center\" id=\"zlhpagination\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0 form-group \" style='border-top:1px solid #d5d5d5;margin-top:5px;padding-top:8px;'>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-xs-12 input-group\">\r\n");
      out.write("\t\t\t\t\t\t\t       <div class=\"input-group-addon\" style='background:none;width:50px;padding-right:8px;color:#333;border:0px;text-align:right'>\r\n");
      out.write("\t\t\t\t                       <div class=\"font-size-12 margin-topnew-2\">工单编号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   <div class=\"font-size-9 line-height-9\">W/O No.</div>\r\n");
      out.write("\t\t\t\t                    </div>\r\n");
      out.write("\t\t\t\t                    <input class=\"form-control\" id=\"alertModalZl_selectzlh\" type=\"text\"  />\r\n");
      out.write("\t\t                       </div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t     \t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t \t </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t</span>\r\n");
      out.write("\t                    <span class=\"input-group-addon modalfooterbtn\">\r\n");
      out.write("\t\t                   \t\t<button type=\"button\" onclick=\"alertModalZl.setData()\" class=\"btn btn-primary padding-top-1 padding-bottom-1\" data-dismiss=\"modal\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">确定</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Confirm</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary padding-top-1 padding-bottom-1\" data-dismiss=\"modal\">\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/produce/planefaultmonitoring/zlh.js\"></script><!--  -->\r\n");
      out.write("  <!--指令号jsp  -->\t\t\r\n");
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/produce/planefaultmonitoring/planefaultmonitoring_mainone_open.js\"></script><!--评估单弹窗的js  -->\r\n");
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/produce/planefaultmonitoring/planefaultmonitoring_mainone_add.js\"></script><!--新增评估单弹窗的js  -->\r\n");
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/produce/planefaultmonitoring/planefaultmonitoring_mainone_update.js\"></script><!--新增评估单弹窗的js  -->\r\n");
      out.write(" <!--新增编辑界面  -->");
      out.write("  <!--故障处理记录  -->\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\t\r\n");
      out.write("\t<!-- 关闭对话框start -->\r\n");
      out.write("\t<div class=\"modal fade modal-new\" id=\"alertModalFjgzjk\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\r\n");
      out.write("\t\t<div class=\"modal-dialog\" style=\"width:550px!important;\">\r\n");
      out.write("\t\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t\t<div class=\"modal-header modal-header-new\">\r\n");
      out.write("\t\t\t\t\t<h4 class=\"modal-title\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"pull-left\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-14 \"><span id=\"modalName\">关闭</span></div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12\"><span id=\"modalEname\">Close</span></div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t <div class=\"pull-right\">\r\n");
      out.write("\t\t\t\t\t\t \t<button type=\"button\" class=\"icon-remove modal-close\" data-dismiss=\"modal\" aria-label=\"Close\"></button>\r\n");
      out.write("\t\t\t\t\t\t </div>\r\n");
      ...
      out.write("\t                </h4>\r\n");
      out.write("\t            </div>\r\n");
      out.write("\t\t\t\t<div class=\"modal-body margin-top-10 padding-bottom-0\" id=\"alertModalStoreBody\">\r\n");
      out.write("\t\t\t\t\t<div class=\"panel panel-primary\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"panel-body padding-top-0 padding-bottom-0\" >\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-12 col-xs-12 col-sm-12 padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input id=\"gbyyid\" type=\"hidden\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-xs-12 col-sm-12 col-lg-12 padding-right-0 padding-left-0 margin-top-10 margin-bottom-10 \">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"gbrname\" readonly=\"readonly\" class=\"form-control \" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div> \r\n");
      out.write("\t\t\t\t\t\t\t\t<div id=\"gb\" class=\"col-xs-12 col-sm-12 col-lg-12 padding-right-0 padding-left-0  margin-bottom-10 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"pull-left col-lg-2 col-xs-2 col-sm-2 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">关闭时间</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-10 col-sm-10 col-xs-10 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"gbsj\" readonly=\"readonly\" class=\"form-control\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div> \r\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-lg-2 col-sm-2 col-xs-2 text-right padding-left-0 padding-right-0 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\"><span style=\"color: red\" id=\"gbyymark\">*</span>关闭原因</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Reason</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-10 col-sm-10 col-xs-10 padding-left-8 padding-right-0 margin-bottom-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<textarea class=\"form-control\" id=\"gbyy\"    maxlength=\"150\" ></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div> \r\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"input-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"input-group-addon modalfootertip\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<i class=\"glyphicon glyphicon-info-sign alert-info\" style=\"display: none;\"></i><p class=\"alert-info-message\" title=\"\"></p>\r\n");
      out.write("\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"input-group-addon modalfooterbtn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button onclick=\"zdjsOver()\" id=\"qd\" class=\"btn btn-primary padding-top-1 padding-bottom-1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">确定</div>\r\n");
      ...
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/produce/planefaultmonitoring/planefaultmonitoring_main.js\"></script><!--当前js  -->\r\n");
      out.write("\r\n");
      out.write("<div class=\"modal fade in modal-new\" id=\"Planefaultmonitoring_Open_Modal\" tabindex=\"-1\" role=\"dialog\" aria-hidden=\"true\" data-keyboard=\"false\" aria-labelledby=\"Assessment_Open_Modal\" data-backdrop=\"static\">\r\n");
      ...
      out.write("\t\t    <div class=\"modal-body  \" >\r\n");
      out.write("\t           \t<div class=\"col-xs-12  \">\r\n");
      out.write(" \t\t\t\t\t<input type=\"hidden\" id=\"djid\"  />\r\n");
      out.write(" \t\t\t\t\t<input type=\"hidden\" id=\"dprtcode1\" />\r\n");
      out.write(" \t\t\t\t\t<form id=\"monitoringForm\" >\r\n");
      out.write("\t\t\t\t\t\t<!--保留数据  -->\r\n");
      out.write("\t\t\t\t\t\t<div class=\"panel-body padding-bottom-0 padding-left-0 padding-right-0  padding-top-0\">\t \r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"input-group-border margin-top-8 padding-left-0\">\r\n");
      out.write("\t\t\t           \t\t\t<div class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div id=\"Planefaultmonitoring_Open_Modal_fjzch_div\" class=\"col-lg-8 col-md-9 col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<select class=\"form-control\" name=\"fjzch\" id=\"Planefaultmonitoring_Open_Modal_fjzch\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class='clearfix'></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"input-group\" style=\"width: 100%\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input id=\"common_zjh_value\" type=\"hidden\" name=\"common_zjh_value\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\"  name=\"common_zjh_display\" class=\"form-control noteditable readonly-style\" id=\"common_zjh_display\" readonly=\"readonly\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span class=\"required input-group-btn\" id=\"common_zjh_btn\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default form-control\"  style='height:34px;' data-toggle=\"modal\" onclick=\"openChapterWin();\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"icon-search cursor-pointer\" ></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t                \t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<textarea  style=\"height:55px\" class=\"noteditable form-control padding-left-3 padding-right-3\" id=\"gzxx\" name=\"gzxx\"   maxlength=\"1300\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t </div>\r\n");
      out.write("\t\t\t\t\t \t \t\t <div class=\"col-xs-12 col-sm-12  padding-left-0 padding-right-0 \" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"col-lg-1 col-md-1 col-sm-2 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 \">Remark</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-11 col-md-11 col-sm-10 col-xs-9 padding-leftright-8 margin-top-8 margin-bottom-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<textarea  style=\"height:55px\" class=\"noteditable form-control padding-left-3 padding-right-3\" id=\"mbz\" name=\"mbz\"   maxlength=\"300\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class='clearfix'></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t<div class=\"clearfix\"></div>\r\n");
      out.write("\t\t\t\t\t<!--参考文件END  -->\t\t\r\n");
      out.write("\t\t\t\t\t<div id=\"attachments_list\" style=\"display:none\">\r\n");
      out.write("\t\t\t\t\t\t");
      out.write("\r\n");
      out.write("\t\r\n");
      out.write("\t\t<div id=\"attach_div\" class=\"panel panel-primary\">\r\n");
      ...
      out.write("\t\t\t\t\t\t</span>\r\n");
      out.write("\t                    <span class=\"input-group-addon modalfooterbtn\">\r\n");
      out.write("\t\t\t\t\t\t   \t<button id=\"baocuns\" type=\"button\" onclick=\"Planefaultmonitoring_Add_Modal.save();\" class=\"btn btn-primary padding-top-1 padding-bottom-1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">保存</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Save</div>\r\n");
      out.write("\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary padding-top-1 padding-bottom-1\" data-dismiss=\"modal\" >\r\n");
      ...
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/produce/planefaultmonitoring/planefaultmonitoring_open.js\"></script><!--飞机故障公用的js  -->\r\n");
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/produce/planefaultmonitoring/planefaultmonitoring_add.js\"></script><!--新增飞机故障弹窗的js  -->\r\n");
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/produce/planefaultmonitoring/planefaultmonitoring_update.js\"></script><!--修改飞机故障弹窗的js  -->\r\n");
      out.write(" <!--新增编辑界面  -->\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/produce/planefaultmonitoring/planefaultmonitoring_main.jsp(120,8) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/produce/planefaultmonitoring/planefaultmonitoring_main.jsp(120,8) '${accessDepartment}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${accessDepartment}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/views/produce/planefaultmonitoring/planefaultmonitoring_main.jsp(120,8) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/views/produce/planefaultmonitoring/planefaultmonitoring_main.jsp(121,36) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
