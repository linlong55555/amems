package org.apache.jsp.WEB_002dINF.views.material2.return_.apply;
...
static {
  ...
  static {
    ...
    _jspx_dependants.add("/WEB-INF/views/material2/return/apply/apply_open.jsp");
    _jspx_dependants.add("/WEB-INF/views/open_win/materialAndOutfield_modal.jsp");
    _jspx_dependants.add("/WEB-INF/views/open_win/outfield_modal_main.jsp");
    _jspx_dependants.add("/WEB-INF/views/open_win/material_modal_main.jsp");
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t$('#applyMainSearch').trigger('click'); //调用主列表页查询\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      ...
      out.write("\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary padding-top-1 padding-bottom-1\" onclick='applyOpen()'>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12\">退料日期</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<input type='text' id='tlrq_search' class='form-control' name='date-range-picker'/>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-3 col-md-6 col-sm-6 col-xs-12 padding-left-0 padding-right-0 margin-top-0 form-group\" >\r\n");
      out.write("\t\t\t\t\t    <div class='text-right'>\r\n");
      out.write("\t\t\t\t\t\t<label class=\"padding-left-5\" style=\"margin-top:6px;font-weight:normal;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input id=\"isSh1\" checked=\"checked\" style=\"vertical-align:text-bottom;\" type=\"checkbox\">&nbsp;待收货&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t<label class=\"padding-left-5\" style=\"margin-top:6px;font-weight:normal;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input id=\"isSh2\" style=\"vertical-align:text-bottom;\" type=\"checkbox\">&nbsp;已收货&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<!-- 搜索框start -->\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"text\" placeholder='部件号/部件名称/批次号/序列号/说明'  class=\"form-control\" id=\"keyword_search\" >\r\n");
      out.write("\t\t                    <div class=\"input-group-addon btn-searchnew\" >\r\n");
      out.write("\t\t                    \t<button id=\"applyMainSearch\" type=\"button\" class=\" btn btn-primary padding-top-1 padding-bottom-1\" onclick=\"applyMain.reload();\" style='margin-right:0px !important;'>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12\">部件来源</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9\">PN Origin</div>\r\n");
      out.write("\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-lg-8 col-sm-8 col-xs-8 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<select class='form-control' id=\"bjly_search\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<select class='form-control' id=\"fjzch_search\">\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<div class=\"col-xs-12 col-sm-6 col-lg-3  padding-left-0 padding-right-0 margin-bottom-10 \">\r\n");
      out.write("\t\t\t\t\t\t<span class=\"pull-left col-xs-4 col-sm-4 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12\">是否可用</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9\">Available</div>\r\n");
      out.write("\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-xs-8 col-sm-8 padding-left-8 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<select class='form-control' id=\"sfky_search\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"\">显示全部 All</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"0\">不可用</option>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th class='colwidth-9 sorting' onclick=\"orderBy('tlrq')\" id=\"tlrq_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\" >日期</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Date</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th class='colwidth-9 sorting' onclick=\"orderBy('whrid')\" id=\"whrid_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">退料人</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Retreating person</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th class='colwidth-9 sorting' onclick=\"orderBy('bjh')\" id=\"bjh_order\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t </div>\r\n");
      out.write("\t\t\t\t\t\t\t    </th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th class='colwidth-15 sorting' onclick=\"orderBy('bjmc')\" id=\"bjmc_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t <div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">部件名称</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">PN name</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th class='colwidth-9 sorting' onclick=\"orderBy('pch')\" id=\"pch_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t <div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">批次号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Batch No.</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t </div>\r\n");
      out.write("\t\t\t\t\t\t\t   </th>\r\n");
      out.write("\t\t\t\t\t\t\t   <th class='colwidth-9 sorting' onclick=\"orderBy('xlh')\" id=\"xlh_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t   <div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">序列号</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">SN</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t   </div>\r\n");
      out.write("\t\t\t\t\t\t\t   </th>\r\n");
      out.write("\t\t\t\t\t\t\t   <th class='colwidth-9 sorting' onclick=\"orderBy('bjly')\" id=\"bjly_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">部件来源</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Original</div>\r\n");
      out.write("\t\t\t\t\t\t\t   </th>\r\n");
      out.write("\t\t\t\t\t\t\t   <th class='colwidth-6 sorting'onclick=\"orderBy('tlsl')\" id=\"tlsl_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">退料数量</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Amount</div>\r\n");
      out.write("\t\t\t\t\t\t\t   </th>\r\n");
      out.write("\t\t\t\t\t\t\t   <th class='colwidth-7 sorting' onclick=\"orderBy('sfky')\" id=\"sfky_order\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">是否可用</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Avaliable</div>\r\n");
      out.write("\t\t\t\t\t\t\t   </th>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Instruction</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t   </th>\r\n");
      out.write("\t\t\t\t\t\t\t    <th class='colwidth-40 '>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">收货信息</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">Info </div>\r\n");
      out.write("\t\t\t\t\t\t\t   </th>\r\n");
      out.write("\t\t\t\t\t\t\t</tr> \r\n");
      out.write("\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t<tbody id=\"apply_list\"></tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"col-xs-12 text-center page-height padding-right-0 padding-left-0\" id=\"apply_pagination\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t   </div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t");
      out.write("\r\n");
      out.write("<div class=\"modal fade in modal-new\" id=\"apply_open_alert\" tabindex=\"-1\" role=\"dialog\"  aria-labelledby=\"apply_open_alert\" aria-hidden=\"true\" data-backdrop='static' data-keyboard= false>\r\n");
      out.write("      <div class=\"modal-dialog\" style='width:50%;'>\r\n");
      out.write("            <div class=\"modal-content\">\r\n");
      out.write("\t\t\t\t<div class=\"modal-header modal-header-new\" >\r\n");
      out.write("\t\t\t\t\t<h4 class=\"modal-title\" >\r\n");
      out.write("                       \t<div class='pull-left'>\r\n");
      out.write("                      \t\t<div class=\"font-size-14\" id=\"modalName\">退料登记</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12\" id=\"modalEname\">Registration</div>\r\n");
      out.write("\t\t\t\t  \t\t</div>\r\n");
      out.write("\t\t\t\t  \t\t<div class='pull-right' >\r\n");
      ...
      out.write("            \t<input type=\"hidden\" id=\"dprtcode\" >\r\n");
      out.write("            \t<input type=\"hidden\" id=\"rejectedMaterialId\" >\r\n");
      out.write("            \t<input type=\"hidden\" id=\"kcid\" >\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\"><span class='color-red'>*</span>退料日期</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9 \">Date</div>\r\n");
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t<input id=\"tlrq\" class=\"form-control date-picker\"   data-date-format=\"yyyy-mm-dd\" type=\"text\" name=\"tlrq\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t    <div class=\"col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">退料人</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9 \">Retreating</div>\r\n");
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t<input id=\"tlr\" class=\"form-control\" maxlength=\"16\" placeholder=\"\" type=\"text\" readonly>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t    <div class='clearfix'></div>\r\n");
      out.write("\t\t\t\t    <div class=\"col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\"><span class='color-red'>*</span>部件号</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9 \">PN</div>\r\n");
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"input-group \" style=\"width:100% !impotant;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input id=\"bjh\" name=\"bjh\" class=\"form-control\" onblur=\"loadMaterialData()\" type=\"text\">\r\n");
      out.write("\t\t                    \t<span id=\"\" class=\"input-group-addon btn btn-default\" onclick=\"loadMaterialAndOutfield()\">\r\n");
      ...
      out.write("\t\t\t\t     <div class=\"col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\"><span class='color-red'>*</span>部件名称</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9 \">PN name</div>\r\n");
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t<input id=\"bjmc\" name=\"bjmc\" class=\"form-control\" maxlength=\"199\" placeholder=\"\" type=\"text\" >\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t    </div>\t\r\n");
      out.write("\t\t\t\t    <div class='clearfix'></div>\r\n");
      out.write("\t\t\t\t    <div class=\"col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      ...
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t<input id=\"pch\" name=\"pch\" class=\"form-control\" maxlength=\"50\" placeholder=\"\" type=\"text\" >\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t    <div class=\"col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      ...
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t<input onblur=\"xlhChange()\" id=\"xlh\" name=\"xlh\" class=\"form-control\" maxlength=\"50\" placeholder=\"\" type=\"text\" >\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t    <div class='clearfix'></div>\r\n");
      out.write("\t\t\t\t    <div class=\"col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\"><span class='color-red'>*</span>退料数量</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9 \">Amount</div>\r\n");
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-8 col-xs-9 padding-leftright-8 \">\r\n");
      out.write("\t\t\t\t\t\t\t <div class=\"input-group\" style=\"width:100%;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input id=\"tlsl\" onblur=\"tlslChange()\" class=\"form-control\" name=\"tlsl\" type=\"text\" maxlength=\"12\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<input id=\"tlsl_hide\"  class=\"form-control\" type=\"hidden\" >\r\n");
      out.write("\t\t                    \t<span id=\"\" class=\"input-group-addon\" style='background:none;padding-top:0px;padding-bottom:0px;border:0px;'  onclick=\"\">\r\n");
      out.write("\t\t                    \t\t<select id=\"dw\" class='form-control' style='width:80px;border-left:0px;'>\r\n");
      out.write("\t\t                    \t\t<option>单位</option>\r\n");
      out.write("\t\t                    \t    </select>\r\n");
      out.write("\t\t                    \t</span>\r\n");
      out.write("\t\t\t\t            </div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t    <div class=\"col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\">是否可用</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9 \">Available</div>\r\n");
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class='text-left' style='height:34px;'>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"padding-left-5\" style=\"margin-top:6px;font-weight:normal;\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input value=\"1\" checked=\"checked\" style=\"vertical-align:text-bottom;\" type=\"radio\" name=\"sfky_radio\" >&nbsp;可用&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"padding-left-5\" style=\"margin-top:6px;font-weight:normal;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input value=\"0\" style=\"vertical-align:text-bottom;\" type=\"radio\" name=\"sfky_radio\" >&nbsp;不可用&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t    </div>\r\n");
      ...
      out.write("\t\t\t\t    <div class=\"col-sm-6 col-xs-12 padding-left-0 padding-right-0 form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"col-sm-4 col-xs-3 text-right padding-left-0 padding-right-0\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12  margin-topnew-2\"><span class='color-red'>*</span>部件来源</div>\r\n");
      ...
      out.write("\t\t                    \t<span id=\"\" class=\"input-group-addon\" style='background:none;padding-top:0px;padding-bottom:0px;border:0px;'  onclick=\"\">\r\n");
      out.write("\t\t                    \t\t<label class=\"padding-left-5\" style=\"margin-top:6px;font-weight:normal;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input onclick=\"fjzchHide()\" value=\"1\" checked=\"checked\" style=\"vertical-align:text-bottom;\" type=\"radio\" name=\"bjly_radio\" >&nbsp;库房&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"padding-left-5\" style=\"margin-top:6px;font-weight:normal;\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input onclick=\"fjzchHide()\" value=\"2\" style=\"vertical-align:text-bottom;\" type=\"radio\" name=\"bjly_radio\" >&nbsp;飞机&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t                    \t</span>\r\n");
      out.write("\t\t                    \t<select class='form-control' id=\"fjzch\" style=\"visibility: hidden;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-8 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t<select id=\"wllb\" class=\"form-control\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9 \">Instruction</div>\r\n");
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-10 col-xs-9 padding-leftright-8\">\r\n");
      out.write("\t\t\t\t\t\t\t<textarea class=\"form-control\" style=\"height:55px;\" id=\"sm\" maxlength=\"1300\" ></textarea>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t    </form>\r\n");
      out.write("\t\t\t\t    <div class='clearfix'></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t</span>\r\n");
      out.write("\t                    <span class=\"input-group-addon modalfooterbtn\">\r\n");
      out.write("\t                    \t<button id=\"save_btn\" type=\"button\" onclick=\"add(false);\" class=\"btn btn-primary padding-top-1 padding-bottom-1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12\">保存</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Save</div>\r\n");
      out.write("\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t<button id=\"submit_btn\" type=\"button\" onclick=\"add(true);\"  class=\"btn btn-primary padding-top-1 padding-bottom-1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-12\">提交并编写下一条</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Submit and write the next</div>\r\n");
      out.write("\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t                    </span>\r\n");
      out.write("\t               \t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/open_win/materialAndOutfield_modal.js\"></script>\r\n");
      out.write("<!-- 飞机注册号选择 -->\r\n");
      out.write("<div class=\"modal fade modal-new\" id=\"open_win_materialAndOutfield\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"open_win_installationlist_removed\" aria-hidden=\"true\" data-backdrop=\"static\">\r\n");
      out.write("\t<div class=\"modal-dialog\" style=\"width:60%;\">\r\n");
      out.write("\t\t<div class=\"modal-content\">\t\r\n");
      out.write("\t                <div class=\"modal-header modal-header-new\">\r\n");
      out.write("                       <h4 class=\"modal-title\">\r\n");
      out.write("                          <div class=\"pull-left\">\r\n");
      out.write("\t                       <div class=\"font-size-12 \">航材查询</div>\r\n");
      ...
      out.write("\t\t            \t <div class=\"col-lg-12 col-xs-12 padding-left-0 padding-right-0 margin-top-10\" style='margin-bottom:10px;'>\r\n");
      out.write("\t\t                \t<ul id=\"myTab\" class=\"nav nav-tabs tabNew-style\">\r\n");
      out.write("\t\t                      \t<li class=\"active\">\r\n");
      out.write("\t\t                      \t<a href=\"#outfield\"  onclick=\"materialAndOutfield.yqChange(true)\" data-toggle=\"tab\" aria-expanded=\"false\">\r\n");
      out.write("\t\t                      \t\t<div class=\"font-size-12 line-height-12\">外场列表</div>\r\n");
      out.write("\t\t\t\t\t                <div class=\"font-size-9 line-height-9\">Outfield List</div>\r\n");
      out.write("\t\t                      \t</a>\r\n");
      out.write("\t\t                      \t</li>\r\n");
      out.write("\t\t                      \t<li class=\"\">\r\n");
      out.write("\t\t                      \t<a href=\"#material\" onclick=\"materialAndOutfield.yqChange(false)\" data-toggle=\"tab\" aria-expanded=\"false\">\r\n");
      out.write("\t\t                      \t\t<div class=\"font-size-12 line-height-12\">航材列表</div>\r\n");
      out.write("\t\t\t\t\t                <div class=\"font-size-9 line-height-9\">Material List</div>\r\n");
      out.write("\t\t\t\t\t             </a>\r\n");
      out.write("\t\t                      \t</li>\r\n");
      ...
      out.write("\t\t                    \t<div class=\"pull-right padding-left-0 padding-right-8 margin-top-0 modalSearch\" style='padding-bottom:10px;'>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<!-- 搜索框start -->\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" fl=\"true\" placeholder='件号/名称/序列号/型号/厂家件号' id=\"materialAndOutfield_keyword_search\" class=\"form-control\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t                  <div class=\" pull-right padding-left-5 padding-right-0 \">   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<button name=\"keyCodeSearch\" type=\"button\" class=\" btn btn-primary padding-top-1 padding-bottom-1 \" onclick=\"materialAndOutfield.search()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">搜索</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Search</div>\r\n");
      out.write("\t\t\t\t\t\t\t                 \t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t                  </div> \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class='clearfix'></div>\r\n");
      out.write("\t\t                      \t<div class=\"tab-pane fade in active\" id=\"outfield\" style=\"width: 100%;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.write("\r\n");
      out.write("<div id=\"outfield_main\">\r\n");
      out.write("\t<div id=\"outfield_main_top_div\" class=\"col-lg-12 col-md-12 padding-left-0 padding-right-0 margin-top-0 tab-table-height\" style='overflow:auto;'>\r\n");
      ...
      out.write("\t\t \t\t </tr>\r\n");
      out.write("\t\t\t</thead>\r\n");
      out.write("\t\t\t<tbody id=\"outfield_main_list\"></tbody>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div class=\"col-xs-12 text-center page-height padding-right-0 padding-left-0\" id=\"outfield_main_pagination\"></div>\r\n");
      out.write("\t</div>\r\n");
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/open_win/outfield_modal_main.js\"></script>\r\n");
      out.write("\r\n");
      out.write("\t\t                      \t</div>\r\n");
      out.write("\t\t                      \t\r\n");
      out.write("\t\t                      \t<div class=\"tab-pane fade\" id=\"material\" style=\"width: 100%;\">\r\n");
      out.write("\t\t                      \t\t");
      out.write("\r\n");
      out.write("<div id=\"material_main\">\r\n");
      out.write("\t<div id=\"material_main_top_div\" class=\"col-lg-12 col-md-12 padding-left-0 padding-right-0 margin-top-0 tab-table-height\" style='overflow:auto;'>\r\n");
      out.write("\t\t<table id=\"material_main_table\" class=\"table table-thin table-bordered table-striped table-hover table-set\" style=\"min-width: 1350px;\">\r\n");
      out.write("\t\t\t<thead>\r\n");
      out.write("\t\t   \t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th style=\"width:50px\" id=\"checkSingle\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">操作</div>\r\n");
      ...
      out.write("/static/assets/img/d2.png\" alt=\"不全选\" /></a>\r\n");
      out.write("\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t<th class=\"colwidth-15 \" onclick=\"orderBy('bjh')\" id=\"bjh_order\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"important\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-12 line-height-18\">件号</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"font-size-9 line-height-18\">P/N</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t<th class=\"colwidth-25 \" onclick=\"orderBy('ywms')\" id=\"ywms_order\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"important\">\r\n");
      ...
      out.write("\t\t \t\t </tr>\r\n");
      out.write("\t\t\t</thead>\r\n");
      out.write("\t\t\t<tbody id=\"material_main_list\"></tbody>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div class=\"col-xs-12 text-center page-height padding-right-0 padding-left-0\" id=\"material_main_pagination\"></div>\r\n");
      out.write("\t</div>\r\n");
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/open_win/material_modal_main.js\"></script>\r\n");
      out.write("\r\n");
      out.write("\t\t                      \t</div>\r\n");
      out.write("\t\t\t\t            </div>\r\n");
      out.write("\t\t\t\t          </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t                    <span class=\"input-group-addon modalfooterbtn\">\r\n");
      out.write("\t\t\t                        <button type=\"button\" class=\"btn btn-primary padding-top-1 padding-bottom-1\" onclick=\"materialAndOutfield.save();\" data-dismiss=\"modal\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-12\">确定</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"font-size-9\">Confirm</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<!-- <button id=\"project_btn_clear\" type=\"button\" onclick=\"materialAndOutfield.clearProject()\" class=\"btn btn-primary padding-top-1 padding-bottom-1\" data-dismiss=\"modal\">\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/static/js/thjw/material2/return/apply/apply_main.js\"></script>\r\n");
      out.write("\t</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/material2/return/apply/apply_main.jsp(145,8) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/material2/return/apply/apply_main.jsp(145,8) '${accessDepartment}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${accessDepartment}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/views/material2/return/apply/apply_main.jsp(145,8) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/views/material2/return/apply/apply_main.jsp(146,37) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
