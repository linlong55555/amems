...
import com.eray.pbs.thread.ReadRevisionThread;
import com.eray.pbs.util.Module;
import com.eray.util.framework.ThreadPoolManager;

public class RevisionModule implements Module<Object>
{
    private Logger logger = LoggerFactory.getLogger(RevisionModule.class);
    ...
    public void start() throws Exception
    {
        ...
        ThreadPoolManager.getThreadPoolExecutor().execute(new ReadRevisionThread());
