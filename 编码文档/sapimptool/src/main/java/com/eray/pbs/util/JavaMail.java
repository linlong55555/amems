...
public class JavaMail {
    ...
    private String mailHost="10.7.0.240";
    private String sender_username="pmsadmin";
    private String sender_password="pass!1234";
...
//        }
    ...
    public void doSendHtmlEmail(String subject, String sendHtml,
            String receiveUser,String sendUser) {
        try {
            // 发件人
...
//            InternetAddress from = new InternetAddress(MimeUtility.encodeWord("幻影")+" <"+sender_username+">");
            ...
            logger.info(subject+" sended successfully");
    ...
    public static void main(String[] args) {
        ...
        se.doSendHtmlEmail("测试", "测试内容 ", "receiveUser","sendUser");
    }
}
