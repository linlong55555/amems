...
import com.eray.pbs.thread.ReadWorkThread;
import com.eray.pbs.util.Module;
import com.eray.util.framework.ThreadPoolManager;

public class WorkModule implements Module<Object>
{
    private Logger logger = LoggerFactory.getLogger(WorkModule.class);
    ...
    public void start() throws Exception
    {
        ...
        ThreadPoolManager.getThreadPoolExecutor().execute(new ReadWorkThread());
