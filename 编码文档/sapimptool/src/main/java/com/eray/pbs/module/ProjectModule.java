...
import com.eray.pbs.thread.ReadProjectThread;
import com.eray.pbs.util.Module;
import com.eray.util.framework.ThreadPoolManager;

public class ProjectModule implements Module<Object>
{
    private Logger logger = LoggerFactory.getLogger(ProjectModule.class);
    ...
    public void start() throws Exception
    {
        ...
        ThreadPoolManager.getThreadPoolExecutor().execute(new ReadProjectThread());
