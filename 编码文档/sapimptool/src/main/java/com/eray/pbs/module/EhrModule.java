...
import com.eray.pbs.thread.ReadEhrThread;
import com.eray.pbs.util.Module;
import com.eray.util.framework.ThreadPoolManager;

public class EhrModule implements Module<Object>
{
    private Logger logger = LoggerFactory.getLogger(EhrModule.class);
    ...
    public void start() throws Exception
    {
        ...
        ThreadPoolManager.getThreadPoolExecutor().execute(new ReadEhrThread());
