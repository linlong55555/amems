...
import com.eray.pbs.thread.ReadTaskThread;
import com.eray.pbs.util.Module;
import com.eray.util.framework.ThreadPoolManager;

public class TaskModule implements Module<Object>
{
    private Logger logger = LoggerFactory.getLogger(TaskModule.class);
    ...
    public void start() throws Exception
    {
        ...
        ThreadPoolManager.getThreadPoolExecutor().execute(new ReadTaskThread());
