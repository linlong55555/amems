...
import com.eray.pbs.thread.ReadMaterialShortageThread;
import com.eray.pbs.util.Module;
import com.eray.util.framework.ThreadPoolManager;

public class MaterialShortageModule implements Module<Object>
{
    private Logger logger = LoggerFactory.getLogger(MaterialShortageModule.class);
    ...
    public void start() throws Exception
    {
        ...
        ThreadPoolManager.getThreadPoolExecutor().execute(new ReadMaterialShortageThread());
